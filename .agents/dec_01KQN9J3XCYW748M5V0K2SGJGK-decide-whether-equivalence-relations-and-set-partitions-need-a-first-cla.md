...
- Original migrated line: `Decide whether equivalence relations and set partitions need a first-class set subtree or remain centralized Sage-backed type aliases from plans/category_specs/posets/docs/TRIAGE.md`
