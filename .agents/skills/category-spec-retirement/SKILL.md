---
name: category-spec-retirement
description: Use when moving completed, rejected, superseded, or stale category-spec
  cards out of active paths and deciding what durable history must remain.
---
...
- Load `category-spec-workflow`, especially the retired-card policy.
...
- Durable history belongs in git commits, PR bodies, plan history, and canonical decisions/docs.
- Do not retire decisions that still prevent backsliding; keep them active or promote them into canonical docs.
