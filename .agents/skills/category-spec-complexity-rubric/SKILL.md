---
name: category-spec-complexity-rubric
description: Use when setting or reviewing category-spec tracker complexity metadata, deciding whether a task is atomic, or choosing whether to keep a card, split it, or promote it to a plan.
---

# Category Spec Complexity Rubric

Use this skill to set the numeric `complexity` metadata field and the card body's
`Complexity And Ownership` section. Complexity measures execution burden and coupling;
