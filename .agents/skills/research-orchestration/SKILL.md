...
Orchestrators must commit outputs to durable artifacts: tracked files, memories where appropriate, and git commits when authorized. Do not leave findings only in chat.
