...
description: Use when organizing category-spec cards, applying theme groups, setting
  priority or complexity metadata from rubric skills, triaging TODO entries, or
  preparing high-level dependency views.
---
...
- `category-spec-priority-rubric` for `priority`.
- `category-spec-complexity-rubric` for `complexity` and split/promote decisions.
