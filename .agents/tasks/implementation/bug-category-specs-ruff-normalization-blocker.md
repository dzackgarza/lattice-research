...
- `.agents/current-goal-phase.md` says QC is a gate for implementation surfaces and
  ...
  work.
- Owning plan: `SPR-VARIADIC-AUDIT-01KQN9`, under `PLN-AUDIT-000`.
...
- `.agents/tasks/implementation/bug-category-specs-import-hygiene-ruff-f401-e402.md`
- `.agents/tasks/implementation/bug-category-specs-e501-long-line-normalization.md`
- `.agents/tasks/implementation/bug-category-specs-utils-up047-modernization.md`
...
separately in `.agents/tasks/implementation/bug-repo-vulture-dead-code-validation-blocker.md`.
