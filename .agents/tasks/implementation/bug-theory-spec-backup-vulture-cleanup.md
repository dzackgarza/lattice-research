...
- Split from `.agents/tasks/implementation/bug-repo-vulture-dead-code-validation-blocker.md`.
...
- Parent blocker: `.agents/tasks/implementation/bug-repo-vulture-dead-code-validation-blocker.md`.
