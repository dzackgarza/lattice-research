...
- Original migrated line: `Sprint algebra constructor admission and tensor multiplication routing from plans/category_specs/algebras/docs/TRIAGE.md and plans/category_specs/tensor_algebra_components/docs/MAPPING.md`
