---
id: TASK-WRAPUP-PHASE-LATTICE-02-CORE-CATEGORY-AND-CARRIERS
trackerStatus:
  type: task
parents:
...
status: complete
priority: high
description: Wrap-up and cleanup for phase PHASE-LATTICE-02-CORE-CATEGORY-AND-CARRIERS. Audit card statuses, run
