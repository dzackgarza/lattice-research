...
- Original migrated line: `Fix Posets constructor refinement __richcmp__ failures from category_specs/posets/docs/TRIAGE.md and Posets failed category assertions`
...
- 2026-05-05: Resolved the poset constructor failed category assertions without weakening
...
- 2026-05-05: Resolved the finite join-semilattice failed category assertions by adding the
...
Outcome: review found one stale category-obligation example fixture and repaired it; card remains
`needs-agent-review` for fresh review and human acceptance.

- Current `posets/category_obligations.sage` failed because the reusable `diamond_poset`
...
- Repaired the fixture to use the public project constructor
  ...
  `raw_diamond_poset()` helper remains available for `from_existing(...)` category-obligation example
...
- Gaps: Sage upstream documentation outside the installed docs was not web-searched
  in this pass, because the task-local category-obligation example defect and installed-source evidence
