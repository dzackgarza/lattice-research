...
- Relevant set category-obligation output is recorded without weakening category-obligation examples, mapping decisions,
...
- Gate 2: success criteria are concrete, and this card records the targeted set category-obligation example
...
- Gate 5: `just --justfile category_specs/justfile category-obligation-file sets/category_obligations.sage`
