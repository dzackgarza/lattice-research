---
id: TASK-VERTICAL-SLICE-SPEC-REPORT-CATEGORY-OBLIGATIONS
trackerStatus:
  type: task
parents:
...
- `[[TASK-MODULE-FREE-FINITE-RANK-CONSTRUCTION-WITNESSES]]`
- `[[PLAN-SPEC-CORE-VERTICAL-SLICE]]`
- `tests/category_specs/test_spec_obligations.py`
- `category_specs/modules/category_obligations.sage`
- Root `justfile`

## Context

This task is the success metric for the pivot. Broad category-obligation repair, full-suite mypy,
...
- [x] The validation artifact includes a failing claimant or fixture that reports
  missing obligations without broad category-obligation example noise.
...
Do not weaken existing category-obligation examples to pass this task. Add focused checks or a focused recipe
...
- Gate 3 pass: `git show ddeb37e` changes only the task card, `justfile`, generated
  planning artifacts, and the handoff; no spec obligations, methods, or category-obligation example
