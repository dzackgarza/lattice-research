---
id: TASK-CATEGORY-OBLIGATION-PLAN-FIX-DEAD-LINKS
trackerStatus:
  type: task
parents:
- '[[PHASE-CATEGORY-ASSERTION-REPAIR]]'
dependsOn: []
title: Remove dead source links and replace vague references in category-obligation example plan
status: complete
priority: high
...
- The vague "Existing category-obligation example and variadic sprint plans under plans/features/" reference
...
- "Existing category-obligation example and variadic sprint plans under `plans/features/`" →
