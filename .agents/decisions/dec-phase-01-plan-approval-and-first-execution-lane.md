...
- `.agents/current-goal-phase.md` identifies the active phase as category specs and
  semantic vocabulary.
- `.agents/plans/phase-01-category-specs/pln-phase-01-category-specs.md` records the
...
- Approve the phase-01 plan tree and begin with the foundation lane:
  `PLN-CAT-110`, `PLN-CAT-120`, `SPR-CAT-SURFACE-01KQN9`, and
  `SPR-MODULE-WRAPPER-01KQN9`.
