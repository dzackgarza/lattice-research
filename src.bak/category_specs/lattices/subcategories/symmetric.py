r"""Compatibility imports for the forms-owned symmetric bilinear category."""

from ...forms.subcategories.symmetric import (
    OverPIDSymmetricBilinearModulesCategory as OverPIDSymmetricBilinearModulesCategory,
)
from ...forms.subcategories.symmetric import (
    OverPIDSymmetricBilinearModulesElement as OverPIDSymmetricBilinearModulesElement,
)
from ...forms.subcategories.symmetric import (
    OverPIDSymmetricBilinearModulesMorphism as OverPIDSymmetricBilinearModulesMorphism,
)
from ...forms.subcategories.symmetric import (
