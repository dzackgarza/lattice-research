...
- [ ] Review task1_1_sextic.sage, task1_1_sextic_example2.sage,
  task1_1_sextic_example3.sage
- [ ] Create proofs/solved/task1_1_sextic.md documenting verified claim
- [ ] Separate literature facts (Coble construction, genus formula) from computational
  verification
- [ ] Cross-reference audit/task1_1_birationality_note.md and
  audit/task1_1_exact_coordinate_note.md

### Phase 2: Task 1.2 gram matrices verification note

- [ ] Review task1_2_gram_matrices.sage, task1_2_gram_matrices_fixed.sage,
  task1_2b_discriminant_forms.sage
- [ ] Create proofs/solved/task1_2_gram_matrices.md documenting verified claim
- [ ] Literature context: Nikulin (r,a,δ) invariants, discriminant form theory

### Phase 3: Task 1.3 embeddings verification note

- [ ] Review task1_3_embeddings.sage, task1_3_embeddings_fixed.sage,
  task1_3_embeddings_primitive.sage
- [ ] Create proofs/solved/task1_3_embeddings.md documenting verified claim
- [ ] Literature context: Nikulin primitive embedding theory

### Phase 4: Task 2.2 orbit lift verification note

- [ ] Review task2_2_orbit_lift.sage
- [ ] Create proofs/solved/task2_2_orbit_lift.md documenting verified claim
- [ ] Cross-reference task2_1 (uses orbit classification from task2_1)

### Phase 5: Task 3.1 generators/stabilizer verification note

- [ ] Review task3_1_generators.sage, task3_1_stabilizer.sage
- [ ] Create proofs/solved/task3_1_stabilizer.md documenting verified claim
- [ ] Literature context: orthogonal group structure, reflection groups
