...
class _CartesianProductSets(Category_singleton):
    ...
    class ParentMethods:
        ...
        @abstract_method
        def cartesian_factors(self) -> tuple[Set, ...]: ...

        @abstract_method
        def _sets_keys(self) -> tuple: ...
        ...
        @abstract_method
        def _coerce_map_from_(self, S: Set): ...
    ...
    class ElementMethods:
        @abstract_method
        def cartesian_projection(self, i: int) -> SetElement: ...
        ...
        @abstract_method
        def cartesian_factors(self) -> tuple[SetElement, ...]: ...
