...
Tasks:
    ...
    - Find and list all named sage rings X and expose Rings().NamedRings().X() to return it. E.g. PolynomialRing(...), MatrixRing(...), ZZ, Zp(..), QQ, Qp, QQbar, RR, CC, etc, all refined to these subcategories.
