...
SMOKE_STATEMENTS = (
    ...
    ("poset_from_digraph(...) refines to finite posets", lambda _: PC.poset_from_digraph(diamond_digraph, cover_relations=True) in P.Finite()),
    (
        "poset_from_relations(...) refines to finite posets",
        lambda _: PC.poset_from_relations(diamond_elements, diamond_relations, cover_relations=True) in P.Finite(),
    ),
    ("poset_from_order_predicate(...) refines to finite posets", lambda _: PC.poset_from_order_predicate(diamond_elements, diamond_le) in P.Finite()),
    (
        "poset_from_cover_predicate(...) refines to finite posets",
        lambda _: PC.poset_from_cover_predicate(chain_elements, chain_covers_predicate) in P.Finite(),
    ),
    ("poset_from_upper_covers_dict(...) refines to finite posets", lambda _: PC.poset_from_upper_covers_dict(diamond_covers) in P.Finite()),
    ("poset_from_upper_covers(...) refines to finite posets", lambda _: PC.poset_from_upper_covers(diamond_cover_list) in P.Finite()),
    ("poset_from_existing(...) refines to finite posets", lambda _: PC.poset_from_existing(raw_diamond_poset()) in P.Finite()),
    (
