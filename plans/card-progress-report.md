...
_Generated: 2026-05-06 21:22 UTC_
...
| Category specs and Sage surface admission | `[#---------------]   9.3%` | 11/118 | 3 | 100 | 2 |
...
- `task` `TASK-1777748120649-EQPN1A-ADD-MISSING-FINAL-MARKERS-AND-RETURN-ANNOTATIONS-ON-CAT-METHODS`: Add missing final markers and return annotations on Cat methods (`critical`)
