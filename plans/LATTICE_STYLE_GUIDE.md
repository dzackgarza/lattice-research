...
| `cardinality()` | `BilinearModules.ParentMethods` | **All** modules have a cardinality, possibly infinite. Free modules have infinite cardinality; torsion modules have finite cardinality. This is axiomatic -- every set has a cardinality. |
