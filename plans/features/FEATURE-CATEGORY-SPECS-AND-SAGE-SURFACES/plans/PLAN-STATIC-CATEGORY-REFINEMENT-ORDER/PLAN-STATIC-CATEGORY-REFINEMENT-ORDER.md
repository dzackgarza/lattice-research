...
This plan records the ordering rule. Domain-specific constructor and signature cards
live under the relevant Sage-constructor phase or `PHASE-VARIADIC-SIGNATURE-CLOSURE-AUDIT`.
