...
- FEATURE-CATEGORY-SPECS-AND-SAGE-SURFACES
---
# Track lattices mapping spec

Source mapping: `category_specs/lattices/docs/MAPPING.md`.

This tracked spec owns review and admission status for the lattices mapping document.
