...
- FEATURE-CATEGORY-SPECS-AND-SAGE-SURFACES
---
# Track cat mapping spec

Source mapping: `category_specs/cat/docs/MAPPING.md`.

This tracked spec owns review and admission status for the core category mapping
document.
