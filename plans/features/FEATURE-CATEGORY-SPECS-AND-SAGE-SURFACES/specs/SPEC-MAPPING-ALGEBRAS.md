...
- FEATURE-CATEGORY-SPECS-AND-SAGE-SURFACES
---
# Track algebras mapping spec

Source mapping: `category_specs/algebras/docs/MAPPING.md`.

This tracked spec owns review and admission status for the algebras mapping document.
