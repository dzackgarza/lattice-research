...
.. NOTE::
    ...
    are first defined at the lattice ``OverIntegralDomain()`` refinement, where
    the fraction field ``K`` exists.
...
from .over_integral_domain import _LatticesOverIntegralDomain
...
class _LatticesOverDedekindDomain(CategoryWithAxiom_over_base_ring):
    ...
    @final
    def extra_super_categories(self) -> list[_LatticesOverIntegralDomain]:
        r"""Return the weaker integral-domain lattice refinement."""
