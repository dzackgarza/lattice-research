    ...
    class ParentMethods:
        ...
        def cardinality(self) -> Cardinality:
            ...
            if self.category().is_subcategory(SageInfiniteEnumeratedSets()):
                ...
                return infinity
            raise NotImplementedError("recursive set cardinality requires finite or infinite category evidence")
        ...
        def to_digraph(
            ...
            r"""Return the directed graph generated by the recursive successor relation."""
        ...
        def map_reduce(
            ...
            raise NotImplementedError("recursive map-reduce is defined for forest-structured recursive sets")
