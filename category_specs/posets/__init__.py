...
if TYPE_CHECKING:
    ...
    def cached_method[_MethodT: Callable[..., object]](
        method: _MethodT,
    ) -> _MethodT: ...
else:
...
class _PosetParentMethods:
    ...
    def lt(self, x: PosetElement, y: PosetElement) -> bool:
        r"""Return whether ``x < y`` in this poset."""
        return self.le(x, y) and not cast(bool, cast(Any, x).__eq__(y))
    ...
    def directed_subset(
        ...
        return cast(
            PosetSubset,
            SagePosets.ParentMethods.directed_subset(self, elements, direction),
        )
    ...
    def principal_order_ideal(self, x: PosetElement) -> PosetSubset:
        ...
        return cast(
            PosetSubset,
            SagePosets.ParentMethods.principal_order_ideal(self, x),
        )
    ...
    def principal_order_filter(self, x: PosetElement) -> PosetSubset:
        ...
        return cast(
            PosetSubset,
            SagePosets.ParentMethods.principal_order_filter(self, x),
        )
    ...
    def order_ideal_toggle(self, ideal: PosetSubset, x: PosetElement) -> PosetSubset:
        ...
        return cast(
            PosetSubset,
            SagePosets.ParentMethods.order_ideal_toggle(self, ideal, x),
        )
    ...
    def order_ideal_toggles(
        ...
        return cast(
            PosetSubset,
            SagePosets.ParentMethods.order_ideal_toggles(self, ideal, elements),
        )
    ...
    def is_order_ideal(self, subset: Iterable[PosetElement]) -> bool:
        ...
        return cast(bool, SagePosets.ParentMethods.is_order_ideal(self, subset))

    @override
    @final
    def is_order_filter(self, subset: Iterable[PosetElement]) -> bool:
        r"""Return whether ``subset`` is an order filter."""
        return cast(bool, SagePosets.ParentMethods.is_order_filter(self, subset))
    ...
    def is_chain_of_poset(
        ...
        return cast(
            bool,
            SagePosets.ParentMethods.is_chain_of_poset(self, subset, ordered=ordered),
        )
    ...
    def is_antichain_of_poset(self, subset: Iterable[PosetElement]) -> bool:
        ...
        return cast(bool, SagePosets.ParentMethods.is_antichain_of_poset(self, subset))
...
class Posets(Category):
    ...
    class _Constructors:
        ...
        def _refine_constructed_poset(
            ...
            return cast(
                Poset,
                refine_category(poset, [Posets(), Posets().Finite(), *categories]),
            )
        ...
        def _refine_meet_semilattice(
            ...
            return cast(
                FiniteMeetSemilatticePoset,
                self._refine_constructed_poset(
...
type PosetsMorphism = PosetHomCategory.ElementMethods
