...
# This file was *autogenerated* from the file computations/task1_2_gram_matrices_fixed.sage
from sage.all_cmdline import *   # import sage library

_sage_const_80 = Integer(80); _sage_const_2 = Integer(2); _sage_const_10 = Integer(10); _sage_const_0 = Integer(0); _sage_const_1 = Integer(1); _sage_const_8 = Integer(8); _sage_const_4 = Integer(4); _sage_const_16 = Integer(16); _sage_const_20 = Integer(20); _sage_const_18 = Integer(18); _sage_const_7 = Integer(7); _sage_const_6 = Integer(6); _sage_const_11 = Integer(11); _sage_const_9 = Integer(9); _sage_const_3 = Integer(3); _sage_const_19 = Integer(19); _sage_const_60 = Integer(60); _sage_const_22 = Integer(22)
...
U = matrix(QQ, [[_sage_const_0 , _sage_const_1 ], [_sage_const_1 , _sage_const_0 ]])
...
print(f"Λ_K3: rank={Lambda_K3.rank()}, sig=(3,19), unimodular={abs(Lambda_K3.determinant())==_sage_const_1 }")
...
orth_D8 = [
    vector(QQ, [_sage_const_1 , -_sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ]),   # e_1 - e_2
    vector(QQ, [_sage_const_0 , _sage_const_0 , _sage_const_1 , -_sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ]),   # e_3 - e_4
    vector(QQ, [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 , -_sage_const_1 , _sage_const_0 , _sage_const_0 ]),   # e_5 - e_6
    vector(QQ, [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 , -_sage_const_1 ]),   # e_7 - e_8
]
...
# Check orthogonality
orth_check = all((orth_D8[i] * orth_D8[j] == _sage_const_0 ) for i in range(_sage_const_4 ) for j in range(i+_sage_const_1 , _sage_const_4 ))
...
Lambda_K3_prime_gram = block_diagonal_matrix([U, U, U, -identity_matrix(QQ, _sage_const_16 )])
print(f"  Λ_K3' signature: {QuadraticForm(Lambda_K3_prime_gram).signature_vector()[:_sage_const_2 ]}")
...
for i in range(_sage_const_7 ):
    ...
    coords = [_sage_const_0 ]*_sage_const_6  + [_sage_const_0 ]*_sage_const_16 
    coords[_sage_const_6  + _sage_const_2 *i] = _sage_const_1 
    coords[_sage_const_6  + _sage_const_2 *i + _sage_const_1 ] = _sage_const_1 
    v = vector(QQ, coords)
...
orth_ok = all(computed_gram[i,j] == _sage_const_0  for i in range(_sage_const_11 ) for j in range(_sage_const_11 ) if i != j)
...
sig_T = (QF_T.signature_vector()[_sage_const_0 ], QF_T.signature_vector()[_sage_const_1 ])
det_T = T_gram.det()
...
expected_sig_T = (_sage_const_2 , _sage_const_9 )
...
sig_S = (_sage_const_1 , _sage_const_10 )
sig_Lambda = (_sage_const_3 , _sage_const_19 )
sig_additive = ((sig_S[_sage_const_0 ] + sig_T[_sage_const_0 ], sig_S[_sage_const_1 ] + sig_T[_sage_const_1 ]) == sig_Lambda)
...
delta_S = _sage_const_1  if any(val.denominator() == _sage_const_2  for val in q_S_gram.diagonal()) else _sage_const_0 
print(f"  δ_S = {delta_S}")
...
brown_match = (brown_T == (-brown_S) % _sage_const_8 )
if brown_match:
...
print(f"{'Λ_K3':<12} {_sage_const_22 :<6} {'(_sage_const_3 , _sage_const_19 )':<12} {'_sage_const_1  (unimodular)':<15}")
...
checks = [
    ...
    ("rank(S) + rank(T) = 22", r_S + r_T == _sage_const_22 ),
    ("Signature additivity", sig_additive),
    ("Brown invariant relation", brown_match),
    ("|A_S| = 2^11", A_S.cardinality() == _sage_const_2 **_sage_const_11 ),
]
