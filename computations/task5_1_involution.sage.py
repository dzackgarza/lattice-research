...
# This file was *autogenerated* from the file computations/task5_1_involution.sage
from sage.all_cmdline import *   # import sage library

_sage_const_80 = Integer(80); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_22 = Integer(22); _sage_const_11 = Integer(11); _sage_const_2 = Integer(2); _sage_const_3 = Integer(3); _sage_const_4 = Integer(4); _sage_const_5 = Integer(5); _sage_const_6 = Integer(6); _sage_const_8 = Integer(8); _sage_const_10 = Integer(10); _sage_const_12 = Integer(12); _sage_const_14 = Integer(14); _sage_const_7 = Integer(7); _sage_const_16 = Integer(16); _sage_const_18 = Integer(18); _sage_const_9 = Integer(9); _sage_const_20 = Integer(20); _sage_const_13 = Integer(13); _sage_const_15 = Integer(15); _sage_const_17 = Integer(17); _sage_const_19 = Integer(19); _sage_const_21 = Integer(21)
...
print(f"  Is unimodular: {abs(Lambda_K3.determinant()) == _sage_const_1 }")
...
print(f"    Model lattice signature: {(sig_model_vec[_sage_const_0 ], sig_model_vec[_sage_const_1 ])}")
...
M_T_plus = Matrix(ZZ, _sage_const_22 , _sage_const_11 , _sage_const_0 )

# t_0: (1,1) in U_0 (positions 0,1)
M_T_plus[_sage_const_0 , _sage_const_0 ] = _sage_const_1 
M_T_plus[_sage_const_1 , _sage_const_0 ] = _sage_const_1 

# t_1: (1,1) in U_1 (positions 2,3)
M_T_plus[_sage_const_2 , _sage_const_1 ] = _sage_const_1 
M_T_plus[_sage_const_3 , _sage_const_1 ] = _sage_const_1 

# t_2: (1,-1) in U_2 (positions 4,5)
M_T_plus[_sage_const_4 , _sage_const_2 ] = _sage_const_1 
M_T_plus[_sage_const_5 , _sage_const_2 ] = -_sage_const_1 
...
M_T_plus[_sage_const_6 , _sage_const_3 ] = _sage_const_1    # index 0 in E₈_a
M_T_plus[_sage_const_8 , _sage_const_4 ] = _sage_const_1    # index 2 in E₈_a
M_T_plus[_sage_const_10 , _sage_const_5 ] = _sage_const_1   # index 4 in E₈_a
M_T_plus[_sage_const_12 , _sage_const_6 ] = _sage_const_1   # index 6 in E₈_a

# E₈_b (positions 14-21 in Λ_K3):
M_T_plus[_sage_const_14 , _sage_const_7 ] = _sage_const_1    # index 0 in E₈_b
M_T_plus[_sage_const_16 , _sage_const_8 ] = _sage_const_1    # index 2 in E₈_b
M_T_plus[_sage_const_18 , _sage_const_9 ] = _sage_const_1    # index 4 in E₈_b
M_T_plus[_sage_const_20 , _sage_const_10 ] = _sage_const_1   # index 6 in E₈_b

# S_Co embedding (22 × 11)
M_S_minus = Matrix(ZZ, _sage_const_22 , _sage_const_11 , _sage_const_0 )

# s_0: (1,1) in U_2 (positions 4,5), norm 2
M_S_minus[_sage_const_4 , _sage_const_0 ] = _sage_const_1 
M_S_minus[_sage_const_5 , _sage_const_0 ] = _sage_const_1 

# s_1: (1,-1) in U_0 (positions 0,1), norm -2
M_S_minus[_sage_const_0 , _sage_const_1 ] = _sage_const_1 
M_S_minus[_sage_const_1 , _sage_const_1 ] = -_sage_const_1 

# s_2: (1,-1) in U_1 (positions 2,3), norm -2
M_S_minus[_sage_const_2 , _sage_const_2 ] = _sage_const_1 
M_S_minus[_sage_const_3 , _sage_const_2 ] = -_sage_const_1 
...
M_S_minus[_sage_const_7 , _sage_const_3 ] = _sage_const_1    # index 1 in E₈_a
M_S_minus[_sage_const_9 , _sage_const_4 ] = _sage_const_1    # index 3 in E₈_a
M_S_minus[_sage_const_11 , _sage_const_5 ] = _sage_const_1   # index 5 in E₈_a
M_S_minus[_sage_const_13 , _sage_const_6 ] = _sage_const_1   # index 7 in E₈_a

# E₈_b (positions 14-21):
M_S_minus[_sage_const_15 , _sage_const_7 ] = _sage_const_1    # index 1 in E₈_b
M_S_minus[_sage_const_17 , _sage_const_8 ] = _sage_const_1    # index 3 in E₈_b
M_S_minus[_sage_const_19 , _sage_const_9 ] = _sage_const_1    # index 5 in E₈_b
M_S_minus[_sage_const_21 , _sage_const_10 ] = _sage_const_1   # index 7 in E₈_b
...
print(f"      0 · 2 = {E8_a_gram[_sage_const_0 , _sage_const_2 ]} (should be 0)")
print(f"      0 · 4 = {E8_a_gram[_sage_const_0 , _sage_const_4 ]} (should be 0)")
print(f"      0 · 6 = {E8_a_gram[_sage_const_0 , _sage_const_6 ]} (should be 0)")
print(f"      2 · 4 = {E8_a_gram[_sage_const_2 , _sage_const_4 ]} (should be 0)")
print(f"      2 · 6 = {E8_a_gram[_sage_const_2 , _sage_const_6 ]} (should be 0)")
print(f"      4 · 6 = {E8_a_gram[_sage_const_4 , _sage_const_6 ]} (should be 0)")

# Set B: indices {1, 3, 5, 7}
print(f"    Set B (S_Co): indices {{1, 3, 5, 7}}")
print(f"      1 · 3 = {E8_a_gram[_sage_const_1 , _sage_const_3 ]} (should be 0)")
print(f"      1 · 5 = {E8_a_gram[_sage_const_1 , _sage_const_5 ]} (should be 0)")
print(f"      1 · 7 = {E8_a_gram[_sage_const_1 , _sage_const_7 ]} (should be 0)")
print(f"      3 · 5 = {E8_a_gram[_sage_const_3 , _sage_const_5 ]} (should be 0)")
print(f"      3 · 7 = {E8_a_gram[_sage_const_3 , _sage_const_7 ]} (should be 0)")
print(f"      5 · 7 = {E8_a_gram[_sage_const_5 , _sage_const_7 ]} (should be 0)")
...
P_det = P.determinant()
print(f"  det(P) = {P_det}")
print(f"  P is invertible: {P_det != _sage_const_0 }")

# The involution in the eigenbasis is:
theta_eigen = block_diagonal_matrix([identity_matrix(_sage_const_11 ), -identity_matrix(_sage_const_11 )])
...
is_involution = (theta_squared == identity_matrix(_sage_const_22 ))
print(f"\nθ² = I: {is_involution}")

if not is_involution:
    print("  Difference from identity:")
    print(theta_squared - identity_matrix(_sage_const_22 ))
else:
...
for eval_, space in eigenspaces_all:
    if eval_ == _sage_const_1 :
        eigenspace_plus = space
    elif eval_ == -_sage_const_1 :
...
assert total_dim == _sage_const_22 , f"Expected 22, got {total_dim}"
...
sig_plus = (sig_plus_vec[_sage_const_0 ], sig_plus_vec[_sage_const_1 ])
...
sig_minus = (sig_minus_vec[_sage_const_0 ], sig_minus_vec[_sage_const_1 ])
...
try:
    ...
    has_half_integer = any(val.denominator() == _sage_const_2  for val in q_plus_gram.diagonal())
    delta_plus = _sage_const_1  if has_half_integer else _sage_const_0 
...
try:
    ...
    has_half_integer = any(val.denominator() == _sage_const_2  for val in q_minus_gram.diagonal())
    delta_minus = _sage_const_1  if has_half_integer else _sage_const_0 
...
h_Co_candidate = V_plus_basis.row(_sage_const_0 )  # First basis vector of +1 eigenspace
h_En_candidate = V_minus_basis.row(_sage_const_0 )  # First basis vector of -1 eigenspace
...
verifications = [
    ("θ is 22×22 matrix", theta_std.dimensions() == (_sage_const_22 , _sage_const_22 )),
    ("θ² = I (involution)", is_involution),
    ("+1 eigenspace dimension = 11", eigenspace_plus.dimension() == _sage_const_11 ),
    ("-1 eigenspace dimension = 11", eigenspace_minus.dimension() == _sage_const_11 ),
    ("+1 eigenspace signature = (2,9)", sig_plus == (_sage_const_2 , _sage_const_9 )),
    ("-1 eigenspace signature = (1,10)", sig_minus == (_sage_const_1 , _sage_const_10 )),
