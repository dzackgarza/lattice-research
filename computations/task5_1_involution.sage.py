...
_sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_2 = Integer(2); _sage_const_10 = Integer(10); _sage_const_9 = Integer(9); _sage_const_22 = Integer(22); _sage_const_11 = Integer(11); _sage_const_3 = Integer(3); _sage_const_19 = Integer(19); _sage_const_80 = Integer(80); _sage_const_2048 = Integer(2048); _sage_const_8 = Integer(8); _sage_const_5 = Integer(5)
import sys
...
def smith_diagonal(M):
    S, _, _ = M.smith_form()
    return [S[i, i] for i in range(min(S.nrows(), S.ncols())) if S[i, i] != _sage_const_0 ]


def primitive_kernel_basis(A):
    """Return an integral basis for ker(A: Z^n -> Z^m)."""
    D, U, V = A.smith_form()
    rank = sum(_sage_const_1  for i in range(min(D.nrows(), D.ncols())) if D[i, i] != _sage_const_0 )
    return V[:, rank:]
...
def build_glued_k3_model():
    ...
    discriminant forms.
    """
    S_expected = diagonal_matrix(ZZ, [_sage_const_2 ] + [-_sage_const_2 ] * _sage_const_10 )
    T_expected = diagonal_matrix(ZZ, [_sage_const_2 , _sage_const_2 ] + [-_sage_const_2 ] * _sage_const_9 )
    ...
    glue_bits = [
        [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 ],
        ...
        [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_0 ],
        [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_0 ],
        [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_1 , _sage_const_0 ],
        [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_0 ],
        [_sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],
        [_sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],
        [_sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],
        [_sage_const_0 , _sage_const_0 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],
    ]

    doubled_generators = []
    for i in range(_sage_const_22 ):
        row = [_sage_const_0 ] * _sage_const_22 
        row[i] = _sage_const_2 
    ...
    for i in range(_sage_const_11 ):
        ...
        for j, bit in enumerate(glue_bits[i]):
            row[_sage_const_11  + j] = bit
        doubled_generators.append(row)

    hermite = matrix(ZZ, doubled_generators).hermite_form()
    ambient_basis_rows = [hermite.row(i) / _sage_const_2  for i in range(hermite.nrows()) if hermite.row(i) != _sage_const_0 ]
    ...
    if ambient_basis.nrows() != _sage_const_22 :
    ...
    if any(ambient_gram[i, i] % _sage_const_2  != _sage_const_0  for i in range(_sage_const_22 )):
        fail("glued ambient lattice is not even")
    if ambient_gram.determinant() != -_sage_const_1 :
        fail(f"glued ambient determinant is {ambient_gram.determinant()}, expected -1")
    if matrix_signature(ambient_gram) != (_sage_const_3 , _sage_const_19 ):
...
def solve_coordinates(basis_rows, target_row):
    column = matrix(QQ, basis_rows.ncols(), _sage_const_1 , list(target_row))
    solution = basis_rows.transpose().solve_right(column)
    return vector(QQ, [solution[i, _sage_const_0 ] for i in range(solution.nrows())])


def embed_expected_sco(ambient_basis):
    embedded_rows = []
    for i in range(_sage_const_11 ):
        target = [_sage_const_0 ] * _sage_const_22 
        target[i] = _sage_const_1 
...
def build_theta_from_decomposition(embedded_sco, complement, ambient_gram):
    ...
    sign_action = diagonal_matrix(QQ, [-_sage_const_1 ] * embedded_sco.nrows() + [_sage_const_1 ] * complement.nrows())
...
def theta_result_lines(
    ...
    return [
        ...
        f"  Embedded S_Co primitive: {smith_diagonal(embedded_sco) == [_sage_const_1 ] * _sage_const_11 }",
        f"  Computed complement primitive: {smith_diagonal(complement) == [_sage_const_1 ] * _sage_const_11 }",
...
mode = sys.argv[_sage_const_1 ] if len(sys.argv) > _sage_const_1  else "primitive"
...
print(f"  Ambient even: {all(ambient_gram[i, i] % _sage_const_2  == _sage_const_0  for i in range(_sage_const_22 ))}")
print()
...
if smith_diagonal(embedded_sco) != [_sage_const_1 ] * _sage_const_11 :
...
if complement.nrows() != _sage_const_11 :
    fail(f"computed complement rank is {complement.nrows()}, expected 11")
if matrix_signature(complement_gram) != (_sage_const_2 , _sage_const_9 ):
...
if abs(complement_gram.determinant()) != _sage_const_2048 :
    fail(f"computed complement determinant is {complement_gram.determinant()}, expected +/-2048")
if smith_diagonal(complement) != [_sage_const_1 ] * _sage_const_11 :
    fail("computed complement is not primitive in the ambient lattice")
if smith_diagonal(combined) != ([_sage_const_1 ] * _sage_const_11  + [_sage_const_2 ] * _sage_const_11 ):
...
brown_S = (_sage_const_1  - _sage_const_10 ) % _sage_const_8 
brown_T_actual = (matrix_signature(complement_gram)[_sage_const_0 ] - matrix_signature(complement_gram)[_sage_const_1 ]) % _sage_const_8 
expected_brown = (-brown_S) % _sage_const_8 
...
print(f"  q_T(actual) diagonal sample: {list(q_T_actual.diagonal()[:_sage_const_5 ])}")

if A_T_actual.cardinality() != _sage_const_2048 :
    fail(f"actual complement discriminant-group order is {A_T_actual.cardinality()}, expected 2048")
if A_T_actual.invariants() != (_sage_const_2 ,) * _sage_const_11 :
...
primitive_lines = [
    ...
    "",
    "Embedded S_Co:",
    f"  Primitive: {smith_diagonal(embedded_sco) == [_sage_const_1 ] * _sage_const_11 }",
...
if mode == "primitive":
    ...
    raise SystemExit(_sage_const_0 )
