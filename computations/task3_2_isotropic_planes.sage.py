...
# This file was *autogenerated* from the file computations/task3_2_isotropic_planes.sage
from sage.all_cmdline import *   # import sage library

_sage_const_80 = Integer(80); _sage_const_2 = Integer(2); _sage_const_9 = Integer(9); _sage_const_1 = Integer(1); _sage_const_0 = Integer(0); _sage_const_3 = Integer(3); _sage_const_5 = Integer(5); _sage_const_7 = Integer(7)
...
assert sig_T == (_sage_const_2 , _sage_const_9 ), f"Expected (2,9), got {sig_T}"
...
examples = [
    ...
    [_sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],  # 1 + 1 = 1 + 1
    [_sage_const_1 , _sage_const_0 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],  # 1 + 0 = 1 + 0
    [_sage_const_2 , _sage_const_1 , _sage_const_2 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],  # 4 + 1 = 4 + 1
    [_sage_const_3 , _sage_const_1 , _sage_const_3 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],  # 9 + 1 = 9 + 1
    [_sage_const_2 , _sage_const_2 , _sage_const_2 , _sage_const_2 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],  # 4 + 4 = 4 + 4
    [_sage_const_1 , _sage_const_2 , _sage_const_1 , _sage_const_2 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],  # 1 + 4 = 1 + 4
    [_sage_const_3 , _sage_const_2 , _sage_const_3 , _sage_const_2 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],  # 9 + 4 = 9 + 4
    [_sage_const_1 , _sage_const_3 , _sage_const_1 , _sage_const_3 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ],  # 1 + 9 = 1 + 9
]

for coords in examples:
    v = vector(ZZ, coords)
    norm_v = v * T_Co_gram * v
    if norm_v == _sage_const_0 :
...
for v in isotropic_vectors:
    v_normalized = v if v[_sage_const_0 ] > _sage_const_0  or (v[_sage_const_0 ] == _sage_const_0  and v[_sage_const_1 ] > _sage_const_0 ) else -v
...
for i, v in enumerate(unique_isotropic[:_sage_const_5 ]):
    print(f"    v_{i+_sage_const_1 } = {list(v)}, v² = {v * T_Co_gram * v}")
...
def is_isotropic_plane(v1, v2, gram):
    ...
    if v1 * gram * v1 != _sage_const_0 :
        return False
    if v2 * gram * v2 != _sage_const_0 :
        return False
    # Must be orthogonal
    if v1 * gram * v2 != _sage_const_0 :
        return False
...
if len(isotropic_planes) > _sage_const_0 :
    ...
    if v1 * T_Co_gram * v1 == _sage_const_0  and v2 * T_Co_gram * v2 == _sage_const_0  and v1 * T_Co_gram * v2 == _sage_const_0 :
...
def compute_quotient_lattice(J_basis, J_perp_basis, gram):
    ...
    if len(nonzero_entries) == rank_quotient:
        ...
        quotient_gram = -S.submatrix(_sage_const_0 , _sage_const_0 , len(nonzero_indices), len(nonzero_indices))
...
if len(isotropic_planes) > _sage_const_0 :
    ...
    if quotient_gram is not None:
        ...
        A1_7_gram = diagonal_matrix(ZZ, [-_sage_const_2 ]*_sage_const_7 )
        
        print(f"  A₁^⊕7 Gram matrix: diag({', '.join(['-2']*_sage_const_7 )})")
        ...
        # Compare signatures
        sig_quotient = QuadraticForm(quotient_gram).signature_vector()[:_sage_const_2 ]
        sig_A1_7 = QuadraticForm(A1_7_gram).signature_vector()[:_sage_const_2 ]
...
v1_explicit = vector(ZZ, [_sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ])
...
# Try: v₂ = (1, -1, 1, -1, 0, ..., 0)
v2_candidate = vector(ZZ, [_sage_const_1 , -_sage_const_1 , _sage_const_1 , -_sage_const_1 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 , _sage_const_0 ])
print(f"\n  Candidate v₂ = {list(v2_candidate)}")
print(f"  v₂² = {v2_candidate * T_Co_gram * v2_candidate}")
print(f"  v₁·v₂ = {v1_explicit * T_Co_gram * v2_candidate}")

if v1_explicit * T_Co_gram * v1_explicit == _sage_const_0 :
    if v2_candidate * T_Co_gram * v2_candidate == _sage_const_0 :
        if v1_explicit * T_Co_gram * v2_candidate == _sage_const_0 :
            ...
            if mat.rank() == _sage_const_2 :
                ...
                if quotient_gram_explicit is not None:
                    ...
                    sig_q = QuadraticForm(quotient_gram_explicit).signature_vector()[:_sage_const_2 ]
                    sig_A1 = QuadraticForm(A1_7_gram).signature_vector()[:_sage_const_2 ]
