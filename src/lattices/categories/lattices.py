...
class Lattices(CategoryWithAxiom_over_base_ring):
    ...
    EvenLattices = LazyImport(
        'src.lattices.categories.even_lattices', 'EvenLattices')
    UnimodularLattices = LazyImport(
        'src.lattices.categories.unimodular_lattices', 'UnimodularLattices')
    RootLattices = LazyImport(
        'src.lattices.categories.root_lattices', 'RootLattices')
    ...
    class ElementMethods:
        ...
        def perp(self):
            ...
            return self.parent().span(
                [g for g in self.parent().gens()
                 if self.parent().b(self, g) == 0])
