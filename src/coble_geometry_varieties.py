...
class CobleSurface(Surface):
    ...
    sextic curve. The Picard lattice is generated by the hyperplane class $H$ and
    the 10 exceptional divisors $E_1,\dots,E_{10}$, with $H^2 = 1$, $E_i^2 = -1$,
    and all cross-terms zero: $\mathrm{Pic}(S) \cong I_{1,10}$, signature $(1,10)$.

    Defining property: $h^0(-K_S) = 0$ and $h^0(-2K_S) = 1$ (unique anti-bicanonical
    curve, which is the proper transform of the rational sextic).
    """
