...
class CobleSurface(Surface):
    ...
    - The Coble lattice $T_{\mathrm{Co}} \cong \langle 2 \rangle \oplus \langle -2
      \rangle^{10}$: the image of $\mathrm{Pic}(S)$ in $H^2(X, \mathbb{Z})$ of the
      K3 double cover $X \to S$, where the covering map doubles all intersection
      numbers.
