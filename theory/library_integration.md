...
- **Oscar.jl lattices:** `/home/dzack/research/theory/oscar_lattices.md`
- **GAP orbits:** `/home/dzack/research/theory/gap_orbits.md`
- **Indefinite.jl:** `/home/dzack/research/theory/indefinite_jl.md`
- **buildings.sage:** `/home/dzack/research/theory/buildings.md`
...
**Doc:** `/home/dzack/research/theory/oscar_lattices.md` → Creation, Invariants, Discriminant groups
...
**Doc:** `/home/dzack/research/theory/oscar_lattices.md` → Primitive embeddings and extensions
...
**Doc:** `/home/dzack/research/theory/gap_orbits.md` → Orbit, Stabilizer, OrbitsDomain
...
**Doc:** `/home/dzack/research/theory/oscar_lattices.md` → Lattices with isometry, Discriminant groups
...
**Doc:** `/home/dzack/research/theory/oscar_lattices.md` → Lattices with isometry, Kernel sublattices
...
**Doc:** `/home/dzack/research/theory/oscar_lattices.md` → Vinberg's algorithm
...
**Doc:** `/home/dzack/research/theory/oscar_lattices.md` → Primitive embeddings and extensions, Equivariant primitive extensions
...
**Doc:** `/home/dzack/research/theory/oscar_lattices.md` → Primitive embeddings and extensions, Admissible equivariant extensions
...
3. **Oscar.jl `equivariant_primitive_extensions` for G5.1, G6.1** - Handles isometry-preserving extensions. Risk: High/Medium → Low/Medium
   - **Doc:** `/home/dzack/research/theory/oscar_lattices.md` → Equivariant/Admissible extensions
...
4. **GAP for G2.1** - Finite group orbit enumeration. Risk: Low → Very Low
   - **Doc:** `/home/dzack/research/theory/gap_orbits.md`
...
5. **Oscar.jl `image_centralizer_in_Oq` for G2.2, G3.1** - Discriminant group lifting. Risk: Medium/High → Low/Medium
   - **Doc:** `/home/dzack/research/theory/oscar_lattices.md` → Lattices with isometry
