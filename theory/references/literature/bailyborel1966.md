...
Source: Annals of Mathematics，Nov.，1966,Second Series，Vol.84, No. 3 (Nov.,1966), pp. 442-528

Published by: Mathematics Department, Princeton University

Stable URL: https://www.jstor.org/stable/1970457
...
$\textup { \textsf { f } } 0$ .Notation and conventions.
...
This paper is chiefly concerned with a bounded symmetric domain $X$ and an arithmetically defined discontinuous group $\mathbf { \Gamma } \Gamma$ of automorphisms of $X$ Its main goals are to construct a compactification $V ^ { * }$ of the quotient space $V = X / \Gamma$ ,in which $V$ is open and everywhere dense,to show that $V ^ { * }$ may be endowed with a structure of normal analytic space which extends the natural one on $V$ ,and to establish,using automorphic forms,an isomorphism of $V ^ { * }$ onto a normally projective variety,which maps $V$ onto a Zariski-open subset of the latter.

We now proceed to a synopsis of the contents and methods of this paper, making,for convenience in this introduction,the following assumptions,which are no essential loss in generality: $X = K \backslash G _ { \mathrm { { R } } }$ is the quotient by a maximal compact subgroup $\kappa$ of the group $G _ { \mathbf { R } }$ of real points of a connected algebraic matric group defined over $\mathbf { Q }$ , simple over $\mathbf { Q }$ ，and $\mathbf { \Gamma } \mathbf { \Gamma } \mathbf { \Gamma }$ is an arithmetic subgroup of $G$ (i.e., $\mathbf { \Gamma } ^ { \Gamma }$ is commensurable with the group $G _ { \mathbf { Z } }$ of integral matrices in $G$ see 3.1). Our program may be roughly divided into three parts:

I. Construction and properties of the compactification $V ^ { * }$ of $V$ as a topological space.

II. Study of certain automorphic forms,and of their behavior under a $\Phi$ -operator.
...
Section 3 introduces the notion of rational boundary component $\pmb { F }$ by means of two conditions:
...
# 1. Natural compactification and Cayley transforms of a bounded symmetric domain.
...
$$
{ \mathfrak { g } } _ { \mathrm { c } } = { \mathfrak { k } } _ { \mathrm { c } } \oplus { \mathfrak { p } } ^ { + } \oplus { \mathfrak { p } } ^ { - }
$$

$$
( { \mathfrak { p } } ^ { + } \oplus { \mathfrak { p } } ^ { - } = { \mathfrak { p } } _ { \mathrm { c } } )
$$

where ${ \mathfrak { p } } ^ { \pm }$ is a commutative subalgebra normalized by $\sharp _ { \mathbf { C } }$

$\mathfrak { h }$ denotes a Cartan subalgebra of $\mathfrak { E }$ ,and therefore also of $\mathfrak { g }$ , in view of our assumption on $X$ ，and $\Phi = \Phi ( \mathfrak { h } _ { \mathrm { c } } , \mathfrak { g } _ { \mathrm { c } } )$ is the set of roots of ${ \mathfrak { g } } _ { \mathbf { C } }$ with respect to $\mathfrak { h } _ { \mathrm { c } }$ We let $E _ { \mu } ( \mu \in \Phi )$ be root vectors, and $H _ { \mu }$ be elements of $\mathfrak { h } _ { \mathrm { C } }$ verifying

$$
[ E _ { \mu } , E _ { - \mu } ] = H _ { \mu } , \qquad \upsilon ( H _ { \mu } ) = 2 ( \upsilon , \mu ) \cdot ( \mu , \mu ) ^ { - 1 }
$$
...
where（，）is the restriction of the Killing form to $\mathfrak { h } _ { \mathrm { C } }$ ，and such that the complex conjugation of $\mathfrak { g } _ { \mathrm { C } }$ with respect to $\mathfrak { g }$ permutes $E _ { \mu }$ and $E _ { - \mu }$ whenever $E _ { \mu } \in \mathfrak { p } ^ { \pm }$ .Let $\pi ^ { \pm } = \{ \mu \in \Phi \mid E _ { \mu } \in { \mathfrak { p } } ^ { \pm } \}$ . The elements $E _ { \mu } ( \mu \in \pi ^ { \pm } )$ form a basis of ${ \mathfrak { p } } ^ { \pm }$ ,and the elements

$$
X _ { \mu } = E _ { \mu } + E _ { - \mu } \ , \qquad Y _ { \mu } = i ( E _ { \mu } - E _ { - \mu } )
$$
...
Assume $X$ to be irreducible.Then $\mathbf { \pi } _ { \mathbf { R } } \Phi $ is known to be of one of two types, to be denoted by $C _ { t }$ and $B C _ { t }$ .If $( \gamma _ { i } )$ are coordinates with respect to the basis $( ( 1 / 2 ) X _ { i } )$ ,then $C _ { t }$ consists of the roots $\pm ( \gamma _ { i } \pm \gamma _ { j } ) / 2$ ， $( 1 \leq i < j \leq t )$ ,± $\gamma _ { i } ( 1 \leq i \leq t )$ and $B C _ { t }$ is the union of $C _ { t }$ and of the set of elements ± $\gamma _ { i } / 2$ $\mathbf { \nabla } ^ { \prime } \mathbf { 1 } \leq i \leq t \rangle$ .In both cases we always take as ordering the lexicographic ordering defined by the basis $( X _ { i } )$ .The set $\mathbf { \delta } _ { \mathbf { R } } \Delta \mathbf { \delta } $ of simple $\mathbf { R }$ -roots consists then of

$$
\alpha _ { i } = ( \gamma _ { i } - \gamma _ { i + 1 } ) / 2
$$
...
where $( Z _ { b } ) _ { \mathbf { C } }$ and $( Z _ { b } ^ { 0 } ) _ { \mathbf { C } }$ denote the smallest algebraic subgroups of $G$ containing $Z _ { b }$ and $\boldsymbol { Z } _ { b } ^ { 0 }$ respectively.
...
$$
( g _ { 0 } \in K _ { \mathrm { C } } ; g _ { \pm } \in P ^ { \pm } )
$$

and the map $g \mapsto \log g _ { + }$ of $\Omega$ onto ${ \mathfrak { p } } ^ { + }$ will be denoted $\zeta$ It is known [22],[24] that $\zeta$ induces an isomorphism of $X = K \backslash G _ { \mathbb { R } } ^ { 0 }$ onto $\zeta ( G ) = D$ ，and that $D$ is a bounded domain in ${ \mathfrak { p } } ^ { + }$ .This is the Harish-Chandra realization of $X$ as a bounded domain.Its closure $\bar { D }$ is therefore compact,and will be called the natural compactification of $X$ 、The action of $G _ { \mathbf { R } } ^ { 0 }$ on $D$ is defined by right translations; i.e., by

$$
p \cdot g = \zeta ( e ^ { p } \cdot g )
$$

$$
( p \in D , g \in G _ { \mathbf { R } } ^ { 0 } )
$$
...
the space $X _ { b } = K _ { b } \backslash L _ { b }$ is hermitian symmetric,and the restriction of $\zeta$ to $L _ { b }$ yields the Harish-Chandra realization $D _ { b }$ of $X _ { b }$ as a bounded domain.

Let $o _ { b } = - ( E _ { 1 } + \cdots + E _ { b } )$ $( 1 \leq b \leq t )$ ,and put $o _ { 0 } = o$ . Then

$$
\begin{array} { r } { \bar { D } = \bigcup _ { \varnothing \le b \le t } \partial _ { b } \cdot G _ { \mathbf { R } } ^ { \scriptscriptstyle 0 } \ . } \end{array}
$$
...
We refer to [30] for various more geometric definitions of the boundary components in the natural compactification and to [29] for a proof of their equivalence.

For every boundary component $F$ ,we put

$$
\begin{array} { r l } & { N ( F ) = \{ g \in G _ { \mathbf { R } } ^ { 0 } \mid F \cdot g = F \} \ , } \\ & { Z ( F ) = \{ g \in G _ { \mathbf { R } } ^ { 0 } \mid f \cdot g = f ( f \in F ) \} \ , } \\ & { G ( F ) = N ( F ) / Z ( F ) \ , } \end{array}
$$

and let $U ( F )$ be the unipotent radical of $N ( F )$ . The group $N ( F )$ is the normalizer, and $Z ( F )$ the centralizer,of $\pmb { F }$ If $X$ is irreducible,we have,in the notation of 1.3,

$$
N ( F _ { b } ) = P _ { b } \ , \qquad U ( F _ { b } ) = V _ { b } \ .
$$

Moreover

$$
\begin{array} { r } { Z ( F _ { b } ) = Z _ { b } . } \end{array}
$$

In fact, $Z ( F _ { b } )$ is a normal subgroup of $P _ { b }$ with Lie algebra $\pmb { \hat { \delta } } _ { b }$ ,hence $Z ( F _ { b } ) \subset Z _ { b }$ by 1.3;on the other hand, the image in $G ( F _ { b } )$ of an element $\boldsymbol { z } \in \boldsymbol { Z } _ { b }$ centralizes the image $L _ { b } ^ { \prime \prime }$ of $L _ { b }$ , and therefore the maximal compact subgroups of $L _ { b } ^ { \prime \prime }$ ， hence it acts trivially on $\boldsymbol { F } _ { b }$ ,and $Z _ { b } \subset Z ( F _ { b } )$
...
To see this,we may assume that $F = F _ { b }$ $( 1 \leq b \leq t )$ .If $b = t , F _ { b }$ is a point,and there is nothing to prove.So assume $b \neq t$ .Then $t \geq 2$ ，and n contains at least three root spaces ${ \mathfrak { g } } _ { \alpha }$ ，whose sum intersects n $\bigcap \big \forall _ { b }$ only at the origin,namely those corresponding to $\alpha = ( \gamma _ { b } \pm \gamma _ { t } ) / 2 , \gamma _ { b }$ ,hence,

$$
\dim \pi - \dim \left( \updownarrow _ { b } \cap \uparrow \right) \geq 3
$$
...
$$
c _ { b } = \prod _ { 1 \leq i \leq b } \exp { ( \pi / 4 ) } \cdot ( E _ { - i } - E _ { i } ) , ( 1 \leq b \leq t ) ; \qquad c _ { 0 } = e .
$$

It verifies

$$
\begin{array} { r l } & { \mathrm { A d } \mathrm { \sf ~ c } _ { b } ( H _ { i } ) = X _ { i } , \qquad \mathrm { A d } \mathrm { \sf ~ c } _ { b } ( X _ { i } ) = - H _ { i } , } \\ & { \mathrm { A d } \mathrm { \sf ~ c } _ { b } ( H _ { i } ) = H _ { i } , \qquad \mathrm { A d } \mathrm { \sf ~ c } _ { b } ( X _ { i } ) = X _ { i } , } \end{array}
$$

$$
\begin{array} { c } { { ( 1 \equiv i \equiv b ) } } \\ { { ( b < i \equiv t ) } } \end{array}
$$

and is transformed into its inverse by the complex conjugation of $G _ { \mathrm { C } }$ with respect to $G _ { \mathbf { R } }$ . Moreover

$$
\begin{array} { l } { { { \displaystyle c _ { b } \cdot g = g \cdot c _ { b } ~ , } } } \\ { { { \displaystyle G \cdot c _ { b } \subset P ^ { - } \cdot K _ { \mathrm { C } } \cdot P ^ { + } ~ . } } } \end{array}
$$

$$
\left( g \in L _ { b } \right)
$$

We put then $S _ { b } = \zeta ( G \cdot c _ { b } )$ ,and let $G$ act on $S _ { b }$ by
...
$$
s \cdot z = \mathrm { A d } \ z _ { 0 } ^ { \prime - 1 } ( s ) + \log z _ { + } ^ { \prime }
$$

Since ${ \mathfrak { p } } ^ { + }$ is commutative, we can replace $ z _ { 0 } ^ { \prime }$ by $z ^ { \prime }$ ，whence

$$
\begin{array} { r } { s { \cdot } z = \operatorname { A d } c _ { b } ^ { - 1 } { \cdot } z { \cdot } c _ { b } ( s ) + \log \big ( c _ { b } ^ { - 1 } { \cdot } z { \cdot } c _ { b } \big ) _ { + } , } \end{array}
$$

$$
( s \in { \mathfrak { p } } ^ { + } , z \in Z _ { b } ) \ .
$$

If $g \in L _ { b }$ ,then it commutes with $c _ { b }$ ,therefore 1.6 (5) becomes

$$
s \cdot g = \zeta ( e ^ { s } \cdot g )
$$

$$
( s \in S _ { b } , g \in L _ { b } ) \ .
$$

In particular

$$
s \cdot g = \operatorname { A d } g ^ { - 1 } ( s )
$$

$$
( s \in S _ { b } , g \in K _ { b } ) \ .
$$

REMARK. Let $\pmb { F }$ be a boundary component,and $g \in G _ { \mathbf { R } } ^ { 0 }$ be such that $F \cdot g = F _ { b }$ . Then $x \mapsto \sigma _ { b } ( x \cdot g ) \cdot g ^ { - 1 }$ is a holomorphic map of $X$ onto $F$ If $g ^ { \prime }$ is such that $F \cdot g ^ { \prime } = F _ { b }$ ，then $g ^ { \prime } = g \cdot n$ $( n \in N ( F _ { b } ) )$ ； since translation by $_ { n }$ commutes with $\sigma _ { b }$ ，we get $\sigma _ { b } ( x \cdot g ) \cdot g ^ { - 1 } = \sigma _ { b } ( x \cdot g ^ { \prime } ) \cdot g ^ { \prime - 1 } \ ( x \in X )$ .We have thus defined a canonical holomorphic projection of $X$ onto $\pmb { F }$ ,equivariant with respect to $N ( F )$ ,to be denoted $\sigma _ { \ / F }$ .If $F ^ { \prime } \subset { \bar { F } }$ ,then we have a factorization

$$
\sigma _ { { \scriptscriptstyle F ^ { \prime } } } = \sigma _ { { \scriptscriptstyle F ^ { \prime } } { \scriptscriptstyle F } } \circ \sigma _ { { \scriptscriptstyle F } } ~ ,
$$

where $\sigma _ { \ / F ^ { \prime } \ / F }$ is the canonical projection of $\pmb { F }$ on its boundary component $F ^ { \prime }$ .In fact,there exists by 1.5 an element $g \in G _ { \mathbf { R } } ^ { \scriptscriptstyle 0 }$ such that $F \cdot g = F _ { b }$ and $F ^ { \prime } { \cdot } g = F _ { c }$ $( b \leq c )$ ,and it is clear from Proposition 1.7 that $\sigma _ { c } = \sigma _ { c , b } \circ \sigma _ { b }$ where $\sigma _ { c , b }$ is the canonical projection of $\boldsymbol { F } _ { b }$ onto the standard boundary component $F _ { c }$ ：
...
$$
( x \in M ; h , h ^ { \prime } \in H ) \ ,
$$

to be referred to as the cocycle formula; it implies

$$
\begin{array} { r } { \mu ( x , h \cdot h ^ { \prime } \cdot h ^ { \prime \prime } ) = \mu ( x , h ) \cdot \mu ( x \cdot h , h ^ { \prime } ) \cdot \mu ( x \cdot h \cdot h ^ { \prime } , h ^ { \prime \prime } ) \qquad } \\ { ( x \in M ; h , h ^ { \prime } , h ^ { \prime \prime } \in H ) \ . \ } \end{array}
$$

It follows immediately from (1) that the set $\boldsymbol { R }$ of elements $h \in H$ for which $\mu ( x , h ) = \rho ( h )$ is independent of $x$ is a subgroup,and that

$$
\mu ( x , h \cdot r ) = \mu ( x , h ) \cdot \rho ( r ) \qquad \quad ( x \in M ; h \in H ; r \in R ) \mathrm { ~ . }
$$

If $M$ is a domain in $\mathbf { C } ^ { n }$ ，then the jacobian Jac $( x , h )$ which associates to $h \in H$ and $x \in M$ the differential of $h$ at $x$ ，is an automorphy factor with values in $\mathbf { G L } ( n , \mathbf { C } )$ ，and $J ( x , h ) = \operatorname* { d e t } \operatorname { J a c } \left( x , h \right)$ is an automorphy factor with values in $\mathbf { C } ^ { * }$ ：

Let $M = X$ be an irreducible bounded symmetric domain.We shall denote by $\mathtt { J a c } _ { b } \left( x , g \right)$ the jacobian of $g \in G _ { \mathbf { R } } ^ { 0 }$ at ${ \boldsymbol { x } } \in S _ { b }$ ,in the unbounded realization associated to $\boldsymbol { F } _ { b }$ ,by $J _ { b } ( x , g )$ its determinant,and by ${ j _ { b } } ( x , g )$ the functional determinant of $g \in { \cal P } _ { b }$ at $\boldsymbol { \mathscr { x } } \in D _ { \boldsymbol { b } }$ $( 0 \leq b \leq t )$ .Our next aim is to obtain some information on $J _ { b } ( x , g )$ when $g \in { \cal P } _ { b }$ ，which will be used in studying Poincaré- Eisenstein series.
...
Let $X \in { \mathfrak { p } } ^ { + }$ . Then $x + X$ goes under the differential $d g$ of the automorphism of $S _ { b }$ defined by $g$ onto an element $Y + x \cdot g$ ; we have to prove that

$$
\begin{array} { r } { Y = \operatorname { A d } h _ { 0 } ^ { - 1 } ( X ) . } \end{array}
$$

Write $g ^ { \prime }$ for $c _ { b } \cdot g \cdot c _ { b } ^ { - 1 }$ ．By definition

$$
\begin{array} { r } { x \cdot g = \zeta ( e ^ { x } \cdot g ^ { \prime } ) = \log { ( e ^ { x } \cdot g ^ { \prime } ) _ { + } } = \log { h _ { + } } , } \end{array}
$$

and

$$
Y + x \cdot g = d \zeta \Bigl \{ \frac { d } { d t } ( e ^ { t x } \cdot e ^ { x } \cdot g ^ { \prime } ) \Big | _ { t = 0 } \Bigr \} .
$$

Clearly

$$
e ^ { t x } \cdot e ^ { x } \cdot g ^ { \prime } = h _ { - } \cdot e ^ { t \tau } \cdot h _ { \scriptscriptstyle 0 } \cdot h _ { + }
$$

$$
\left( { \cal U } = \mathrm { A d } h _ { - } ^ { - 1 } ( X ) \right) .
$$

But the bracket relations

$$
[ { \mathfrak { f } } _ { \mathrm { C } } , { \mathfrak { p } } ^ { \pm } ] \subset { \mathfrak { p } } ^ { \pm } \ , \qquad [ { \mathfrak { p } } ^ { + } , { \mathfrak { p } } ^ { - } ] \subset { \mathfrak { f } } _ { \mathrm { C } } \ ,
$$

imply readily that if $p \in { \mathfrak { p } } ^ { - }$ and $X \in { \mathfrak { p } } ^ { + }$ ,then Ad exp $p ( X ) \equiv X$ ,modulo $\mathfrak { k } _ { \mathrm { c } } \oplus \mathfrak { p } ^ { - }$ We may therefore write $U = X + Z ( Z \in \mathfrak { t } _ { \mathbf { C } } \oplus p ^ { - } )$ ，whence

$$
\begin{array} { r } { e ^ { t x } \cdot h = h _ { - } \cdot h _ { 0 } \cdot e ^ { t ( X ^ { \prime } + Z ^ { \prime } ) } \cdot h _ { + } \qquad \bigl ( X ^ { \prime } = \mathrm { A d } h _ { 0 } ^ { - 1 } ( X ) , Z ^ { \prime } = \mathrm { A d } h _ { 0 } ^ { - 1 } ( Z ) \bigr ) . } \end{array}
$$

We have then

$$
\frac { d } { d t } ( e ^ { t x } \cdot h ) \Big | _ { t = 0 } = h _ { - } \cdot h _ { \circ } \cdot ( X ^ { \prime } + Z ^ { \prime } ) \cdot h _ { + } \ .
$$

Since $z ^ { \prime }$ also belongs to $\mathfrak { k } _ { \mathrm { C } } + \mathfrak { p } ^ { - }$ ,the image of the right-hand side under $d \zeta$ is $X ^ { \prime } + \log h _ { + }$ ，which, in view of (2),prove3 our contention.

1.10.LEMMA．Let $\beta _ { b }$ $\quad 0 \leq b \leq t$ ） be the sum of roots $\mu \in \pi ^ { + }$ such that $E _ { \mu } \in \mathfrak { p } _ { b } ^ { + }$ . Then $m _ { b } = \beta _ { b } ( H _ { i } )$ is $^ { a }$ strictly positive integer independent of $i$ $( b < i \leq t )$ ，and $m _ { b } > m _ { c } \mathrm { ~ } i f \mathrm { ~ } 0 \le b < c \le t .$

In view of the“hereditary’ character of the natural compactification (1.5), it is enough to prove this when $b = 0$ $G _ { \mathbf { R } } ^ { 0 } = L _ { b }$ ：

Let $\mathfrak { h } _ { t } = \mathbf { A } \mathrm { d } \mathfrak { c } _ { t } ^ { - 1 } ( \mathfrak { a } _ { \mathrm { C } } )$ .It is the subalgebra of $\mathfrak { h }$ spanned by the vectors $H _ { i }$ $\langle \mathbf { 1 } \leq i \leq { t } _ { \ast } ^ { }$ .We denote the coordinates with respect to the basis $\left( H _ { i } / 2 \right)$ also by $\gamma _ { i }$ . We choose an ordering on $\Phi$ verifying the following conditions:
...
The sum of two elements in $\pi ^ { + }$ is never a root,hence
...
$$
( \beta _ { 0 } , \mu ) = ( \beta _ { 0 } , \varkappa ) \equiv ( \varkappa , \varkappa ) > 0
$$
...
But ${ \mathfrak { p } } ( H _ { i } ) = 2 ( \nu , \gamma _ { i } ) \cdot ( \gamma _ { i } , \gamma _ { i } ) ^ { - 1 }$ is an integer for every ${ \boldsymbol { \nu } } \in \Phi$ ,and each $i$ ; therefore,

$$
\begin{array} { r } { \beta _ { 0 } ( H _ { i } ) = 2 \cdot ( \beta _ { 0 } , \gamma _ { i } ) \cdot ( \gamma _ { i } , \gamma _ { i } ) ^ { - 1 } \in { \bf Z } , \beta _ { 0 } ( H _ { i } ) > 0 . } \end{array}
$$
...
$$
\begin{array} { r l } & { J _ { b } ( x { \cdot } z , l { \cdot } u ) = J _ { b } ( x { \cdot } z , l ) { \cdot } \gamma _ { b } ( u ) = J _ { b } ( x , z { \cdot } l ) { \cdot } J _ { b } ( x , z ) ^ { - 1 } { \cdot } \gamma _ { b } ( u ) \ , } \\ & { J _ { b } ( x { \cdot } z , l { \cdot } u ) = J _ { b } ( x , l ) { \cdot } \gamma _ { b } ( z ^ { \prime } ) { \cdot } \gamma _ { b } ( z ) ^ { - 1 } { \cdot } \gamma _ { b } ( u ) \ , } \end{array}
$$

where $z ^ { \prime } = l ^ { - 1 } { \cdot } z { \cdot } l$ .But $\boldsymbol { Z } _ { b } ^ { 0 }$ is the semi-direct product of $V _ { b }$ by a reductive group which centralizes $L _ { b }$ (see 1.3); therefore, $\eta _ { b } ( z ) = \eta _ { b } ( z ^ { \prime } )$ and

$$
J _ { \boldsymbol { b } } ( \boldsymbol { x } \cdot \boldsymbol { z } , l \cdot u ) = J _ { \boldsymbol { b } } ( \boldsymbol { x } , l \cdot u ) .
$$
...
$$
\begin{array} { r l r } { \boldsymbol { J } _ { b } ( \boldsymbol { x } , g ) = \Psi ( g ) \ , \quad } & { \boldsymbol { j } _ { b } ( y , g ) = \psi ( g ) \ , \quad } & { ( \boldsymbol { x } \in S _ { b } ; y \in D _ { b } ; g \in K _ { b } ) } \\ { \boldsymbol { J } _ { b } ( \boldsymbol { o } , g ) = \Psi ( g _ { 0 } ) \ , \quad } & { \boldsymbol { j } _ { b } ( o _ { b } , g ) = \psi ( g _ { 0 } ) \ , \quad } & { ( g \in L _ { b } ) \ . } \end{array}
$$

Given $x \in S _ { b }$ , there exists $l \in L _ { b }$ such that $\sigma _ { b } ( x ) = o _ { b } \cdot l$ . The points $x$ and $o _ { b } \cdot l$ belong to the same fibre of $\sigma _ { b }$ ,hence $J _ { \boldsymbol { b } } ( \boldsymbol { x } , \boldsymbol { g } ) = J _ { \boldsymbol { b } } ( o _ { \boldsymbol { b } } \cdot \boldsymbol { l } , \boldsymbol { g } )$ by (i),and the latter functional determinant has to be compared with ${ j _ { b } } ( o _ { b } \cdot l , g )$ . The desired relationship then follows from the cocycle formula and what has already been proved.

1.12.PROPOSITION． Let $a = \exp { ( \lambda _ { 1 } X _ { 1 } + \dotsb + \lambda _ { t } X _ { t } ) }$ be an element of $A$ Then

$$
\begin{array} { r } { J _ { b } ( o , a ) = \prod _ { \substack { 1 \leq i \leq b } } e ^ { - \lambda _ { i } \cdot m _ { 0 } } \cdot \prod _ { \substack { b < i \leq t } } ( \cosh \lambda _ { i } ) ^ { - m _ { 0 } } . } \end{array}
$$

Write $a = u \cdot v$ $\mathfrak { v } \left( u = \mathbf { e x p } \left( \lambda _ { 1 } X _ { 1 } + \cdot \cdot \cdot + \lambda _ { b } X _ { b } \right) ; v = \mathbf { e x p } \left( \lambda _ { b + 1 } X _ { b + 1 } + \cdot \cdot \cdot + \lambda _ { t } X _ { t } \right) \right)$ We have then $u \in Z _ { b } , v \in L _ { b }$ ,and therefore,by 1.11,

$$
\begin{array} { r } { J _ { b } ( o , a ) = J _ { b } ( o , u ) \cdot J _ { b } ( o , v ) \ . } \end{array}
$$

Since $c _ { b } ^ { - 1 } \cdot u \cdot c _ { b } ^ { \phantom { - 1 } } = u ^ { \prime } = \exp { ( \lambda _ { 1 } H _ { 1 } + \dots + \lambda _ { b } H _ { b } ) } \in K _ { \mathrm { c } }$ ,the action of $^ { u }$ on $S _ { b }$ is given by

$$
\begin{array} { r } { s \cdot u = \operatorname { A d } u ^ { \prime - 1 } ( s ) \ , } \end{array}
$$

hence

$$
\begin{array} { r } { J _ { b } ( x , u ) = \Psi ( c _ { b } ^ { - 1 } { \cdot } u { \cdot } c _ { b } ) = \prod _ { 1 \leq i \leq b } e ^ { - \lambda _ { i } { \cdot } m _ { 0 } } . } \end{array}
$$

On the other hand,a standard computation on the three-dimensional simple group (see e.g.[24, p. 316]) shows that the $K _ { \mathrm { c } }$ -component $v _ { \mathfrak { d } }$ of $v$ is

$$
\begin{array} { r } { v _ { \scriptscriptstyle 0 } = \prod _ { \scriptscriptstyle i \leq t } \exp \log \cosh \lambda _ { \scriptscriptstyle i } \cdot H _ { \scriptscriptstyle i } } \end{array}
$$

and our assertion now follows from 1.11 (5),(6).

1.13.COROLLARY. Let $h _ { c } ( \lambda ) = \exp \lambda ( X _ { 1 } + \cdots + X _ { c } )$ $( 1 \leq c \leq t , \lambda \in \mathbf { R } )$ Then $J _ { c } ( o , h _ { c } ( \lambda ) ) = J _ { b } ( o , h _ { c } ( \lambda ) )$ if $c \leq b$ ，and $J _ { b } ( o , h _ { c } ( \lambda ) ) \cdot J _ { c } ( o , h _ { c } ( \lambda ) ) ^ { - 1 }$ tends monotonically to zero as $\lambda \longrightarrow - \infty \ i f \ c > b$

By 1.11, we have

$$
J _ { c } ( o , h _ { c } ( \lambda ) ) = \exp { - \lambda \cdot m _ { 0 } \cdot c } \ ,
$$

and

$$
\begin{array} { l } { { J _ { b } \big ( o , h _ { c } \ ( \lambda ) \big ) = \exp - \lambda \cdot m _ { \scriptscriptstyle 0 } \cdot c \mathrm { ~ , ~ } } } \\ { { J _ { b } \big ( o , h _ { c } \ ( \lambda ) \big ) = \exp - \lambda \cdot m _ { \scriptscriptstyle 0 } \cdot b ( \cosh \lambda ) ^ { - m _ { \scriptscriptstyle 0 } ( c - b ) } \mathrm { ~ , ~ } } } \end{array}
$$

$$
\begin{array} { l } { { ( c \equiv b ) ~ , } } \\ { { ( c > b ) ~ , } } \end{array}
$$
...
Since $G = K \cdot A \cdot K$ and $^ o$ is fixed under $\kappa$ ,this shows that $K _ { b } ( z , z )$ is completely determined by $K _ { b } ( o \cdot a , o \cdot a )$ ， $( a \in A )$ ，which is given by

$$
K _ { b } ( o \cdot a , o \cdot a ) = K _ { b } ( o , o ) \cdot | J _ { b } ( o , a ) | ^ { 2 } .
$$
...
1.16.PROPOSITION．Let $\eta _ { b }$ be the restriction to $Z _ { b }$ of the functional determinant $\scriptstyle { J _ { b } }$ ，and let $\chi _ { b } ( g ) = \operatorname* { d e t } \mathrm { A d } _ { \mathfrak { v } _ { b } } g ( g \in P _ { b } )$ . Then $\eta _ { b } ( g ) = \chi _ { b } ( g ) ^ { - n _ { b } }$ if $g \in A _ { b } \cdot V _ { b }$ ，and $\mid \gamma _ { b } ( g ) \mid = \mid \chi _ { b } ( g ) \mid ^ { - n _ { b } } i f g \in Z _ { b }$ , where ${ n } _ { b } = 1$ in case (i) of 1.15, and $n _ { b } = ( p _ { b } + 4 q _ { b } ) \cdot ( 2 p _ { b } + 4 q _ { b } ) ^ { - 1 }$ in the cases (i), (ii) of 1.15.

By 1.7 $( 1 ^ { \prime } )$ ，we have
...
$$
\chi _ { b } ( g ) = { \operatorname * { d e t } \mathrm { A d } _ { \mathfrak { v } _ { b } } g = \mathfrak { v } _ { b } ( g ) ^ { p _ { b } + 2 q _ { b } } }
$$
...
We may write $a \in A _ { b }$ in the form $a = \exp \lambda ( X _ { 1 } + \cdots + X _ { b } )$ . Therefore (1.6) we have $c _ { b } ^ { - 1 } \bullet a \bullet c _ { b } = \exp { \lambda ( H _ { 1 } + \cdots + H _ { b } ) }$ .Let $\nu _ { b } ^ { \prime }$ be the image of $\nu _ { b }$ under $\operatorname { I n t } c _ { b } ^ { - 1 }$ . Its value on $c _ { b } ^ { - 1 } \cdot a \cdot c _ { b }$ is again equal to the restriction of $\gamma _ { b }$ in case (i), of $\gamma _ { b } / 2$ in cases (ii),(i),where $\gamma _ { i }$ are now coordinates in $\mathfrak { h } _ { t }$ with respect to the base $\left( H _ { i } / 2 \right)$ . By definition $\eta _ { b } ( a ^ { - 1 } )$ is equal to the product of the values on $c _ { b } ^ { - 1 } \cdot a \cdot c _ { b }$ of the roots $\pmb { \mu } \in \pi ^ { + }$ .Therefore $\eta _ { b } ( a ^ { - 1 } ) = \mathfrak { v } _ { b } ^ { \prime } ( a ) ^ { r _ { b } }$ where the exponent $\boldsymbol { r } _ { b }$ is in case (i),

the number of elements of $\pi ^ { + }$ , which is equal to $p _ { b }$ in case (ii),

the number of elements of $\pi ^ { + }$ restricting to one of $( \gamma _ { i } + \gamma _ { j } ) / 2$ $( 1 \leq i \leq b < j \leq t )$ ，plus twice the number of elements in $\pi ^ { + }$ restricting to one of $\gamma _ { i }$ $\langle 1 \leq i \leqeq b$ ，or of $( \gamma _ { i } + \gamma _ { j } ) / 2$ $( 1 \leq i < j \leq c )$ ，which gives

$$
r _ { b } = u { \cdot } b ( t - b ) + 2 b + u { \cdot } b ( b - 1 ) = p _ { b } / 2 + 2 q _ { b }
$$

in case (ii),

it is the same as in case (ii) plus the number of $\pmb { \mu } \in \pi ^ { + }$ restricting to one of $\gamma _ { i } / 2$ $( 1 \leq i \leq b )$ .According to Lemma 14 in [22], this last number is half the multiplicity of the $\mathbf { R }$ -root $\gamma _ { i } / 2$ ，which gives

$$
r _ { b } = u { \cdot } b ( t - b ) + 2 b + u { \cdot } b ( b - 1 ) + v { \cdot } b / 2 = p _ { b } / 2 + 2 q _ { b } ,
$$

and our assertion follows from (2),(3) and (4).

1.17. PRoPOsITIoN. We keep the notation of 1.11, 1.16, and let $q _ { b } =$ $m _ { 0 } / m _ { b }$ . Then

$$
\mid J _ { b } ( x , g ) \mid = \mid j _ { b } ( \sigma _ { b } ( x ) , g ) \mid ^ { q _ { b } } \mid \chi _ { b } ( g ) \mid ^ { - n _ { b } } , \qquad \quad ( x \in S _ { b } ; g \in N ( F _ { b } ) ) ~ .
$$

In view of 1.3, we may write $g = l { \cdot } z \ ( l \in L ( F _ { b } ) , z \in Z ( F _ { b } ) )$ . By the cocycle formula

$$
\begin{array} { r } { J _ { b } ( x , g ) = J _ { b } ( x , l ) \cdot J _ { b } ( x \cdot l , z ) . } \end{array}
$$

Since $\pmb { z }$ acts trivially on $\boldsymbol { F } _ { b }$ ， we have

$$
j _ { b } ( y , l ) = j _ { b } ( y , l \cdot z ) ,
$$

The proposition follows then from 1.11,1.16.

1.18.PROPOSITION． Let $1 \leq b < d \leq t$ ，and $\mathfrak { V } _ { b , d } = \mathfrak { V } _ { d } \circ \mathfrak { V } _ { b } ^ { - 1 } \colon S _ { b } \longrightarrow S _ { d } .$ where $\nu _ { b } \colon X \to S _ { b }$ is as in 1.6. Then

(i） $J _ { b } ( x , g ) = J _ { d } ( y _ { b , d } ( x ) , g ) , ( g \in Z ( F _ { b } ) ^ { 0 } ; x \in S _ { b } ) .$ (ii) the functional determinant $j ( x , y _ { b , d } )$ of $\nu _ { b , d }$ is constant along the fibres of the canonical projection $\sigma _ { b } \colon S _ { b } \longrightarrow F _ { b }$

The group $Z ( F _ { b } ) ^ { \scriptscriptstyle 0 }$ is the semi-direct product of a reductive group $\scriptstyle { R _ { b } }$ with Lie algebra $\mathfrak { m } _ { b } + \mathfrak { a } _ { b } + \mathfrak { l } _ { b } ^ { \prime }$ ,in the notation of 1.3,by the unipotent radical $V _ { b }$ of $P _ { b } = N ( F _ { b } )$ ,and it is contained in $Z ( F _ { d } )$ .Both $J _ { b } ( x , \mathbf { \theta } )$ and ${ \cal J } _ { d } ( x , \mathbf { \theta } )$ are equal to one if $z \in V _ { b }$ by 1.11. Therefore,it suffices to prove (i) when $g \in R _ { b }$ .By the definition of the Cayley transform, $c _ { b } ^ { - 1 } \cdot c _ { d } \in L _ { b , \mathbf { C } }$ ；therefore, $c _ { b } ^ { - 1 } \cdot c _ { d }$ centralizes $R _ { b }$ ,and (i) follows from 1.7 (1).

By the composition rule for functional determinants,we have

$$
j ( x , y _ { b , d } ) \cdot J _ { d } ( \mathscr { v } _ { b , d } ( x ) , g ) = J _ { b } ( x , g ) \cdot j ( x \cdot g , \mathscr { v } _ { b , d } )
$$
...
Furthermore, ${ \mathfrak { g } } _ { Y _ { i } , \mathbf { C } }$ is one-dimensional and spanned by Ad $c _ { t } ( E _ { \gamma _ { i } } )$ . From the result just quoted,and the standard fact $[ E _ { \mu } , E _ { \nu } ] \neq 0$ if $\mu + \nu$ is a root, we get then

$$
[ g _ { \gamma _ { i } } , \mathfrak { g } _ { ( - \gamma _ { i } \pm \gamma _ { j } ) / 2 } ] = \mathfrak { g } _ { ( \gamma _ { i } \pm \gamma _ { j } ) / 2 } \ ,
$$
...
$$
( y \in \mathfrak { g } _ { ( - \gamma _ { i } \pm \gamma _ { j } ) / 2 } , u \in \mathfrak { g } _ { \gamma _ { i } } ) \ .
$$

It is well-known that, given $v \in \mathfrak { g } _ { \alpha } \left( \alpha \in \mathfrak { g } _ { \alpha } \Phi \right)$ ,there exists $v ^ { \prime } \in \mathfrak { g } _ { - \alpha }$ such that $[ v , v ^ { \prime } ]$ is a non-zero multiple of the element $h _ { \alpha } \in \mathfrak { a }$ such that $\beta ( h _ { \alpha } ) = ( \beta , \alpha )$ $( { \boldsymbol { \beta } } \in \mathbf { \kappa } _ { \mathbf { R } } \Phi )$ . (One may take, for instance, for $v ^ { \prime }$ the transform of $v$ under a suitable Cartan involution.） There exists therefore $\mathfrak { z } \in \mathfrak { g } _ { ( \mathfrak { Y } _ { i } \mp \mathfrak { Y } _ { j } ) / 2 }$ such that $[ z , y ] =$ $c \cdot h _ { ( \check { Y } _ { i } \mp \check { Y } _ { j } ) / 2 }$ $( c \neq 0 )$ . We have then

$$
[ [ z , y ] , u ] = c \cdot \gamma _ { i } ( h _ { ( \gamma _ { i } \mp \gamma _ { j } ) / 2 } ) \cdot u \ne 0 .
$$
...
$$
\begin{array} { c } { { ( \gamma \pm \gamma _ { j } ) / 2 ( 1 \leq i \leq b < j \leq t ) , ( \gamma _ { i } + \gamma _ { j } ) / 2 ( 1 \leq i < j \leq b ) , } } \\ { { \gamma _ { i } ( 1 \leq i \leq b ) , } } \end{array}
$$

together with $\gamma _ { i } / 2$ $( 1 \leq i \leq b )$ in the case $B C _ { t }$ . We want to prove that ${ \mathfrak { w } } _ { b }$ is the sum of the root spaces $g _ { \alpha }$ ，where $\alpha$ runs through the roots

$$
( \gamma _ { i } + \gamma _ { j } ) / 2 ,
$$
...
$$
( 1 \leq i \leq b < j \leq t ) ,
$$

and that

$$
\mathfrak { m } _ { b } \cap \mathfrak { g } _ { \gamma _ { i } / 2 } = \{ 0 \} \ ,
$$
...
if ${ \bf { R } } ^ { \Phi }$ is of type $B C _ { t }$ ,but this follows from 1.19.

The Lie algebra c is also stable under $\mathfrak { a }$ . It is obvious that it contains the ${ \mathfrak { g } } _ { \alpha } \subset { \mathfrak { l } } _ { b }$ and that $\mathfrak { c } \cap \mathfrak { a } \cap \mathfrak { z } _ { b } = 0$ . Lemma 1.19 shows moreover that,if ${ \mathfrak { g } } _ { \alpha } \subset { \mathfrak { l } } _ { b } ^ { \prime }$ ， then $\mathfrak { g } _ { \alpha } \cap \mathfrak { c } = 0$ . The proposition follows then from the facts about ${ \mathfrak { P } } _ { b }$ and $\hat { \boldsymbol { \delta } } \boldsymbol { b }$ recalled in 1.3.

REMARK. Proposition 1.20 was suggested by a statement in [31, $\ S 3 . 3 ]$ which becomes essentially equivalent to 1.20,if the word normalizer there is replaced by centralizer.
...
(M normal $k$ -subgroup, $M \cap S$ finite), and $M$ is anisotropic over $k$ ,i.e., $\mathbf { r } \mathbf { k } _ { k } \left( M \right) = 0$

For $\theta \subset { } _ { k } \Delta$ ，we let $[ \theta ]$ be the set of $k$ -roots which are linear combinations of elements in $\theta$ ,and let $\scriptstyle _ { k } L _ { \theta }$ be the smallest connected $k$ -subgroup normalized by $Z ( S )$ whose Lie algebra ${ \check { \mathbf { \Gamma } } } _ { k } { \check { \mathbf { \Gamma } } } _ { \theta }$ contains the subspaces ${ \mathfrak { g } } _ { \alpha }$ $( \alpha \in [ \theta ] )$ . It is easily seen that $[ \theta ] = \mathbf { \nabla } _ { k } \Phi ( \mathbf { \nabla } _ { k } L _ { \theta } )$ ，that ${ \cal S } \cap _ { k } L _ { \theta }$ is a maximal $k$ -split torus of $\scriptstyle _ { k } L _ { \theta }$ ,and that $\scriptstyle _ { k } L _ { \theta }$ is semi-simple with Lie algebra

$$
\begin{array} { r } { { \bf \Phi } _ { k } \mathbb { I } _ { \pmb { \theta } } = \sum _ { \alpha \in [ \theta ] } \mathbb { J } _ { \alpha } + [ \mathbb { g } _ { \alpha } , \mathbb { g } _ { - \alpha } ] . } \end{array}
$$

Moreover, we have $\ d U _ { k } P _ { \theta } = M _ { \theta } \bullet \ d _ { k } L _ { \theta } \bullet S _ { \theta } \bullet U _ { \theta }$ ,where $M _ { \theta }$ is the identity component of $M \cap Z ( \mathbf { \Sigma } _ { k } L _ { \theta } )$ .If $\theta$ is connected, then $\scriptstyle _ { k } L _ { \theta }$ is almost $k$ -simple, since otherwise, by [14,5.11,8.5] $\scriptstyle _ { k } L _ { \theta }$ would be the almost direct product of a $k$ -group without $k$ -rational unipotent elements $\neq e$ ,and of a $k$ -group containing all unipotent elements rational over $k$ of $\scriptstyle _ { k } L _ { \theta }$ ,and $\scriptstyle _ { k } L _ { \theta }$ could not be generated by unipotent $k$ -subgroups.

We shall sometimes denote by ${ } _ { k } T$ a maximal $k$ -split torus and by ${ } _ { k } U$ the unipotent radical of a minimal parabolic $k$ -subgroup.

We recall finally the Bruhat decomposition $G _ { k } = P _ { k } \cdot N ( S ) _ { k } \cdot P _ { k }$ [14, 5.15].

More precisely, let $n _ { w }$ be a representative in $N ( S ) _ { k }$ of $w \in \mathbf { \Sigma } _ { k } W$ . Then $G _ { k }$ is the disjoint union of the double classes
...
$$
\begin{array} { r } { \chi _ { \mathfrak { o } } = \sum _ { \alpha \in \pmb { \theta } ^ { \prime } } e _ { \alpha } d _ { \alpha } } \end{array}
$$
...
For the proofs, see [14,6.8,6.15,6.16]. A simple $\kappa$ -root will be said to be critical if it restricts onto a simple $k$ -root.Thus a simple $\kappa$ -root either is critical or restricts to zero.
...
(ii)If $k _ { v } = \mathbf { C }$ ,then all maximal tori of $G _ { k _ { v } }$ are conjugate, and 2.5 amounts to the existence of a maximal torus defined over $k$ ,which is known [32,p.45]. Assume now that $k _ { v } = \mathbf { R }$ .Let $T$ be a maximal torus of $G$ defined over $\mathbf { R }$ and $H ^ { \prime }$ the set of regular elements of $( T _ { \mathbf { R } } ) ^ { 0 }$ .It is well known that the set $C$ of conjugates of elements of $H ^ { \prime }$ by elements of $( G _ { \mathbf { R } } ) ^ { 0 }$ is an open subset of $( G _ { \mathbf { R } } ) ^ { 0 }$ ： By (i),it contains an element $x$ rational over $k$ . Then $Z ( x ) ^ { 0 }$ is the desired maximal torus.
...
From now on, $\mathbf { \delta R } ^ { \Delta }$ is of type $C _ { t }$ .Its highest root is then

$$
{ \small 2 ( \alpha _ { 1 } + \dots + \alpha _ { t - 1 } ) + \alpha _ { t } } .
$$

Let $c _ { i }$ denote the number of simple $\mathbf { R }$ -root restricting onto $\beta _ { i }$

(ii）Assume that $r ( \alpha _ { t } ) \neq 0$ .Then the highest $k$ -root is
...
$$
\mathfrak { s } \cdot \beta _ { 2 } = r \big ( 2 ( \alpha _ { j } + \cdots + \alpha _ { t - 1 } ) + \alpha _ { t } \big )
$$

is a $k$ -root,which is absurd.If $j < m ( 1 )$ ，then
...
'herefore $\mathbf { \Lambda } _ { k } \Phi$ is of type $C _ { t }$ ,and the numbering is the canonical one.

(iii) Assume that $r ( \alpha _ { t } ) = 0$ . In this case the highest $k$ -root is
...
(b)Let  be an initial (resp.a final) segment of $\mathbf { \delta } _ { \mathbf { R } } \Delta$ consisting of all roots which come before (resp.after) $a$ critical root and $\theta = r ( \psi ) \cap _ { k } \Delta$ Then $\ O _ { \mathrm { R } } L _ { \psi } = \ O _ { k } L _ { \theta }$ and is defned over $k$

PROOF OF (a). Let $P$ be a proper maximal parabolic $k$ -subgroup of $G$ It follows from 2.2 that there exists a simple $k$ -root $\beta$ such that $P$ is conjugate over $k$ to the group ${ } _ { k } P _ { \theta } \left( \theta = { } _ { k } \Delta - \{ \beta \} \right)$ .Let $\alpha$ be the unique critical simple $\mathbf { R }$ -root which restricts onto $\beta$ and $\psi = \mathbf { \scriptscriptstyle R } \Delta - \{ \alpha \}$ . Then $T _ { \psi } = S _ { \theta }$ by 2.9. Furthermore, since the given orderings are compatible,we have $\mathsf { \Pi } _ { \mathsf { R } } U \subset Z ( \ v { r } _ { k } T ) \cdot \ v { r } _ { k } U ,$ and therefore ${ \bf \Phi } _ { \mathrm { R } } P _ { \psi } \subset { \bf \Phi } _ { k } P _ { \theta }$ . Since ${ } _ { \mathbf { R } } P _ { \psi }$ is a proper maximal parabolic $\mathbf { R }$ -group, we have ${ \bf \mathrm { _ R } } P _ { \psi } = { \bf \mathrm { _ { \it R } } } P _ { \theta }$ ，which proves (a).

PROOF OF (b). By 2.9, $\theta$ is an initial or final segment of $_ k \Delta$ ,and $\psi$ is the greatest connected subset of $\kappa \Delta$ such that $\theta = { \bf \Phi } _ { k } \Delta \cap r ( \psi )$ .Therefore (b） follows from 2.4 (ii).
...
$$
\begin{array} { r } { G _ { \mathbf { R } } \cong \Pi _ { v \in \nu } G _ { k _ { v } } ^ { \prime } \ , } \end{array}
$$

hence

$$
\begin{array} { r } { X = \prod _ { v \in \mathcal { V } } X _ { v } } \end{array}
$$

$$
( X _ { v } = ( K \cap G _ { k _ { v } } ^ { \prime } ) \backslash G _ { k _ { v } } ^ { \prime } )
$$

and $K _ { \left( v \right) } = K \cap G _ { k _ { v } } ^ { \prime }$ is a maximal compact subgroup of $G _ { k _ { v } } ^ { \prime }$ .If $k _ { v } = \mathbf { C }$ ,then $G _ { k _ { v } } ^ { \prime }$ is a complex Lie group,viewed as real Lie group,and its rank as such is twice the rank of $K _ { \iota _ { v } ) }$ ,whence (a).
...
where $X _ { \sigma }$ is an irreducible symmetric bounded domain.For simplicity，we shall also write $G _ { \sigma }$ for ${ } ^ { \sigma } G _ { \mathbf { R } } ^ { 0 }$ ：
...
By 1.1l,applied to each irreducible factor of $X$ ，the functional determinant $J _ { F } ( x , g )$ ， $( g \in N ( F ) )$ , is constant along the fibres of the canonical projection $\sigma _ { F }$ of $X$ onto $F$ ,(defined in 1.7,remark).

The natural compactiffcation $\bar { X }$ of $X$ is the product of the natural compactifications ${ \breve { X } } _ { \sigma }$ of the $X _ { \sigma }$ . We shall also write $O _ { \mathbf { b } }$ for the point with components $o _ { c ( b , \sigma ) } \in \bar { X } _ { \sigma }$ , in the notation of 1.5. Thus

$$
{ \cal F } _ { \bf b } = o _ { \bf b } { \cdot } N ( { \cal F } _ { \bf b } ) = o _ { \bf b } { \cdot } L ( { \cal F } _ { \bf b } ) = o _ { \bf b } { \cdot } G ( { \cal F } _ { \bf b } ) ,
$$
...
We recall that $G ( F _ { \mathbf { b } } ) = N ( F _ { \mathbf { b } } ) / Z ( F _ { \mathbf { b } } )$ . We shall denote by $\mathfrak { \varpi } _ { \mathfrak { b } }$ the natural projection of $N ( F _ { \mathbf { b } } )$ onto $G ( F _ { \mathbf { b } } )$ . Applying 1.3 and 1.5 to each irreducible factor of $X$ ，we see that $G ( F _ { \mathbf { b } } )$ is connected，that $N ( F _ { \mathbf { b } } ) = L ( F _ { \mathbf { b } } ) { \cdot } Z ( F _ { \mathbf { b } } )$ ，and that $Z ( F _ { \mathbf { b } } )$ is the greatest normal subgroup of $N ( F _ { \mathbf { b } } )$ with identity component $Z ( F _ { \mathbf { b } } ) ^ { 0 }$
...
3.6. Clearly,(ii) is implied by (ii)’ the group $\Gamma ( F )$ is of arithmetic type.

Assuming (i)，we now prove that (ii)’ is implied by either of the two following equivalent conditions:

(iii) There exists a normal connected $\mathbf { Q }$ -subgroup $C$ of $N ( F ) _ { \mathrm { c } }$ containing $U ( F ) _ { \mathrm { c } }$ and $L ( F ) _ { \mathrm { c } }$ and such that $C _ { \mathrm { R } } / L ( F ) \cdot U ( F )$ is compact.
...
$$
\begin{array} { l } { { \displaystyle \left( g \in { \cal A } _ { b } \cdot U ( { \cal F } _ { \mathbf { b } } ) \right) ~ , } } \\ { { \displaystyle \left( g \in { \cal Z } ( { \cal F } _ { \mathbf { b } } ) \right) ~ . } } \end{array}
$$

Using the notation of 1.16,we may write

$$
\begin{array} { r l } & { \chi _ { \mathfrak { d } } ( g ) = \prod _ { \sigma \in \Sigma } \operatorname* { d e t } \cdot \operatorname { A d } _ { \mathfrak { u } , \sigma } g _ { \sigma } } \\ & { \qquad = \prod _ { \sigma \in \Sigma } \chi _ { \mathfrak { c } ( b , \sigma ) } ( g _ { \sigma } ) \qquad \quad \qquad ( g = ( g _ { \sigma } ) , \mathfrak { u } _ { \sigma } = \mathfrak { u } ( F _ { \mathfrak { c } ( b , \sigma ) } ) ) ~ , } \end{array}
$$

and similarly

$$
\begin{array} { r } { \eta _ { \mathfrak { b } } ( g ) = \prod _ { \sigma \in \Sigma } \eta _ { c ( b , \sigma ) } ( g _ { \sigma } ) \ . } \end{array}
$$

By 1.16, there exists a rational number $n _ { c ( b , \sigma ) } > 0$ such that

$$
\begin{array} { r l r l } & { | \eta _ { c ( b , \sigma ) } ( g ) | = | \chi _ { c ( b , \sigma ) } ( g ) | ^ { - n _ { c ( b , \sigma ) } } , \qquad } & & { ( g \in Z ( F _ { c ( b , \sigma ) } ) ) } \\ & { \eta _ { c ( b , \sigma ) } ( g ) = \chi _ { c ( b , \sigma ) } ( g ) ^ { - n _ { c ( b , \sigma ) } } } & & { ( g \in A _ { c ( b , \sigma ) } ) \ . } \end{array}
$$

Let $g = ( g _ { \sigma } ) \in { \bf { \sigma } } _ { \bf { Q } } A$ .We have already remarked that $g _ { \sigma } = \varphi _ { \sigma } \circ \varphi ( g )$ ,in the notation of 3.3; by the properties of the functor $R _ { k / \mathbf { Q } }$ ,this implies

$$
\mathrm { d e t \ A d } _ { \mathfrak { u } _ { \sigma } } g = \chi _ { c ( b , \sigma ) } ( g _ { \sigma } )
$$

$$
( \sigma \in \Sigma ; g \in \mathbf { \mathbf { \mathbf { \mathbf { \mathbf { \mathbf { \mathbf { \mathbf \mathbf { \mathbf \Phi } } } } } } } } _ { \mathbf { \mathbf { \mathbf { \mathbf { \mathbf { \mathbf { \mathbf \mathbf { \mathbf \Phi } } } } } } } } ^ { } ( \Sigma ^ { } ) \ .
$$

The proposition will then be a consequence of (1) to (5) once it is shown that ${ \mathcal { n } } _ { c ( b , \sigma ) }$ is independent of $\sigma$ . By 2.9, $\mathbf { \Lambda } _ { k } \Phi$ is of type $C _ { s }$ if and only if $\mathbf { \pi } _ { \mathbf { R } } \Phi ( ^ { \sigma } G ^ { \prime } )$ is of type $C _ { t \sigma }$ and $c ( s , \sigma ) = t _ { \sigma }$ for every $\sigma \in \Sigma$ . Thus if $\mathbf { \Lambda } _ { k } \Phi$ is of type $C _ { s }$ and $b = s$ ， we are in case (i) of 1.15 for every $\sigma$ ，hence $n ( b , \sigma ) = 1 ( \sigma \in \Sigma )$ .If either $b \neq s$ or $\mathbf { \Lambda } _ { k } \Phi$ is of type $B C _ { s }$ , then,for every $\sigma \in \Sigma$ ，we are in one of the cases (ii), (ii)of 1.15.Then $n _ { c ( b , \sigma ) }$ is given by an expression which depends only on the multiplicities of the restrictions to $A _ { c ( b , \sigma ) }$ of $\alpha _ { \sigma , c ( b , \sigma ) }$ and $2 \alpha _ { \sigma , c ( b , \sigma ) }$ . In view of the different identifications made in 3.3,these are also the multiplicities of the restrictions of $\beta _ { b }$ and $\mathbf { 2 } \cdot \boldsymbol { \beta } _ { b }$ to $A _ { \mathbf { b } }$ ,and they are consequently independent of $\pmb { \sigma }$ . This proves our assertion;and,in view of 1.16, shows that

$$
\begin{array} { l } { { n _ { b } = 1 } } \\ { { n _ { b } = ( p _ { b } + 4 q _ { b } ) \cdot ( 2 p _ { b } + 4 q _ { b } ) ^ { - 1 } } } \end{array}
$$

${ \bf \Phi } _ { k } \Phi$ of type $C _ { s }$ and $b = s$ ）

where $p _ { b }$ and $q _ { b }$ are the multiplicities of the restrictions of $\beta _ { b }$ and $2 \cdot \beta _ { b }$ to the intersection ${ \bf _ { Q } } A _ { \bf { b } }$ of the kernels of the simple $\mathbf { Q }$ -roots $\beta _ { i }$ $( i \neq b )$ ：

3.12. The functional determinant on $F _ { \mathbf { b } }$ .Let $\mathbf { q } _ { b } = ( q _ { c ( b , \sigma ) } ) _ { \sigma \in \Sigma }$ ，where $\boldsymbol { q } _ { c ( b , \sigma ) }$ is the rational number $\geq 1$ attached by 1.17 to $X _ { \sigma }$ and the boundary component $F _ { c ( b , \sigma ) }$ .Put

$$
\mid \dot { j } _ { r } ( \sigma _ { \mathfrak { b } } ( x ) , g ) \mid ^ { \mathfrak { q } _ { b } } = \prod _ { \sigma \in \Sigma } \mid \dot { j } _ { c ( b , \sigma ) } \big ( \sigma _ { c ( b , \sigma ) } \big ( \mathfrak { x } _ { \sigma } \big ) , g _ { \sigma } \big ) \mid ^ { q _ { c ( b , \sigma ) } } \qquad \big ( g = ( g _ { \sigma } ) \in N ( F _ { \mathfrak { b } } ) \big ) \ .
$$

If we apply 1.17 to each component $F _ { c ( b , \sigma ) }$ and use 3.11, we see that
...
$$
{ \bf \ L _ { q } } A _ { t } = \{ a \in { \bf \ L _ { q } } A \ | \ a ^ { \beta } \leq t ( \beta \in { \bf \ L _ { q } } \Delta ) \} \ .
$$

A fundamental property of this subset is given by the:

LEMMA. Let ω be a compact subset of $( M \cdot U ) _ { \mathbf { R } }$ . Then the union of the sets $a \cdot \omega \cdot a ^ { - 1 }$ ， $( a \in \mathbf { \mathbf { \mathbf { \mathbf { q } } } } A _ { t } )$ is relatively compact.

Since $\boldsymbol { S }$ centralizes $M$ and normalizes $U$ ,it is enough to prove this when $\omega \subset U _ { \mathbf { R } }$ .But then ${ \bf _ { Q } } A _ { t }$ is a bounded set of operators on ${ \mathfrak { u } } _ { \mathbf { R } }$ by $a \mapsto \operatorname { A d } a$ ,in view of the very definition of $\mathbf { \mathbf { \mathbf { Q } } } ^ { A _ { t } }$ . Since the exponential is a homeomorphism of ${ \mathfrak { u } } _ { \mathbf { R } }$ onto $U _ { \mathbf { R } }$ , our assertion follows (see [13, Prop. 4.2]).

4.2. Let $\kappa$ be a maximal compact subgroup of $G _ { \mathbf { R } }$ whose Lie algebra is orthogonal to that of $S _ { \mathbf { R } }$ ，with respect to the Killing form, $\pi$ the natural projection of $G _ { \mathbf { R } }$ onto $X = K \backslash G _ { \mathbb { R } }$ ,and $o = \pi ( K )$ . A Siegel domain $\mathbf { \mathcal { S } ^ { \prime \prime } } = \mathbf { \mathcal { S } } _ { t , \mathbf { \mathcal { \omega } } } ^ { \prime \prime }$ in $G _ { \mathbf { R } }$ (with respect to $\kappa , s$ ,and $U$ )isa set of the form

$$
\widetilde { \odot } ^ { \prime \prime } = \widetilde { \odot } _ { t , \omega } ^ { \prime \prime } = K \cdot _ { \mathbf { q } } A _ { t } \cdot \omega
$$

$$
( \omega \mathrm { c o m p a c t i n } V _ { \mathrm { R } } ) \ .
$$

In this paper,we shall in fact be more concerned with the intersection $\mathfrak { S } ^ { \prime } = ( K \cap P ) \cdot _ { \mathrm { q } } A _ { t } \cdot \omega$ of $@ "$ with $P _ { \mathbf { R } }$ , to be called a Siegel domain in $P$ ,and with

$$
\mathfrak { S } = \mathfrak { S } _ { t , \omega } = o \cdot \mathfrak { S } ^ { \prime \prime } = o \cdot \mathfrak { S } ^ { \prime } ,
$$

to be called a Siegel domain in $X$ ，If we replace the $\mathbf { s i g n } \cong \mathbf { b y } <$ in 4.1 (1), and $\omega$ by an open relatively compact subset of $V _ { \mathbf { R } }$ , then we get open Siegel domains in $G _ { \mathrm { R } } , P _ { \mathrm { R } }$ and $X ,$ ，We note that $\mathbf { \_ } A$ centralizes $M$ and that $K \cap P \subset M$ so that we may also write $\widetilde { \mathcal { G } } ^ { \prime } = \mathbf { { q } } A _ { t } \cdot \boldsymbol { \omega } ^ { \prime }$ with ${ \omega } ^ { \prime } = ( K \cap P ) { \cdot } { \omega }$

The $\mathbf { Q }$ -roots are,in a natural way, positive-valued functions on $P _ { \mathbf { R } } ^ { 0 }$ which are equal to one on $V _ { \mathbf { R } } ^ { 0 }$ . Thus we also have
...
$$
( s \in \mathcal {  Q } _ { t } ^ { \prime } ; \beta \in \mathbf { \mathbf { \mathbf { \mathbf { q } } } } \Delta ) .
$$
...
$$
( 1 \leq i \leq t _ { \sigma } )
$$

$$
\begin{array} { r c l } { { } } & { { } } & { { \alpha _ { \sigma , i } = ( \gamma _ { \sigma , i } - \gamma _ { \sigma , i + 1 } ) / 2 \mathrm { ~ , ~ } } } \\ { { } } & { { } } & { { } } \\ { { } } & { { } } & { { \alpha _ { \sigma , t _ { \sigma } } = \gamma _ { t _ { \sigma } } \mathrm { ~ , ~ } } } \\ { { } } & { { } } & { { \alpha _ { \sigma , t _ { \sigma } } = \gamma _ { t _ { \sigma } } / 2 \mathrm { ~ . ~ } } } \end{array}
$$

In the product of the groups $T _ { \sigma \mathbf { R } }$ ,the torus $\mathbf { \_ } A$ is contained in the identity

component of the intersections of the kernels of the roots $\alpha _ { \sigma , i } ~ ( \alpha _ { \sigma , i } \in \mathbf { \Gamma } _ { \mathbb { R } } \Delta _ { \sigma }$ $1 \leq i \leqq t _ { \sigma } ,$ $i$ not critical).An element $\pmb { a } = ( a _ { \sigma } ) \in \mathbf { \mathbf { \mathbf { _ { Q } } } } A$ satisfies therefore the relations

$$
\gamma _ { \sigma , i } ( \log a _ { \sigma } ) = \gamma _ { \sigma , i + 1 } ( \log a _ { \sigma } ) \qquad ( \sigma \in \Sigma , 1 \\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\\ \ ) \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ \ 
$$

with the convention that $\gamma _ { \sigma , i } = 0$ if $i > t _ { \sigma }$ . Moreover, $S _ { \mathbf { R } }$ being diagonally imbedded in $G _ { \mathbf { R } }$ (see 3.3), we have

$$
a ^ { \beta _ { j } } = a _ { \sigma } ^ { \alpha _ { \sigma , i } }
$$

$$
( i = c ( j , \sigma ) , j = 1 , \cdots , s ; \sigma \in \Sigma ) \ .
$$

Therefore, $a \in \mathbf { \mathbf { \mathbf { \mathbf { q } } } } A _ { t }$ if and only if it verifies (4),(5),and

$$
\gamma _ { \sigma , i } ( \log a _ { \sigma } ) - \gamma _ { \sigma , i + 1 } ( \log a _ { \sigma } ) \leq 2 \log t
$$
...
$$
o _ { \mathbf { b } } \cdot \mathfrak { w } _ { \mathbf { { b } } } ( \mathfrak { S } ^ { \prime \prime } \cap N ( F _ { \mathbf { b } } ) ) = o _ { \mathbf { { b } } } \cdot \mathfrak { w } _ { \mathbf { { b } } } ( \mathfrak { S } ^ { \prime } )
$$

is a Siegel domain of $F _ { \mathbf { b } }$

If $b = s$ ,then $F _ { \mathbf { b } } / \Gamma ( F _ { \mathbf { b } } )$ is compact, and $o _ { \mathbf { b } } \cdot \varpi _ { \mathbf { { b } } } ( \mathfrak { S } ^ { \prime \prime } \cap N ( F _ { \mathbf { b } } ) )$ is compact.
...
$$
( i \leq c ( b , \sigma ) , \sigma \in \Sigma )
$$

and that $\gamma _ { \sigma , i } ( \log a _ { \scriptscriptstyle \upsilon , \sigma } )$ has finite limits if $i > c ( b , \sigma )$ . We have then

$$
\operatorname * { l i m } _ { { \bf \Phi } } o { \bf \cdot } a _ { \nu } = o _ { { \bf b } } { \bf \cdot } a { \bf \Phi } .
$$

where $a$ is the element of $L ( F _ { \mathbf { b } } ) \cap \mathfrak { S }$ such that $a ^ { \beta _ { j } } = d _ { j } \left( j > b \right)$ if $b \neq s$ ,and is the identity if $b = s$ . This implies

$$
\begin{array} { r } { \operatorname* { l i m } _ { \nu  \infty } o \cdot a _ { \nu } \cdot v _ { \nu } = o _ { \mathbf { b } } \cdot a \cdot v \in o _ { \mathbf { b } } \bullet \varpi _ { \mathbf { b } } ( _ { \mathbf { Q } } A _ { t } \cdot \omega ) \ . } \end{array}
$$

Conversely, given $x \in \sigma _ { \mathbf { b } } \cdot \pi ( \mathbf { q } A _ { t } \cdot \omega )$ , it is clear that we can find a sequence $a _ { \nu } \cdot v _ { \nu }$ as above such that $\pmb { x } = \operatorname* { l i m } \pmb { o } \cdot \pmb { a } _ { \nu } \pmb { v } _ { \nu }$ . Taking into account the next to last paragraph of 4.4,this proves the lemma.
...
$$
{ \mathfrak { T } } _ { \lambda } { \cdot } c _ { \lambda } { \cdot } \gamma \cap { \mathfrak { T } } _ { \mu } { \cdot } c _ { \mu } \not = \emptyset ~ ,
$$

choose one element $\gamma _ { \lambda \mu } \in \Gamma$ fulfilling that condition and let $d _ { \lambda \mu } = c _ { \lambda } \cdot \gamma _ { \lambda \mu } \cdot c _ { \mu } ^ { - 1 }$ We have $b ( \lambda ) = b ( \mu )$ $\mathfrak { T } _ { \lambda } = \mathfrak { T } _ { \mu } \subset F _ { b ( \lambda ) }$ ,and $d _ { \lambda \mu } \in N ( F _ { b ( \lambda ) } ) _ { \mathbf { Q } }$ Let $\gamma$ be an element of $\mathbf { \Gamma } \Gamma$ satisfying (1). We define $e _ { \lambda \mu } ( \gamma ) = c _ { \mu } \cdot \gamma _ { \lambda \mu } ^ { - 1 } \cdot \gamma \cdot c _ { \mu } ^ { - 1 }$ . We have $e _ { \lambda \mu } ( \gamma ) \in N ( F _ { b ( \lambda ) } ) _ { \mathbf { Q } }$ Condition (1) implies
...
$$
( \boldsymbol { x } \in \mathfrak { T } _ { \lambda } \cdot \boldsymbol { c } _ { \lambda } )
$$

This means that,if ${ \bar { \Omega } } \cdot \gamma \cap { \bar { \Omega } } \neq \emptyset$ ,there are only finitely many possibilities for the action of $\gamma$ on $\bar { \Omega } \cdot \gamma ^ { - 1 } \cap \bar { \Omega }$ ，whence the lemma.

4.7. LEMmA. We keep the assumptions of 4.4. Let $X ^ { \ast }$ be the union of the rational boundary components of $X ,$ Then there exists a fundamental set $\Omega = \mathfrak { S } { \cdot } C$ for I such that $X ^ { * } = \bar { \Omega } { \cdot } \Gamma = \bar { \Omega } { \cdot } G _ { \bf q }$
...
$$
\bar { \Omega } \cdot \gamma \cdot c \subset \bar { \Omega } \cdot D \subset \bar { \Omega } \cdot \Gamma ~ ;
$$

therefore,

$$
{ \cal F } = { \cal F } _ { \mathrm { b } } { \cdot } c \subset \bar { \Omega } { \cdot } \Gamma \ ,
$$

and $X ^ { \ast } \subset \overline { { \Omega } } \cdot \Gamma$ ，which completes the proof.

4.8.We now turn to the general case and let $\Gamma$ be an arithmetic subgroup of $H ( X )$ as in 3.3 (i). We take the notation of 3.3 (i). The union $X ^ { \ast }$ of the rational boundary components of $X$ is the product of the similarly defined spaces $X _ { i } ^ { * }$ corresponding to the different simple $\mathbf { Q }$ -factors $G _ { i }$ of $G$ The group $H ( X )$ operates continuously on the natural compactification of $X$ (11.2),and hence $H ( X ) _ { \mathbf { Q } }$ operates on $X ^ { \ast }$ . Furthermore,(11.2),the restriction of each element $h \in H ( X )$ to each boundary component is holomorphic.By 4.7,applied to $X _ { i } ^ { * }$ and $\Gamma _ { i } = \Gamma \cap G _ { i \mathbf { R } } ^ { 0 }$ ,and 4.3,there exists then a fundamental set $\Omega$ for $\Gamma$ in $X$ such that ${ \boldsymbol { \bar { \Omega } } } \cdot \Gamma = X ^ { * }$ .For ${ \boldsymbol { x } } \in X ^ { * }$ , we let $\Gamma _ { x } = \{ \gamma \in \Gamma , x \bullet \gamma = x \}$ The space $X ^ { * }$ will be endowed with the topology $\mathcal { S } ( \Omega , \Gamma )$ in which a fundamental set of neighborhoods of ${ \boldsymbol { \mathscr { x } } } \in X ^ { * }$ is the set of all subsets $U$ of $X ^ { \ast }$ containing $x$ and having the following properties: $\tau { \cdot } \gamma = U$ if $\gamma \in \Gamma _ { x }$ and $U \cdot \gamma \cap { \bar { \Omega } }$ is a neighborhood of $x \cdot \gamma$ in $\bar { \Omega }$ ,in the natural topology of $\bar { \Omega }$ whenever $x \cdot \gamma \in { \overline { { \Omega } } }$ This topology was introduced,in a similar setting,in [33],and will be called the Satake topology for $X ^ { * }$

4.9. THEoREM. We keep the assumptions of 4.8. The Satake topology is the unique topology on $X ^ { * }$ having the following properties: (i） It induces the natural topology on $X$ and on the closure of any fundamental set $\Omega$ for any arithmetic group $\Gamma \subset H ( X )$ (ii) The elements of the group $H ( X ) _ { \mathbf { Q } }$ operate continuously on $X ^ { \ast }$ ： (ii) If x and $x ^ { \prime }$ are not equivalent with respect to $\Gamma$ , then there exist neighborhoods U of x and $U ^ { \prime }$ of $x ^ { \prime }$ such that $U \cdot \Gamma \cap U ^ { \prime } = \emptyset$ ：
...
4.10．PROPOSITION． Let $\pmb { F }$ be a rational boundary component of $X$ and $x \in F$ Then x has a neighborhood $U$ in $X ^ { \ast }$ verifying 4.9 (iv),and such that a rational boundary component $F ^ { \prime }$ intersects $U$ if and only if $F \subset { \bar { F } } ^ { \prime }$ . The closure of $\pmb { F }$ in $X ^ { \ast }$ is the union of the rational boundary components contained in the closure of $\pmb { F }$ in the natural compactification $\bar { X }$ of $X$

We let $\mathfrak { S }$ and $\mathcal { T }$ denote respectively the Satake topology of $X ^ { * }$ and the topology of the natural compactification $\tilde { X }$ Let $\bar { \Omega }$ be as in 4.8.Then $\mathfrak { S }$ and $\mathcal { T }$ coincide on $\bar { \Omega }$ . We may (and shall) assume that $x \cdot \mathbf { \Gamma } \mathbf { \Gamma }$ contains an interior point of $\bar { \Omega } \cap F$ ，It follows from 4.6 that we may find finitely many elements $\gamma _ { 1 } , \ldots$ ， $\gamma _ { m } \in \Gamma$ such that $\bar { \Omega } \cap { \boldsymbol x } \cdot \Gamma = \{ { \boldsymbol x } \cdot { \boldsymbol \gamma } _ { 1 } , \cdot \cdot \cdot , x \cdot { \boldsymbol \gamma } _ { m } \}$ .Let $U _ { i }$ $\left( 1 \leq i \leq m \right)$ be a subset of $X ^ { * }$ such that $U _ { i } { \cdot } \gamma _ { i }$ is a neighborhood of $x \cdot \gamma _ { i }$ in $\bar { \Omega }$ . Then $U =$ $\textstyle \mathbf { U } _ { i } \ U _ { i } \cdot \Gamma _ { x }$ is a neighborhood of $x$ ，which satisfies 4.9 (iv) if the $U _ { i }$ are sufficiently small,and we get in this way a fundamental system of neighborhoods of $x$ in $\mathfrak { S }$ [33,p. 562]. By 4.6, $\bar { \Omega }$ is the union of its intersections with finitely many rational boundary components.We may therefore assume $U _ { i }$ to be such that if the rational boundary component $F ^ { \prime }$ intersects $U _ { i } { \cdot } \gamma _ { i }$ ,then $x \cdot \gamma _ { i }$ belongs to the closure of $F ^ { \prime } \cap \widehat \Omega$
...
$$
\mathfrak { S } _ { b } ^ { \prime } ( u , E ) = \{ s \in \mathfrak { S } ^ { \prime } \mid s ^ { \beta _ { b } } \leq u , o _ { \mathbf { b } } \cdot s \in E \} \ ,
$$
...
(ii） The group $\mathbf { \mathbf { q } } A _ { b }$ centralizes $K ^ { \prime } = K \cap P _ { \mathbf { R } }$ ,and is contained in the isotropy group of $O _ { \mathbf { b } }$ . Since $\widetilde { \Theta } ^ { \prime } = K ^ { \prime } \cdot _ { \mathbf { q } } A _ { t } \cdot \omega$ $( \omega \subset V _ { \mathbf { R } } )$ ，we have then

$$
h \cdot \mathfrak { S } _ { \mathfrak { b } } ^ { \prime } ( u , E ) \subset \mathfrak { S } _ { \mathfrak { b } } ^ { \prime } ( v , E ) \ , \qquad \ ( v = u \cdot h ^ { \beta _ { \mathfrak { b } } } , h \in \mathfrak { q } A _ { \mathfrak { b } } ) \ ,
$$

and hence also

$$
\begin{array} { c } { { o _ { \mathbf { b } } { \cdot } \mathcal { S } ^ { \prime } = o _ { \mathbf { b } } { \cdot } \mathfrak { S } _ { b } ^ { \prime } ( u , F _ { \mathbf { b } } ) \ , } } \\ { { o _ { \mathbf { b } } { \cdot } \mathfrak { S } ^ { \prime } ( u , E ) = o _ { \mathbf { b } } { \cdot } \mathfrak { S } ^ { \prime } ( v , E ) \ } } \end{array}
$$
...
By 4.6, $x \cdot \Gamma \cap \bar { \Omega }$ is finite.Let $\gamma _ { j }$ $( 1 \leq j \leq q )$ ）be elements of $\Gamma$ such that $\boldsymbol { x } \cdot \Gamma \cap \bar { \Omega } = \{ \boldsymbol { x } \cdot \gamma _ { 1 } , \cdot \cdot \cdot , \boldsymbol { x } \cdot \gamma _ { q } \}$ ,and put $x \cdot \gamma _ { j } = x _ { j }$ .Let $\Gamma _ { x }$ be the isotropy group of $x$ in $\mathbf { \Gamma } ^ { \Gamma }$ .From 4.10,it follows that if $U _ { j } { \cdot } \gamma _ { j }$ is a neighborhood of $x _ { j }$ in $\bar { \Omega }$ ， then $\cup _ { j } U _ { j } { \cdot } \mathbf { r } _ { x }$ is a neighborhood of $x$ in $X ^ { \ast }$ ,and that we get in this way a fundamental set of neighborhoods.For $U _ { j }$ ,we may by the above take a finite union of sets $\mathcal { \bar { S } } _ { b } ( u , E ) \cdot c$ ，where $c \in C$ is such that $x _ { j } \in \mathcal { \tilde { \mathrm { S } } } \cdot c$ ,and $\pmb { { \cal E } }$ is a neighborhood of $x _ { j } { \cdot } { c } ^ { - 1 }$ in $F _ { \mathbf { b } }$ . From this,our first assertion follows,with $e _ { i }$ running over the set of products $c \cdot \gamma _ { j } ^ { - 1 }$ for which $\pmb { x } \cdot \gamma _ { j } \bullet \pmb { c } ^ { - 1 } \in \bar { \mathfrak { S } }$ . Such elements are rational over $\mathbf { Q }$ ，and they belong to $N ( F _ { \mathbf { b } } )$ , since they transform $x$ into a point of $F _ { \mathbf { b } }$ ·

As for the second assertion, the images of the sets $\cup _ { j } U _ { j } ^ { \prime }$ ，which are constructed simply by replacing $\mathfrak { S }$ by $\mathfrak { S } ^ { \prime }$ while allowing $c$ and $\gamma _ { j }$ to run over the same sets of objects as in the definition of $U _ { j }$ ,are relatively compact neighborhoods of $x ^ { * }$ ,and for $u \longrightarrow 0$ and $E _ { j }$ .. decreasing through a basis of compact neighborhoods of $x _ { j } \cdot c ^ { - 1 }$ for each $j$ and $\pmb { c }$ ，we obtain a decreasing family of compact neighborhoods of $x ^ { * }$ ； it follows from 4.12 (6) that the intersection of all these is just $x ^ { * }$ . Since $V ^ { * }$ is compact and Hausdorff,and since all the spaces we consider are second countable,it follows that these neighborhoods also give a basis of neighborhoods of $x ^ { * }$ in $V ^ { * }$ ,which proves the last assertion.
...
onto $A \cdot N$ ，Furthermore $( L ( F _ { \mathbf { b } } ) \cap A )$ and $( L ( F _ { \mathfrak { b } } ) \cap N )$ are the $A$ and $N$ part of an Iwasawa decomposition of $L ( F _ { \mathbf { b } } )$ . It follows that $( a , n ) \mapsto o \cdot a \cdot n$ and $( a , n ) \mapsto \boldsymbol { o } _ { \mathbf { b } } \cdot \boldsymbol { a } \cdot n$ yield homeomorphisms of $A \times N$ onto $X$ and of

$$
\left( L ( F _ { \mathfrak { b } } ) \cap A \right) \times \left( L ( F _ { \mathfrak { b } } ) \cap N \right)
$$

onto $F _ { \mathbf { b } }$ . We also have ( $\approx$ meaning homeomorphism)

$$
\begin{array} { r l } & { L ( F _ { \mathbf { b } } ) \cap A \cdot N \approx \left( _ { \mathbf { q } } A \cap L ( F _ { \mathbf { b } } ) \right) \times \left( L ( F _ { \mathbf { b } } ) \cap V _ { \mathbf { R } } \cap A \cdot N \right) , } \\ & { Z ( F _ { \mathbf { b } } ) \cap A \cdot N \approx \left( _ { \mathbf { q } } A \cap Z ( F _ { \mathbf { b } } ) \right) \times \left( Z ( F _ { \mathbf { b } } ) \cap V _ { \mathbf { R } } \cap A \cdot N \right) , } \end{array}
$$
...
$$
\mathbf { \nabla } x = o _ { \mathbf { b } } { \cdot } a ^ { \prime } { \cdot } w ^ { \prime }
$$

$$
\left( a ^ { \prime } \in L ( F _ { \mathbf { b } } ) \cap _ { \mathbf { q } } A , w ^ { \prime } \in \omega _ { \ast } \right) .
$$

An arbitrary element $s \in \widetilde { \mathcal { O } } ^ { \prime }$ can be written as a product

$$
\pmb { s } = \pmb { k } ^ { \prime } \pmb { \cdot } \pmb { a } _ { 1 } \pmb { \cdot } \pmb { h } _ { b } \pmb { \cdot } \pmb { a } _ { 2 } \pmb { \cdot } \pmb { w } _ { 1 } \pmb { \cdot } \pmb { w } _ { 2 }
$$

where $a _ { 1 } , h _ { b } , a _ { 2 }$ are as in 4.12,and $k ^ { \prime } \in K ^ { \prime } , w _ { i } \in \omega _ { i } \ ( i = 1 , 2 )$ . The remarks made above imply that $o _ { \mathbf { b } } \cdot s = x$ if and only if $a _ { 2 } = a ^ { \prime }$ ， $w _ { 2 } = w ^ { \prime }$ . Thus $w _ { 1 }$ runs through $\omega _ { 1 }$ ，which is connected by assumption, $k ^ { \prime }$ through $\kappa \prime$ ,and $a _ { 1 } \cdot h _ { b }$ runs through the elements $y \in Z ( F _ { \mathbf { b } } ) \cap _ { \mathbf { q } } A$ satisfying the conditions

$$
y ^ { \beta i } \le t ( i < b ) , \qquad y ^ { \beta b } \le u \cdot t ,
$$

which define clearly a connected set;whence our contention.

4.15.PRoPosITioN. We keep the notation of 4.1l. Every point $v ^ { * } \in V ^ { * }$ has a fundamental set of open neighborhoods $U$ such that $U \cap V$ is connected.

Let $\Gamma ^ { \prime }$ be a normal subgroup of finite index of $\mathbf { r }$ . Then $V ^ { * } = V ^ { * } ( \Gamma ) =$ $X ^ { * } / \Gamma$ is the quotient of $X ^ { * } / \Gamma ^ { \prime }$ by $\Gamma / \Gamma ^ { \prime }$ .Let $G _ { i }$ $\left( 1 \leq i \leq m \right)$ ）be the simple $\mathbf { Q }$ factors of $G$ and,as in 3.3 (i), let $\Gamma ^ { \prime }$ be the group generated by the $\Gamma _ { i } ^ { \prime } = G _ { i \mathbf { R } } ^ { _ { 0 } } \cap \mathbf { r }$ Then $\begin{array} { r } { X ^ { * } / \Gamma ^ { \prime } = \prod _ { i } X _ { i } ^ { * } / \Gamma _ { i } } \end{array}$ . It suffices therefore to consider the case where $G$ is simple over $\mathbf { Q }$ and $\Gamma \subset G _ { \mathbf { R } } ^ { 0 }$ . We may furthermore assume ${ \boldsymbol { x } } \in F _ { \mathbf { b } }$ .We use the notation of 4.13,4.14, take ${ \mathfrak { C } } _ { 0 } ^ { \prime }$ with $\mathfrak { S } _ { 0 }$ verifying 4.7,and $\bar { \mathfrak { S } } _ { 0 }$ containing $x$ ： We choose the elements $\boldsymbol { e } _ { i } \in N ( F _ { \mathbf { b } } ) _ { \mathbf { Q } }$ as in the proof of 4.13; in particular, $x \cdot e _ { i } ^ { - 1 } \in o _ { \mathbf { b } } \cdot \mathcal { \ C } _ { 0 } ^ { \prime }$ . Moreover，we may so arrange things that each $x \cdot e _ { i } ^ { - 1 }$ is contained in the (relative) interior of $F _ { \mathbf { b } } \cap \bar { \mathcal { \infty } } _ { \mathfrak { d } }$ ; this is an easy consequence of the two following facts: the fixed set $C$ of 4.13 is finite,and the number of elements in the intersection of any orbit of $\Gamma$ in $X ^ { * }$ with the closure of any Siegel domain (constructed with respect to the given torus,ordering,etc.） is finite.

Let $\pmb { { \cal E } }$ be a connected open neighborhood of $x$ in $\boldsymbol { \mathsf { \Pi } } ^ { F }$ ,small enough so that $E \cdot e _ { i } ^ { - 1 } \subset o _ { \mathbf { b } } \cdot \mathcal { ( } \mathcal { \leq } _ { 0 } ^ { \prime }$ for all $\textit { i }$ Given $u > 0$ ，there exists $g _ { 0 } \in \mathcal { ( } \mathcal { } _ { 0 , b } ^ { \prime } ( u , E )$ such that $x = o _ { \mathbf { b } } \cdot g _ { 0 }$ (see 4.12 (ii)). By construction, $o _ { \mathbf { b } } \cdot g _ { \mathbf { \imath } } \cdot e _ { i } ^ { - 1 } \in o _ { \mathbf { b } } \cdot \mathcal { \breve { \mathbf { \Gamma } } } _ { 0 } ^ { \prime }$ ；hence (loc.cit.), $o _ { \mathsf { b } } \cdot g _ { \flat } \cdot e _ { i } ^ { - 1 } \in o _ { \mathsf { b } } \bullet \mathfrak { S } _ { \flat , b } ^ { \prime } ( \boldsymbol { u } , \boldsymbol { E } \cdot \boldsymbol { e } _ { i } ^ { - 1 } )$ ; there exists therefore $u _ { i }$ in the isotropy subgroup of $O _ { \mathbf { b } }$ in $N ( F _ { \mathbf { b } } )$ such that $u _ { i } \cdot g _ { 0 } \cdot e _ { i } ^ { - 1 } \in \mathbb { S } _ { 0 , b } ^ { \prime } ( u , E \cdot e _ { i } ^ { - 1 } )$

The groups $K \cap L ( F _ { \mathbf { b } } )$ and $K \cap Z ( F _ { \mathbf { b } } )$ are maximal compact in $L ( F _ { \mathbf { b } } )$ and $Z ( F _ { \mathbf { b } } )$ ,and the first one is the isotropy group of $O _ { \mathbf { b } }$ in $L ( F _ { \mathbf { b } } )$ . Moreover,

$$
Z ( F _ { \mathbf { b } } ) = \left( K \cap Z ( F _ { \mathbf { b } } ) \right) \cdot \left( P \cap Z ( F _ { \mathbf { b } } ) \right) .
$$

Since $N ( F _ { \mathfrak { b } } ) = L ( F _ { \mathfrak { b } } ) \cdot Z ( F _ { \mathfrak { b } } )$ by 3.3,we may write (not uniquely):
...
for all $u > 0$ ,all $i$ ,and all $E ^ { \prime }$ subject to our previous conditions.

We let $h$ be an element of $\mathbf { \mathbf { q } } A _ { b }$ such that $h ^ { \beta _ { b } } \leqq t ^ { - 1 } \cdot u$

By construction, $o _ { \mathbf { b } } \cdot s _ { i } \cdot g _ { 0 } = x$ and $s _ { i } \cdot g _ { 0 } \in \widetilde { \mathcal { O } } ^ { \prime }$ ; hence, $s _ { i } \cdot g _ { 0 } \in \mathcal { O } _ { b } ^ { \prime } ( t , E ^ { \prime } )$ ,and therefore (4.12 (ii)):

$$
h \cdot s _ { i } \cdot g _ { 0 } \in \mathcal { O } _ { b } ^ { \prime } ( u , E ^ { \prime } ) \ .
$$

By 4.12 (ii),we have

$$
o \cdot h \cdot u _ { i } \cdot g _ { 0 } \cdot e _ { i } ^ { - 1 } \in o \cdot \mathfrak { S } _ { b } ^ { \prime } ( u , E ^ { \prime } \cdot e _ { i } ^ { - 1 } ) \ .
$$

But ${ \bf \mathbf { \mathbf { Q } } } ^ { A _ { b } }$ centralizes $L ( F _ { \mathbf { b } } )$ and $K \cap Z ( F _ { \mathbf { b } } )$ ; therefore,

$$
o \cdot h \cdot u _ { i } \cdot g _ { 0 } \cdot e _ { i } ^ { - 1 } = o \cdot h \cdot k _ { i } ^ { \prime } \cdot k _ { i } ^ { \prime \prime } \cdot s _ { i } \cdot g _ { 0 } \cdot e _ { i } ^ { - 1 } = o \cdot h \cdot s _ { i } \cdot g _ { 0 } \cdot e _ { i } ^ { - 1 } ~ ,
$$

whence

$$
o \cdot h \cdot s _ { i } \cdot g _ { 0 } \in o \cdot \mathfrak { S } _ { b } ^ { \prime } ( u , E ^ { \prime } \cdot e _ { i } ^ { - 1 } ) \cdot e _ { i } \ ,
$$
...
$$
J ( x , g ) = J ( o \cdot s , g ) = J ( o , s ) ^ { - 1 } \cdot J ( o , s \cdot g )
$$
...
As pointed out in 4.12 (i), since $s \in \widetilde { \mathcal { O } } _ { F } ^ { \prime }$ , the element $a _ { 2 }$ is bounded on ${ \widetilde { \mathcal { C } } } _ { F } ^ { \prime }$ ，and there exists $t ^ { \prime } \geq t$ such that

$$
h \cdot a _ { \scriptscriptstyle 1 } \in { \bf { \Gamma } } _ { \bf Q } A _ { t } , \ .
$$

From (2),we get

$$
\begin{array} { r } { s = a _ { \circ } \cdot h \cdot a _ { 1 } \cdot q \cdot ( h \cdot a _ { 1 } ) ^ { - 1 } \cdot h \cdot a _ { 1 } = c \cdot h \cdot a _ { 1 } \qquad ( c = a _ { \circ } \cdot h \cdot a _ { 1 } \cdot q \cdot ( h \cdot a _ { 1 } ) ^ { - 1 } ) \ ; } \end{array}
$$

hence,by 1.11,

$$
J ( o , s ) = J ( o , c ) \cdot J ( o , h ) \ .
$$

By 4.1,and the above remark on $a _ { 2 }$ , the element $\pmb { c }$ varies in a compact set when $s \in \ @ _ { F } ^ { \prime }$ ; hence,
...
$$
g = u \star t \cdot w \cdot v \ , \qquad \quad ( u , v \in U _ { \mathbf { q } } , t \in Z ( S ) _ { \mathbf { q } } , w \in N _ { \scriptscriptstyle { N ( F ) } } ( S ) _ { \mathbf { q } } )
$$

whence

$$
\begin{array} { r } { s \cdot g = d \cdot f \cdot v \qquad \left( d = c \cdot h \cdot a _ { 1 } \cdot \mathcal { U } \cdot ( h \cdot a _ { 1 } ) ^ { - 1 } \cdot t \cdot w ; f = w ^ { - 1 } \cdot h \cdot a _ { 1 } \cdot w \right) . } \end{array}
$$

Since $\pmb { c }$ varies in a compact set, 4.1 and (2) show that so does $d$ . We may write

$$
v = v ^ { \prime } \cdot v ^ { \prime \prime } \qquad \left( v ^ { \prime } \in L ( F ) \cap U , v ^ { \prime \prime } \in Z ( F ) \right.
$$

The element $v ^ { \prime }$ commutes with the subtorus $Z ( F ) \cap S = S _ { \theta } ( \theta = \{ \beta _ { b + 1 } , \cdots , \beta _ { s } \} )$ Since $\theta$ is a connected component of the set $\mathbf { \Delta q } \Delta - \{ \beta _ { b } \}$ of simple $\mathbf { Q }$ -roots of $N ( F )$ , the Weyl group relative to $\mathbf { Q }$ of $N ( F )$ also leaves $S _ { \theta }$ stable.Therefore $v ^ { \prime }$ commutes with $f$ ，we have $\begin{array} { r } { s \cdot g = d \cdot v ^ { \prime } \cdot f \cdot v ^ { \prime \prime } } \end{array}$ ,and,by (1.11),
...
and the proposition follows now from (1),(5),(7),and (8).
...
where $d h$ is a Haar measure on $H$ , chosen once and for all.

5.4.THEOREM. Let $\mathbf { \Gamma } ^ { \Gamma }$ be a discrete subgroup of $H$ Let $f \colon H \to V$ be $^ { a }$ function which belongs to $L ^ { 1 } ( H ) \otimes V$ is $\mathcal { Z } ( { \mathfrak { g } } )$ -fnite,and is of finite type on the right, with respect to $\kappa$ Then the series

$$
\begin{array} { r } { p _ { f } ( g ) = \sum _ { \gamma \in \Gamma } f ( g \cdot \gamma ) \ , \qquad p _ { \mid \mid f \mid \mid } ( g ) = \sum _ { \gamma \in \Gamma } \mid \mid f ( g \cdot \gamma ) \mid \mid , } \end{array}
$$

are absolutely and uniformly convergent on compact subsets,and are bounded on $H$

It is enough to prove this for $\mathcal { p } _ { | | f | | }$ . Since $\mathbf { \Gamma } ^ { \Gamma }$ is discrete,we may find a symmetric compact neighborhood $U$ of $e$ such that $U ^ { 2 } \cap \Gamma = \{ e \}$ . By 5.3, there exists $\alpha \in C _ { c } ^ { \infty } ( U )$ such that

$$
f ( g \cdot \gamma ) = \int _ { H } f ( g \cdot \gamma \cdot h ^ { - 1 } ) \cdot \alpha ( h ) d h \ ;
$$

$$
( g \in H , \gamma \in \Gamma )
$$

this can also be written

$$
f ( g \cdot \gamma ) = \int _ { \cal H } f ( g \cdot h ^ { - 1 } ) \alpha ( h \cdot \gamma ) d h ~ .
$$

Let $M$ be the maximum of $| \alpha |$ on $H$ Since $_ \alpha$ has its support in $U = U ^ { - 1 }$ ，we have then

$$
\| f ( g \cdot \gamma ) \| \leq M \cdot \int _ { \tau \cdot \gamma ^ { - 1 } } \lvert | f ( g \cdot h ^ { - 1 } ) \rvert | \cdot d h \ .
$$

But $U { \cdot } \gamma \cap U { \cdot } \gamma ^ { \prime } = \emptyset$ if $\gamma \neq \gamma ^ { \prime }$ ,hence

$$
\begin{array} { r } { \sum _ { \gamma \in \Sigma } \vert \vert \boldsymbol { f } ( \boldsymbol { g } \cdot \gamma ) \vert \vert \le M \Big \{ \vert \boldsymbol { f } ( \boldsymbol { g } \cdot \boldsymbol { h } ^ { - 1 } ) \vert \vert \boldsymbol { d } \boldsymbol { h } \le M \vert \vert \boldsymbol { f } \vert \vert _ { L ^ { 1 } } , } \end{array}
$$

which proves that $p _ { | | f | }$ is bounded on $\pi$ ·

Let now $C$ be a compact subset of $H$ Given $\varepsilon > 0$ , there exists a compact subset $D$ of $H$ such that

$$
\int _ { \pi - D } \lvert | f ( h ) \rvert | d h \rvert \leq \varepsilon .
$$
...
from which the uniform convergence of $p _ { \vert \vert f \vert \vert }$ on $C$ follows.
...
$$
\mu ( x , g ) = ( e ^ { t x } \cdot g ) _ { \circ } \in E _ { \mathrm { C } } \ ,
$$
...
be the canonical automorphy factor of the bounded realization $D$ of $X$ (1.8), and let

$$
\mu _ { \rho } ( x , g ) = \rho ( \mu ( x , g ) ) \ ,
$$

where $\rho$ also denotes the natural extension to $K _ { \mathrm { c } }$ of $\rho$ . Since $\mu ( x , k ) = k$ $( k \in K )$ , we have in particular,
...
To a function $F \colon D \to V .$ ，we associate $f \colon H \to V$ by

$$
f ( g ) = \mu _ { \rho } ( o , g ) \cdot F \big ( \zeta ( g ) \big )
$$
...
From (2),and the cocycle identity (1.8),it follows that

$$
f ( k \cdot g ) = \rho ( k ) \cdot f ( g )
$$
...
It is easily seen that $F \mapsto f$ is in fact a bijection of the set of $V \mathrm { . }$ -valued functions on $D$ onto the set of $V \mathrm { . }$ -valued functions on $\pi$ which satisfy (4).

5.7. LEMMA. We keep the notation of 5.6. Then

(a） the function $\pmb { F }$ on $D$ is holomorphic if and only if $Y \cdot f = 0$ for all $Y \in { \mathfrak { p } } ^ { - }$ (b）Let f: $H \to V$ be a function which satisfies 5.6 (4) and $Y \cdot f = 0$ ， $( Y \in { \mathfrak { p } } ^ { - } )$ . Then $f$ is Z(g)-finite.

The second assertion is proved in [35,Exp.10, pp.6-8]. As a matter of fact,it is only explicitly stated there that $f$ is an eigenfunction of $\mathcal { Z } ( { \mathfrak { g } } )$ if $\rho$ is irreducible,but the proof also yields (b).

Part (a) is also known,and mentioned in [35,Exp.10,p.6]. For the sake of completeness,we indicate a proof.If we view $\mathfrak { g }$ as a Lie algebra of differential operators on $D$ , via the action of $G _ { \mathbf { R } } ^ { 0 }$ , then the elements of $\mathfrak { p } ^ { - }$ are the linear combinations with constant coeffcients of the partial derivatives $\partial / \partial { \overline { { z } } _ { i } }$ ，where the $z _ { i }$ are coordinates in ${ \mathfrak { p } } ^ { + }$ .Therefore it is enough to show

$$
Y f ( g ) = \mu _ { \rho } ( o , g ) \cdot Y F ( \zeta ( g ) )
$$

$$
( Y \in { \mathfrak { p } } ^ { - } ; g \in H ) \ .
$$

Let first $Y \in { \mathfrak { g } } _ { \mathbf { R } }$ . We may write
...
$$
( Y _ { \pm } \in { \mathfrak { p } } _ { \pm } ; Y _ { \circ } \in { \mathfrak { k } } _ { \mathrm { c } } )
$$

where,obviously

$$
Y _ { \scriptscriptstyle 0 } = \Big ( { \frac { d } { d t } } ( e ^ { t Y } ) _ { \scriptscriptstyle 0 } \Big ) _ { t = \scriptscriptstyle 0 } .
$$

We have

$$
Y f ( e ) = \frac { d } { d t } \left( \mu _ { \rho } ( o , e ^ { t Y } ) \cdot F ( o \cdot e ^ { t Y } ) \right) \Big | _ { t = 0 } ,
$$

hence,using (3),and denoting by $d \rho \colon { \mathfrak { g } } _ { \mathbf { C } } \longrightarrow { \mathfrak { g l } } ( V )$ the differential of $\rho$ ，

$$
Y f ( e ) = d \rho ( Y _ { 0 } ) \cdot F ( o ) + Y \cdot F ( o ) .
$$

By linearity this formula extends to all $Y \in { \mathfrak { g } }$ If $Y \in { \mathfrak { p } } ^ { - }$ ，then $Y _ { \mathrm { 0 } } = 0$ ,and (4) yields (1) for $g = e$ .Now the correspondence 5.6 (3) associates to the right translate $f ^ { \prime } = r _ { g } \cdot f ( g \in H )$ the function $F ^ { \prime }$ given by $F ^ { \prime } ( x ) = \mu _ { \mathfrak { p } } ( x , g ) \cdot F ( x \cdot g )$ Since $\mu _ { \rho }$ is holomorphic in $x$ , we have $Y F ^ { \prime } ( o ) = \mu _ { \mathrm { \scriptsize \rho } } ( o , g ) \cdot Y F ( o \cdot g )$ ；on the other hand $Y ( r _ { g } f ) ( e ) = Y f ( g )$ ,hence (4),applied to $f ^ { \prime }$ and $F ^ { \prime }$ ,yields (1).

5.8.LEMMA.Let $J ( x , g )$ be the functional determinant function in the bounded realization of $X$ . Then $g \mapsto J ( o , g ) ^ { a }$ is in $L ^ { 1 } ( H )$ for every integer $a \geq 2$

We know that $J ( x , k ) = \operatorname* { d e t } \mathrm { A d } _ { \mathfrak { p } + } k ^ { - 1 }$ is a scalar independent of $x$ ，of modulus one $( k \in K )$ .By the cocycle formula, $g \mapsto \vert J ( o , g ) \vert ^ { a }$ is therefore left and right invariant under $\kappa$ ,and in particular may be viewed as a function on $D$ .We have
...
Letting $J _ { i }$ be the functional determinant function in the canonical bounded realization $D _ { i }$ of $X _ { i }$ ,we have

$$
\begin{array} { r } { J ( x , g ) = \prod _ { i } J _ { i } ( x _ { i } , g _ { i } ) . } \end{array}
$$

If $\mathbf { a } = ( a _ { 1 } , \cdots , a _ { q } )$ is a sequence of integers, define ${ \pmb J } ^ { \mathbf { a } }$ by
...
Then by the cocycle formula,we have formally

$$
\begin{array} { r } { p _ { f } ( g ) = \sum _ { \gamma \in \Gamma } f ( g \cdot \gamma ) = J ( o , g ) ^ { \mathrm { a } } \cdot P \big ( \zeta ( g ) \big ) . } \end{array}
$$

As before, let

$$
\begin{array} { r } { p _ { | | \boldsymbol { f } | | } ( \boldsymbol { g } ) = \sum _ { \gamma \in \Gamma } | | \boldsymbol { f } ( \boldsymbol { g } \cdot \gamma ) \left| \right| . } \end{array}
$$
...
$$
\mu _ { \rho ( m ) } ( x , g ) = J ( x , g ) ^ { m } \cdot \mu _ { \rho } ( x , g ) ~ ,
$$
...
For a linear transformation $A$ of a finite dimensional Hilbert space we let $| | A | | ^ { 2 } = \operatorname { T r } \left( A ^ { * } { \cdot } A \right)$ ，where $A ^ { * }$ is the adjoint of $A$ ，We claim that，given $\rho$ ， there exists $m _ { 0 }$ such that the function $\beta \colon g \mapsto | | \mu _ { \rho ( m ) } ( 0 , g ) | |$ belongs to $L ^ { 1 } ( H )$ for all $m \geq m _ { 0 }$ ：

PROOF.We have

$$
\mu ( o , k \cdot g \cdot k ^ { \prime } ) = k \cdot \mu ( o , g ) \cdot k ^ { \prime } \qquad \quad ( g \in H , k , k ^ { \prime } \in K \cap H )
$$

so that $\beta$ is right and left invariant under $\kappa$ Clearly, $\smash { \mu _ { \rho ( n ) } = J ^ { n - m } \cdot \mu _ { \rho ( m ) ; } }$ $( n , m \in \mathbf { Z } )$ ; therefore,as in 5.8,it is enough to show that $\beta$ is bounded on $A$ for m big enough.For $a \in A$ ，we have

$$
\begin{array} { r l } & { \mu ( o , a ) = a _ { \scriptscriptstyle 0 } } \\ & { \qquad = \prod _ { \scriptscriptstyle \mathrm { i } } \exp \left( \log \cosh \gamma _ { \scriptscriptstyle \mathrm { i } } \cdot H _ { \scriptscriptstyle \mathrm { i } } \right) , \qquad \left( a = \exp \left( \gamma _ { \scriptscriptstyle 1 } X _ { \scriptscriptstyle 1 } + \cdot \cdot \cdot + \gamma _ { \scriptscriptstyle t } X _ { \scriptscriptstyle t } \right) \right) } \end{array}
$$

as was recalled in 1.12. The transformations $\rho ( m ) ( a _ { 0 } )$ are simultaneously diagonalizable,and their eigenvalues are of the form $a _ { \scriptscriptstyle 0 } ^ { \scriptscriptstyle \delta }$ ，where $\delta$ runs through the weights of $\rho ( m )$ . These are the sums $m \cdot \mathscr { V } + \mathscr { \lambda }$ ，where $\lambda$ runs through the weights of $\rho$ . From 1.10,applied to each irreducible factor of $X$ ，we see that $\nu ( H _ { i } ) < 0$ for all $i$ .Consequently，there exists $m _ { 0 }$ such that $\partial ( H _ { i } ) < 0$ for all $i$ and all weights $\delta$ of $\rho ( m )$ if $m \geq m _ { 0 }$ By (3), $\beta$ is then bounded on $A$

As in 5.10,it follows that if $\varphi \colon X \to V$ is a polynomial mapping,the series

$$
\begin{array} { r } { \sum _ { \gamma \in \Gamma } J ( x , \gamma ) ^ { m } \cdot \mu _ { \rho } ( x , g ) \cdot \varphi ( x \cdot \gamma ) } \end{array}
$$

is a Poincaré series for $m \geq m _ { 0 }$ , and any discrete subgroup $\Gamma$ of $\pi$ ,to which the conclusion of 5.10 applies.

# 6.Poincaré-Eisenstein series

6.1.In this section, $G$ is a connected semi-simple $\mathbf { Q }$ -group, $H$ a subgroup of finite index of $G _ { \mathbf { R } }$ ， $\kappa$ a maximal compact subgroup of $H , V$ a finite dimensional complex Hilbert space, $P$ a parabolic $\mathbf { Q }$ -subgroup of $G$ ，and $\chi _ { \scriptscriptstyle 0 } \colon p \mapsto$ det $\operatorname { A d } _ { \mathfrak { u } } p$ $( p \in P )$ the determinant of Ad $p$ in the Lie algebra of the unipotent radical $U = R _ { u } ( P )$ of $P$

Furthermore we assume $P$ to be in the standard form (2.2). Thus $P = _ { \mathbf { Q } } P _ { \theta }$ where $\theta \subset \mathbf { _ { Q } } \Delta$ .Let $\theta ^ { \prime } = { \bf { { q } } } \Delta - \theta$ . We have then (2.3):

$$
\begin{array} { r } { \chi _ { \mathfrak { d } } = \sum _ { \alpha \in \mathfrak { d } ^ { \prime } } e _ { \alpha } d _ { \alpha } \ , } \end{array}
$$

$$
( e _ { \alpha } \in \mathbf { Q } , e _ { \alpha } > 0 )
$$

where the $d _ { \alpha }$ are fundamental highest weights for $P$ ，For every set $s =$

$( s _ { \alpha } ) _ { \alpha \in \theta ^ { \prime } }$ ：of complex numbers，we let $\Delta ( p , s )$ be the complex valued function on $P _ { \mathbf { R } }$ defined by

$$
\begin{array} { r } { \Delta ( p , s ) = \prod _ { \alpha \in \theta ^ { \prime } } \vert d _ { \alpha } ( p ) \vert ^ { - s _ { \alpha } } . } \end{array}
$$

Let $f \colon H \to V$ be a continuous function which satisfies

$$
f ( g \cdot p ) = f ( g ) \cdot \Delta ( p , s ) \qquad \quad ( g \in H , p \in P \cap H ) .
$$

Let $\mathbf { \Gamma } ^ { \Gamma }$ be an arithmetic subgroup of $G$ ,contained in $H$ ,and $\Gamma _ { \infty }$ a subgroup of finite index of $\Gamma \cap P .$ The series

$$
\begin{array} { r } { E _ { f } ( g ) = \sum _ { \gamma \in \Gamma / \Gamma _ { \infty } } f ( g \cdot \gamma ) } \end{array}
$$
...
We note that since a rational character, defined over $\mathbf { Q }$ ， takes only the values $\pm 1$ on an arithmetic subgroup,(2) implies that $f$ is right invariant under $\Gamma _ { \infty }$ ,so that the summation in (3) makes sense,and $E _ { f }$ is right invariant under $\Gamma$ . We shall need the following generalization of this result.

6.2. THEOREM. We keep the notation of 6.1. Let $f ^ { \prime } \colon H \to V$ be $^ { a }$ continuous function which is right invariant under $\Gamma _ { \infty }$ and such that

$$
m ( g ) = \operatorname { s u p } _ { p } \parallel f ^ { \prime } ( g \cdot p ) \parallel \cdot \mid \Delta ( p , s ) \mid ^ { - 1 }
$$
...
Such functions obviously exist; we may for instance simply put $f ^ { \prime \prime } ( k \cdot p ) =$ $\Delta ( p , s )$ . Since $\Delta$ is trivial on $P \cap K$ ，this is legitimate,and defines the required function on $H = K { \cdot } ( P \cap H )$ . Writing $g = k { \cdot } p \ ( k \in K , p \in P \cap H )$ ，we have
...
$$
f ^ { \prime } ( g ) \leq c \cdot f ^ { \prime \prime } ( g )
$$

whence the reduction to the case of 6.1.

We now introduce a generalization of Eisenstein series and Poincaré series, to be called Poincaré-Eisenstein series.

6.3. Let $B$ be a normal connected $\mathbf { Q }$ -subgroup of $P$ which contains the split radical $S \cdot U$ of $P .$ ，and let $C = P / B$ ，This is a reductive connected $\mathbf { Q }$ group which has no non-trivial rational character defined over $\mathbf { Q }$ . The natural projection maps $H \cap P$ and $P _ { \mathbf { R } }$ onto subgroups of finite index of $C _ { \mathbf { R } }$ . Furthermore,if $f \colon H \to V$ verifies

$$
| | f ( h \cdot c ) | | = | | f ( h ) \cdot \Delta ( c , s ) | | , \qquad ( h \in H , c \in B _ { \mathbf { R } } \cap H )
$$

then the restriction of $\left| | f { \cdot } \Delta ( \textrm { , } s ) ^ { - 1 } | \right|$ to $H \cap P$ is right invariant under $B \cap H$ and may be identified with a function on the open subgroup $( H \cap P ) / ( H \cap B ) =$ $C _ { 1 }$ of $C _ { \mathbf { R } }$

Let now $\mathbf { \varGamma }$ and $\Gamma _ { \infty }$ be as in 6.1,and $\Gamma _ { 0 } = \Gamma _ { \infty } \cap B$ .We define the Poincaré- Eisenstein series $E _ { f }$ by:
...
$$
| | f ( h \cdot b \cdot p ) | | = | | f ( h \cdot p ) | | \cdot \Delta ( b , s ) \qquad ( h \in H , b \in B \cap H , p \in P \cap H ) \ .
$$

In fact, we have $b { \cdot } p = p { \cdot } b ^ { \prime } \ ( b ^ { \prime } = p ^ { - 1 } { \cdot } b { \cdot } p )$ ,hence

$$
| | f ( h \cdot b \cdot p ) | | = | | f ( h \cdot p \cdot b ^ { \prime } ) | | = | | f ( h \cdot p ) | | \cdot \Delta ( b ^ { \prime } , s ) .
$$

But $\Delta ( b ^ { \prime } , s ) = \Delta ( b , s )$ since $P$ acts trivially by inner automorphisms on its character group，whence (1). The function $\Delta$ ,being equal to one on $\Gamma _ { 0 }$ ,and $\Gamma _ { 0 }$ being normal in $\Gamma _ { \infty }$ ,this implies in particular

$$
f ( h \cdot \tau \cdot \sigma ) = f ( h \cdot \sigma ) \qquad \quad ( h \in H , \tau \in \Gamma _ { 0 } , \sigma \in \Gamma _ { \infty } ) \mathrm { ~ . ~ }
$$

Let

$$
\begin{array} { r l } & { ~ p _ { f } ( h ) = \sum _ { \sigma \in \Gamma _ { \infty } / \Gamma _ { 0 } } f ( h \cdot \sigma ) \ , } \\ & { \underbrace { p _ { \scriptscriptstyle { | | f | } | } ( h ) } = \sum _ { \sigma \in \Gamma _ { \infty } / \Gamma _ { 0 } } \vert \vert f ( h \cdot \sigma ) \vert \vert } \end{array}
$$
...
Write $h = k _ { h } \cdot p _ { h }$ ，where $k _ { h } \in K$ and $p _ { h } \in P$ are determined up to an element of $K \cap P .$ 、In view of (i),(ii),we have, $\pi$ denoting the projection $H \cap P \to C { _ 1 }$

$$
p _ { | \vert f | \vert } ( h \cdot p ) \cdot \Delta ( p , s ) ^ { - 1 } = \Delta ( p _ { h } , s ) \cdot p _ { | \vert f ^ { \prime } | \vert } ( \pi ( p _ { h } \cdot p ) ) \ ,
$$

where

$$
\begin{array} { r } { p _ { | | f ^ { \prime } | | } ( \pi ( q ) ) = \sum _ { \sigma \in \Gamma _ { \infty } / \Gamma _ { 0 } } \left| \left| f ^ { \prime } ( \pi ( q \cdot \sigma ) ) \right. \right| } \end{array}
$$
...
so that the theorem now follows from 6.2.
...
For this to make good sense,each term of the right hand side should be right invariant under $\Gamma _ { 0 }$ . More generally,we wish to know that

$$
\varphi \big ( \sigma _ { \mathfrak { b } } ( x \cdot g \cdot \lambda ) \big ) \cdot J _ { F } ( x , g \cdot \wedge ) ^ { l } = \varphi \big ( \sigma _ { \mathfrak { b } } ( x \cdot g ) \big ) \cdot J _ { F } ( x , g ) ^ { l } \quad ( g \in G _ { \mathbb { R } } ^ { 0 } , x \in X , \lambda \in \Gamma _ { 0 } ) \ .
$$
...
$$
\begin{array} { r } { E \circ g ( x ) = \sum _ { \gamma \in \Gamma / \Gamma _ { 0 } } \varphi \big ( \sigma _ { \mathfrak { b } } ( x \cdot g ^ { - 1 } \bullet \gamma ) \big ) \cdot J _ { \mathit { r } } ( x , g ^ { - 1 } \bullet \gamma ) ^ { \iota } \ . } \end{array}
$$

We shall see shortly that this series converges absolutely for suitable $ { l }$ .It represents then an automorphic form of weight $ { l }$ for the group $\Gamma ^ { \prime } { } ^ { \prime } = g ^ { - 1 } { \cdot } \Gamma { \cdot } g$

7.2.THEOREM. There exists $a$ positive integer $l _ { 0 }$ such that,if $ { l }$ is $^ { a }$ positive multiple of $l _ { \mathfrak { d } }$ ，then the series $E _ { \varphi , l , \Gamma } \circ g$ converges absolutely and uniformly on compact sets.

It suffices to prove this for $E$

The group $N ( F ) _ { \mathrm { c } }$ is the standard parabolic group ${ \mathbf { _ { Q } } } P _ { \mathcal { I } }$ where $\boldsymbol { \theta } = \mathbf { { \underline { { \alpha } } } } _ { \mathbf { Q } } \Delta - \left\{ \beta _ { b } \right\}$ in the notation of 2.2. Therefore the set $\theta ^ { \prime } = { \bf { { q } } } \Delta - \theta$ reduces to $\{ \beta _ { b } \}$ ，and $\chi _ { \mathsf { b } } ( p ) = \operatorname* { d e t } \mathrm { A d } _ { \mathsf { u } } p ( p \in N ( F ) _ { \mathrm { c } } )$ may be taken as the fundamental highest weight relative to $\mathbf { Q }$ (2.3). By 3.12 (1), we have then

$$
| J _ { \scriptscriptstyle F } ( x , g ) | = | j _ { \scriptscriptstyle F } ( \sigma _ { \mathrm { b } } ( x ) , g ) | ^ { q _ { \mathrm { b } } } \cdot \Delta ( g , n _ { b } ) ,
$$
...
where $\Delta ( g , n _ { b } ) = \chi _ { \bf b } ( g ) ^ { - n _ { b } }$

We claim that 7.2 holds if we take for $l _ { 0 }$ the smallest positive integer $\imath$ verifying 7.1 (2) and:

$$
\begin{array} { r } { l \cdot n _ { b } \in { \bf Z } \ , \qquad l \cdot n _ { b } > 1 \ ; \qquad l \cdot q _ { c ( b , \sigma ) } \geq 2 } \end{array}
$$

Let $f$ be the complex valued function on $G _ { \mathbf { R } } ^ { 0 }$ defined by

$$
f ( g ) = \varphi ( \sigma _ { \mathfrak { b } } ( \zeta ( g ) ) ) { \cdot } J _ { \scriptscriptstyle F } ( o , g ) ^ { \iota } .
$$

Since the maximal compact subgroup $\kappa$ leaves $o$ fixed,and $\mid J _ { \scriptscriptstyle F } ( o , k ) \mid = 1$ ,if $k \in K$ ,we have

$$
\mid f ( k \cdot g ) \mid = \mid f ( g ) \mid \qquad ( k \in K \cap G _ { \mathrm { R } } ^ { \circ } , g \in G _ { \mathrm { R } } ^ { \circ } ) \ .
$$

The cocycle formula and 3.11 imply

$$
\vert f ( g \cdot b ) \vert = \vert f ( g ) \vert \cdot \Delta ( b , l \cdot n _ { b } ) , \qquad ( g \in G _ { \mathrm { { R } } } ^ { _ 0 } , b \in B _ { \mathrm { { R } } } \cap G _ { \mathrm { { R } } } ^ { _ 0 } ) .
$$

From (1), we get

$$
\mid f ( g ) \mid \cdot \Delta ( g , l \cdot n _ { b } ) ^ { - 1 } = \mid \varphi \left( \sigma _ { \bf b } \cdot \zeta ( g ) \right) \mid \cdot \mid j _ { \mathcal { F } } ( o _ { \bf b } , g ) \mid ^ { l \cdot q _ { \bf b } } \qquad \left( g \in N ( F ) \cap G _ { \bf R } ^ { 0 } \right) .
$$

Taking (4),(5) and 5.7, 5.8 into account, we see that all conditions of 6.4 are fulfilled by $\mid f \mid$ ,if $ { l }$ is a positive multiple of $l _ { \scriptscriptstyle 0 }$ ; therefore

$$
\begin{array} { r } { E _ { f } ( g ) = \sum _ { \gamma \in \Gamma / \Gamma _ { 0 } } f ( g \cdot \gamma ) \ , } \end{array}
$$
...
by the cocycle identity, the theorem is proved.

As in 6.4, we may write $\pmb { { \cal E } }$ in the form

$$
\begin{array} { r } { E ( o \cdot g ) = J ( o , g ) ^ { - l } \cdot \sum _ { \gamma \in \Gamma / \Gamma _ { \infty } } \mathcal { p } _ { f } ( g \cdot \gamma ) \ , } \end{array}
$$

where

$$
\begin{array} { r } { p _ { f } = \sum _ { \lambda \in \Gamma _ { \infty } / \Gamma _ { 0 } } f ( g \cdot \lambda ) = \sum _ { \lambda \in \Gamma _ { \infty } / \Gamma _ { 0 } } \varphi \big ( \sigma _ { \mathrm { b } } \circ \zeta ( g \cdot \lambda ) \big ) \cdot J _ { \scriptscriptstyle F } ( o , g \cdot \lambda ) ^ { \iota } \ . } \end{array}
$$

The argument used in proving 6.4 shows that

$$
\mid f ( g \cdot b \cdot p ) \mid = \mid f ( g \cdot p ) \mid \Delta ( b , l \cdot n _ { b } ) \qquad \left( g \in G _ { \mathbf { R } } ^ { _ 0 } , b \in B \cap G _ { \mathbf { R } } ^ { _ 0 } , p \in N ( F ) \right) ;
$$

therefore,if we put again

$$
\begin{array} { r } { p _ { \vert \vert \boldsymbol { f } \vert \vert } = \sum _ { \lambda \in \Gamma _ { \infty } / \Gamma _ { 0 } } \vert \boldsymbol { f } ( \boldsymbol { g } \cdot \boldsymbol { \lambda } ) \vert , } \end{array}
$$

we have

$$
p _ { \mathsf { 1 } | f | \mathrm { 1 } } ( k \cdot g \cdot b ) = p _ { \mathsf { 1 } | f \mathsf { 1 } } ( g ) \cdot \Delta ( b , l \cdot n _ { b } ) \qquad \quad ( g \in G _ { \mathbf { R } } ^ { \circ } , b \in G _ { \mathbf { R } } ^ { \circ } \cap B , k \in K )
$$

As was proved in 6.4, $\mathscr { p } _ { | | f | | } ( g \cdot p ) \Delta ( p , l \cdot n _ { b } ) ^ { - 1 }$ is bounded when $g$ varies in a compact set of $G _ { \mathbf { R } } ^ { 0 }$ and $p$ in ${ \cal P } \cap { \cal G } _ { \mathbf { R } } ^ { \scriptscriptstyle 0 }$

We henceforth assume $ { \boldsymbol { l } }$ to be divisible by the integer $l _ { 0 }$ defined above.

7.3. From the geometric point of view,an automorphic form $\omega$ on $X$ of weight $ { l }$ for $\Gamma$ is a holomorphic cross section, invariant under $\Gamma$ ,of the complex line bundle $( \Lambda ^ { n } \tau ) ^ { - l }$ $( n = \operatorname { d i m } _ { \mathbf { C } } X )$ ，where $\Lambda ^ { n } \tau$ is the $n ^ { \mathrm { t h } }$ exterior power of the tangent bundle $\tau$ to $X$ If $X$ is realized as a domain in $\mathbf { C } ^ { n }$ ，then $\tau$ is canonically trivialized,and $\omega$ is represented by a holomorphic function $\omega ^ { \prime }$ on $X$ which verifies

$$
\omega ^ { \prime } ( x ) = j ( x , \gamma ) ^ { l } \cdot \omega ^ { \prime } ( x \cdot \gamma ) \ ,
$$
...
where $j ( x , \nu )$ is the functional determinant of $\nu$ at $x$ . In studying $E ^ { * }$ ，and more generally $E ^ { \ast } \circ g \ ( g \in G _ { \mathbf { Q } } )$ ，we shall use the following notation,where $J , J _ { * }$ stand for $J _ { F } , J _ { F ^ { * } }$

$$
\begin{array} { r c l } { { } } & { { } } & { { \alpha ( s ) = J ( o , s ) ^ { \iota } ~ , } } \\ { { } } & { { } } & { { } } \\ { { } } & { { } } & { { \alpha ^ { * } ( s ) = J _ { * } ( o , s ) ^ { \iota } ~ , } } \\ { { } } & { { } } & { { \beta ( s ) = \sum _ { \lambda \in \Gamma _ { \infty } / \Gamma _ { 0 } } { \varphi } \big ( { \sigma } _ { \mathfrak { b } } \cdot \zeta ( s \cdot \lambda ) \big ) \alpha ( s \cdot \lambda ) ~ , } } \end{array}
$$
...
Thus, $\beta$ is the function $p _ { f }$ of 7.2 (10), and we have, by 7.1 (4) and 7.2 (9):

$$
\begin{array} { r } { ( E \circ g ) ( o \cdot s ) = \alpha ( s ) ^ { - 1 } \cdot \sum _ { \gamma \in \Gamma / \Gamma _ { \infty } } \beta ( s \cdot g ^ { - 1 } \cdot \gamma ) } \end{array}
$$
...
$$
\begin{array} { r l } & { ( E ^ { * } \circ g ) ( o , s ) } \\ & { \quad = d ^ { - 1 } { \cdot } \alpha ^ { * } ( s ) ^ { - 1 } { \cdot } \sum _ { \gamma \in \Gamma / \Gamma _ { \infty } } \beta ( s { \cdot } g ^ { - 1 } { \cdot } \gamma ) \qquad \quad ( s , g \in G _ { \mathrm { \mathbf { R } } } ^ { \circ } ; d = j ( o , \mathfrak { p } ) ^ { \iota } ) \ . } \end{array}
$$

In fact,the obvious equality

$$
j ( x , y ) \cdot J _ { * } \bigl ( \ d y ( x ) , s \bigr ) = J ( x , s ) \cdot j ( x \cdot s , y ) \ , \qquad \quad ( s \in G _ { \mathrm { R } } ^ { 0 } , x \in S _ { \mathrm { b } } )
$$

shows that

$$
d { \cdot } \alpha ^ { * } ( s ) = \alpha ( s ) { \cdot } j ( o { \cdot } s , \ y ) ^ { l } \ .
$$

On the other hand

$$
\begin{array} { r l } & { ( E ^ { * } \circ g ) ( o \cdot s ) = J _ { * } ( o \cdot s , g ^ { - 1 } ) ^ { l } \cdot E ^ { * } ( o \cdot s \cdot g ^ { - 1 } ) } \\ & { \qquad = J _ { * } ( o \cdot s , g ^ { - 1 } ) ^ { l } \cdot { j } ( o \cdot s \cdot g ^ { - 1 } , y ) ^ { - l } \cdot E ( o \cdot s \cdot g ^ { - 1 } ) } \\ & { \qquad = J _ { * } ( o , s ) ^ { - l } \cdot J _ { * } ( o , s \cdot g ^ { - 1 } ) ^ { l } \cdot { j } ( o \cdot s \cdot g ^ { - 1 } , y ) ^ { - l } \cdot E ( o \cdot s \cdot g ^ { - 1 } ) \ . } \end{array}
$$

Together with (9), this gives

$$
( E ^ { * } \circ g ) ( o \cdot s ) = \alpha ^ { * } ( s ) ^ { - 1 } \bullet d ^ { - 1 } \bullet \alpha ( s \cdot g ^ { - 1 } ) \cdot E ( o \cdot s \cdot g ^ { - 1 } ) \ ,
$$
...
where $\mathbf { \delta } m _ { 0 } , \mathbf { \delta } \sigma$ is the positive integer associated to $G _ { \sigma }$ by 1.10,and denoted by $m _ { 0 }$ there.This expression is indeed independent of $b \geq 1$ .From now on，we write $\textcircled { m }$ for $m _ { b }$ . From (1),we get

$$
\begin{array} { r } { a ^ { \wedge } = a ^ { \sharp m \nu b \beta _ { \ast } } \prod _ { 1 \leq i \leq b } a ^ { 2 m \ast \beta _ { i } } \cdot \prod _ { b < _ { i } < s } a ^ { 2 m b \beta _ { i } } \qquad ( b \geq 1 , m > 0 , a \in _ { \mathbb { Q } } { \cal A } ) \ . } \end{array}
$$

The roots $\beta _ { i }$ $\beta _ { i } \ ( i > b ^ { * } )$ are multiplicatively bounded on $a ( s ) ( s \in \mathfrak { S } ^ { * } )$ . Therefore if $\chi = c _ { 1 } \beta _ { 1 } + \dots + c _ { s } \beta _ { s } \left( c _ { i } \in \mathbf { Q } \right)$ is a character on $\mathbf { \Omega } _ { \mathbf { Q } } A$ ， we have

$$
\begin{array} { r } { a ( s ) ^ { \times } \asymp \prod _ { 1 \leq i \leq b ^ { * } } a ( s ) ^ { c _ { i } \cdot \beta _ { i } } \ , } \end{array}
$$
...
In particular,taking (i) into account:

$$
\begin{array} { r l } & { \alpha ^ { * } \big ( a ( s ) \big ) \asymp \prod _ { \iota \leq i \leq b ^ { * } } a ( s ) ^ { - 2 m \cdot i \cdot \beta _ { i } } } \\ & { \alpha ^ { * } \big ( a ( s ) \big ) \asymp a ^ { - 2 m s \nu \beta _ { s } } \cdot \prod _ { 1 \leq \ell < s } a ^ { - 2 m i \beta _ { i } } \ , } \end{array}
$$

$$
\begin{array} { l } { \left( 1 \leq b ^ { * } < s \right) , } \\ { \left( s \in \widetilde { \mathfrak { S } } ^ { * } ; b ^ { * } = s \right) . } \end{array}
$$

These relations and (3) yield (ii) and

$$
\begin{array} { r l r l } & { \alpha ^ { * } ( a ( s ) ) \cdot a ( s ) ^ { \wedge } \asymp \prod _ { b < i \leq b ^ { * } } a ( s ) ^ { - 2 m ( i - b ) \beta _ { i } } , } & & { ( s \in \mathfrak { S } ^ { * } ; b < b ^ { * } < s ) ~ . } \\ & { \alpha ^ { * } ( a ( s ) ) \cdot a ( s ) ^ { \wedge } \asymp a ^ { - 2 m ( s - b ) \nu \beta _ { s } } \cdot \prod _ { b < i \leq s } a ( s ) ^ { - 2 m ( i - b ) \beta _ { i } } } & & { ( b < b ^ { * } = s ) ~ , } \end{array}
$$
...
$$
c ( k \cdot g \cdot p ) = c ( g ) \cdot \mid p ^ { - \Lambda } \mid
$$
...
It is also clear that if $h$ varies in a compact set $C$ and $g \in G _ { \mathbf { R } }$ ，then $c ( g ) \asymp c ( h \cdot g )$ . In particular,if ${ \mathfrak { S } } ^ { \prime }$ is a Siegel domain in the minimal standard parabolic $\mathbf { Q }$ -group $P .$ ,then,using 4.1,we see that

$$
c ( a ( s ) \cdot g ) \asymp c ( s \cdot g ) ~ ,
$$

$$
( s \in { \mathfrak { S } } ^ { \prime } , g \in G _ { \mathbf { R } } )
$$

where, as in 7.4, $a ( s )$ denotes the component in $\mathbf { \_ } A$ of $\pmb { s }$ . The main properties of interest to us of the function $\mathscr { c }$ are given by the following lemma:

7.6. LEMMA. We keep the notation of 7.4, 7.5, choose $t > 0$ ，and let ${ \pmb a } _ { 0 }$ be the element of $\mathbf { \_ } A$ on which all simple $\mathbf { Q }$ -roots $\beta _ { i }$ take the value $t$ . Then,

$$
a ^ { \scriptscriptstyle \Lambda } \cdot c ( a \cdot h ) \le a _ { \scriptscriptstyle 0 } ^ { \scriptscriptstyle \Lambda } \cdot c ( a _ { \scriptscriptstyle 0 } \cdot h ) ( h \in G _ { \scriptscriptstyle \mathrm { R } } ; a \in _ { \scriptscriptstyle \mathrm { Q } } A _ { t } )
$$

(ii) $\begin{array} { r } { \operatorname* { l i m } _ { a } \beta _ { b ^ { * } \to 0 } a ^ { \Lambda } { \cdot } c ( a { \cdot } g ) = 0 } \end{array}$ if $b ^ { * } \geq b$ and $g \notin N ( F _ { \mathbf { b } ^ { * } } ) \cdot N ( F _ { \mathbf { b } } )$ ， $( g \in G _ { \mathbf { Q } } , a \in \mathbf { \mathbf { \mathbf { q } } } A _ { t } )$

We refer to the situation in 7.5. Since $\mathbf { \nabla } _ { \mathbf { Q } } A$ is represented by self-adjoint operators in $V$ ，the space $V$ is the direct sum of the mutually orthogonal subspaces

$$
V _ { \mu } = \{ v \in V , \rho ( a ) \cdot v = a ^ { \mu } \cdot v , ( a \in \mathbf { \_ g } A ) \} \ ,
$$

corresponding to the different $\mathbf { Q }$ -weights $\mu$ of $\rho$ . The space $V _ { \Lambda }$ being onedimensional,spanned by the unit vector $\scriptstyle { e _ { 0 } }$ , we may write

$$
\begin{array} { r } { \rho ( h ) \cdot e _ { 0 } = d ( h ) \cdot e _ { 0 } + \sum _ { \mu } f _ { \mu } ( h ) \ , \qquad \quad \left( f _ { \mu } ( h ) \in V _ { \mu } ; d ( h ) \in { \bf R } ; h \in G _ { \bf R } \right) \ , } \end{array}
$$

whence

$$
\begin{array} { r } { c ( h ) ^ { - 2 } = d ( h ) ^ { 2 } + \sum _ { \mu } \vert \vert f _ { \mu } ( h ) \vert \vert ^ { 2 } , } \end{array}
$$

and

$$
\begin{array} { r } { \rho ( a \cdot h ) \cdot e _ { \mathrm { 0 } } = a ^ { \wedge } \cdot d ( h ) \cdot e _ { \mathrm { 0 } } + \sum _ { \mu } a ^ { \mu } \cdot f _ { \mu } ( h ) \ , \ ~ ( a \in \mathsf { q } , h \in G _ { \mathrm { R } } ) \ . } \end{array}
$$

It is known [14, $\ S 1 2 . 1 4 ]$ that every $\mathbf { Q }$ -weight is of the form

$$
\begin{array} { r } { \mu = \Lambda - \sum _ { 1 \leq i \leq s } m _ { i } ( { \boldsymbol { \mu } } ) \cdot \beta _ { i } \qquad \quad \qquad \left( m _ { i } ( { \boldsymbol { \mu } } ) \in { \bf Z } , m _ { i } ( { \boldsymbol { \mu } } ) \geq 0 \right) ; } \end{array}
$$

hence

$$
\begin{array} { r } { a ^ { - \Lambda } \cdot \rho ( a \cdot h ) \cdot e _ { 0 } = d ( h ) \cdot e _ { 0 } + \sum _ { \mu } \left( \prod _ { i } a ^ { - m _ { i } ( \mu ) \cdot \beta _ { i } } \right) \cdot f _ { \mu } ( h ) \qquad ( a \in \mathfrak { _ { d } } A , h \in G _ { \mathtt { R } } ) \ . } \end{array}
$$

Using(1) and the definition (7.5) of $c$ ， we have

$$
\begin{array} { r } { \mid c ( a \cdot h ) \cdot a ^ { \wedge } \mid ^ { - 2 } = d ( h ) ^ { 2 } + \sum _ { \mu } \left( \prod _ { i } a ^ { - 2 m _ { i } ( \mu ) \beta _ { i } } \right) \mid \mid f _ { \mu } ( h ) \mid \mid ^ { 2 } . } \end{array}
$$

Since the $m _ { i } ( \mu ) { \mathrm { ~ a r e ~ } } \geq 0$ ，we have

$$
a ^ { - 2 m _ { i } ( \mu ) \beta _ { i } } \geq a _ { 0 } ^ { - \mathfrak { s } m _ { i } ( \mu _ { i } ) \beta _ { i } } = t ^ { - \mathfrak { s } m _ { i } ( \mu ) } ,
$$

for all $\mu$ and all $_ i$ ，whence (i).

Let $P = M \cdot S \cdot U$ be the minimal standard parabolic $\mathbf { Q }$ group (2.2) which underlies the definition of the standard boundary components.As recalled in 2.2,the element $g \in G _ { \mathbf { Q } }$ may be written as

$$
g = u \cdot n _ { g } \cdot u ^ { \prime } \qquad \quad ( u , u ^ { \prime } \in { \cal U } _ { \bf Q } ; n _ { g } \in N ( { \cal S } ) _ { \bf Q } ) \ ,
$$

where $\scriptstyle { n _ { g } }$ is uniquely determined by $g$ .Let $w _ { g }$ be the image of $n _ { g }$ in the relative Weyl group $_ { \mathrm { q } } W ( G ) = N ( S ) / Z ( S )$

We have $a { \cdot } g = a { \cdot } u { \cdot } a ^ { - 1 } { \cdot } n _ { g } { \cdot } n _ { g } ^ { - 1 } { \cdot } a { \cdot } n _ { g } { \cdot } u ^ { \prime }$ ,and consequently
...
The transform $\mathfrak { v } = w _ { g } ( \Lambda )$ of $\Lambda$ by $w _ { g }$ is a weight of $\rho$ ,and therefore has the form

$$
\begin{array} { r } { \pmb { \mathscr { v } } = \Lambda - \sum _ { i } m _ { i } ( \pmb { \mathscr { v } } ) \beta _ { i } , \qquad \quad \ \left( m _ { i } ( \pmb { \mathscr { v } } ) \geq 0 , m _ { i } ( \pmb { \mathscr { v } } ) \in \mathbf { Z } \right) . } \end{array}
$$

Thus we are reduced to studying the product

$$
\prod _ { i } a ^ { m _ { i } ( \nu ) \cdot \beta _ { i } } .
$$

Since $a \in \mathbf { \mathbf { \mathbf { \mathbf { q } } } } A _ { t }$ ,each factor is bounded above.Let $\theta ( \mathfrak { z } ) = \{ \beta _ { i } | m _ { i } ( \mathfrak { z } ) > 0 \}$ .It follows from [14, $\ S 1 2 . 1 6 ]$ that $\theta ( \nu ) \cup \Lambda$ is connected； by construction, $\Lambda$ is orthogonal to all simple $\mathbf { Q }$ -roots except $\beta _ { b }$ . Now,if $g \notin N ( F _ { \mathbf { b } } )$ ，then $\nu \neq \Lambda$ therefore $\theta ( \nu )$ is non-empty,and we must have $m _ { b } ( \pmb { \nu } ) \neq 0$ . It follows that

$$
\begin{array} { r } { \operatorname* { l i m } _ { a } \beta _ { b \to 0 } \prod _ { i } a ^ { m _ { i } ( \nu ) \cdot \beta _ { i } } = 0 } \end{array}
$$

$$
( a \in \mathbf { \mathbf { \mathbf { \mathbf { q } } } } A _ { t } )
$$

which proves (i) if $b ^ { * } = b$ . Let now $b ^ { * } > b$ ,and assume that the limit is not zero.Then $m _ { b ^ { * } } ( \mathfrak { x } ) = 0$ ,and $\theta ( \nu )$ is contained in the set $\mathbf { \Delta q } \Delta - \{ \beta _ { b ^ { * } } \}$ of $\mathbf { Q }$ -simple roots of $N ( F _ { \mathbf { b ^ { * } } } ) _ { \mathrm { c } } / U ( F _ { \mathbf { b ^ { * } } } ) _ { \mathbf { C } }$ . Then,by [14,12.17],there exist

$$
\begin{array} { r } { n _ { \mathfrak { n } _ { 1 } } \in N ( S ) _ { \mathbf { q } } \cap N ( F _ { \mathfrak { b } ^ { \ast } } ) \ , \qquad n _ { \mathfrak { n } _ { 2 } } \in N ( S ) _ { \mathbf { q } } \cap N ( F _ { \mathfrak { b } } ) \ , } \end{array}
$$

such that $n _ { g } = n _ { 1 } \cdot n _ { 2 }$ . Consequently

$$
g = g _ { 1 } { \cdot } g _ { 2 } \ , \qquad g _ { 1 } = u { \cdot } n _ { 1 } \in N ( F _ { \mathrm { b ^ { * } } } ) _ { \mathrm { q } } \ , \qquad g _ { 2 } = n _ { 2 } { \cdot } u ^ { \prime } \in N ( F _ { \mathrm { b } } ) _ { \mathrm { q } } \ ,
$$

which completes the proof of (ii).

7.7. LEMmA. We keep the notation of 7.4, 7.5. Let $g \in G _ { \mathbf { Q } }$

(i） There exists a convergent series of positive constant terms which majorizes termwise, in the truncated Siegel domain $\mathfrak { S } ^ { * }$ ， the series (see 7.3 (7)):

$$
\begin{array} { r } { ( E ^ { * } \circ g ) ( o \cdot s ) = \sum _ { \gamma \in \Gamma / \Gamma _ { \infty } } \alpha ^ { * } ( s ) ^ { - 1 } \cdot \beta ( s \cdot g ^ { - 1 } \cdot \gamma ) \ ; } \end{array}
$$

(ii） ${ \begin{array} { r l } { \cdot { f } } & { { } b ^ { * } \leq b } \end{array} }$ and $g \notin N ( F _ { \mathbf { b } ^ { * } } ) \cdot N ( F _ { \mathbf { b } } )$ ，then $\begin{array} { r } { \operatorname* { l i m } _ { s } \beta _ { b ^ { \ast }  0 } \alpha ^ { \ast } ( s ) ^ { - 1 } \cdot \beta ( s \cdot g ) = 0 , } \end{array}$ $( s \in { \mathfrak { S } } ^ { * } )$ ; (ii) $\begin{array} { r } { i f b < b ^ { * } , t h e n \operatorname* { l i m } _ { s } \beta \mathfrak { b } ^ { * } { } _ {  0 } \alpha ^ { * } ( s ) ^ { - 1 } \cdot \beta ( s \cdot g ) = 0 , ( s \in \mathfrak { S } ^ { * } ) . } \end{array}$

The function $\beta$ is equal to $p _ { f }$ , in the notation of 7.2(10),and is majorized by $p _ { | | f | | }$ . We have already remarked (7.2(12)) that

$$
p _ { | | f | | } ( h \cdot p ) \cdot \Delta ( p , n _ { b } \cdot l ) ^ { - 1 } = p _ { | | f | | } ( h \cdot p ) \cdot | ~ p ^ { - \Lambda } ~ |
$$

is bounded when $h$ varies in a compact set of $G _ { \mathbf { R } }$ and $p \in P \cap G _ { \mathbf { R } } ^ { \scriptscriptstyle 0 }$ . Since $c ( h \cdot p ) = c ( h ) \cdot \mid p ^ { - \Lambda } \mid$ by 7.5 (2),it follows then,as in 6.2, that $p _ { | | f | } { \cdot } c ^ { - 1 }$ is bounded on $G _ { \mathbf { R } } ^ { \scriptscriptstyle 0 }$ . There exists then a constant $\delta > 0$ such that

$$
| \beta ( h ) | \leq \delta \cdot c ( h ) ~ ,
$$

and therefore such that

$$
\begin{array} { r } { \hat { \sigma } \cdot \sum _ { \gamma \in \Gamma / \Gamma _ { \infty } } \alpha ^ { * } ( s ) ^ { - 1 } \cdot c ( s \cdot h \cdot \gamma ) \ , } \end{array}
$$

is a normal majorant of $( E ^ { * } \circ h ) ( s )$ for all s, $h \in G _ { \mathbf { R } } ^ { 0 }$ ， which converges in view of 6.1.

We have $c ( s \cdot h ) \asymp c ( a ( s ) \cdot h )$ for s in a Siegel domain and $h \in G _ { \mathbf { R } } ^ { \scriptscriptstyle 0 }$ by 7.5 (3), and $\alpha ^ { * } ( a ( s ) ) \asymp \alpha ^ { * } ( s )$ for $s \in \mathfrak { S } ^ { * }$ ， $( s = a ( s ) \cdot v , a ( s ) \in _ { \mathbf { q } } A , v \in V _ { \mathbf { R } } )$ by 7.4. Together with (1),this yields

$$
| \alpha ^ { * } ( s ) ^ { - 1 } \bullet \beta ( s \cdot h ) | \prec \cdot \alpha ^ { * } ( a ( s ) ) ^ { - 1 } \bullet c ( a ( s ) \cdot h )
$$

Using 7.4, we get

$$
\begin{array} { r } { \mid \alpha ^ { * } ( s ) ^ { - 1 } \cdot \beta ( s \cdot h ) \mid \prec \left( \prod _ { i = b + 1 } ^ { b ^ { * } } a ( s ) ^ { l _ { i } \beta _ { i } } \right) \cdot \left( c ( a ( s ) \cdot h ) \cdot a ( s ) ^ { \wedge } \right) , } \end{array}
$$

where the first factor on the right hand side stands for the constant one if $b ^ { * } \leq b$ ,and the $l _ { i }$ are strictly positive integers if $b ^ { * } > b$ . Let,as in $7 . 6 , a _ { 0 }$ be the element of $\mathbf { \_ } A$ on which the simple $\mathbf { Q }$ -roots take the value $t$ .Since the first factor on the right hand side of (4) is bounded on $\mathfrak { S } ^ { * }$ ,Lemma 7.6 (i) and (1) imply the existence of a constant $\delta ^ { \prime } > 0$ such that

$$
c ^ { \prime } ( h ) = \delta ^ { \prime } \cdot c ( a _ { 0 } \cdot h ) \cdot a _ { 0 } ^ { \wedge } \geq | \alpha ^ { * } ( s ) ^ { - 1 } \cdot \beta ( s \cdot h ) |
$$

$$
( s \in \mathfrak { S } ^ { * } ; h \in G _ { \mathbf { R } } ^ { 0 } ) \ .
$$

As a consequence, $E ^ { * } \circ g$ is majorized in $\mathfrak { S } ^ { * }$ by the series

$$
\sum c ^ { \prime } ( g ^ { - 1 } \cdot \gamma ) \ ,
$$

which converges,as was noted above (6.1 and 7.5 (2))，whence (i).

In view of (1),(2) it suffces to prove the statements (ii),(iii) with $\alpha ^ { * } ( s ) ^ { - 1 } \cdot \beta ( s \cdot g )$ replaced by

$$
\begin{array} { r l } { \textstyle } & { { } ( \prod _ { i = b + 1 } ^ { b ^ { * } } a ^ { l _ { i } \beta _ { i } } ) \cdot c ( a \cdot g ) \cdot a ^ { \wedge } } \end{array}
$$
...
(i) Assume $b < b ^ { * }$ . Then there exists $u _ { 0 } > 0$ such that

$$
| \mathit { \Pi } | ^ { \mathit { \Pi } _ { \mathcal { S } ^ { \ast } \circ g \left( 0 \cdot s \right) } } | < \varepsilon
$$

$$
( s \in \mathfrak { S } _ { F ^ { * } } ^ { \prime } , a ( s ) ^ { \beta _ { b ^ { * } } } < u _ { 0 } ) \ .
$$

(ii) Assume $b \geq b ^ { * }$ . Then there exists $u _ { 0 } > 0$ such that

$$
\begin{array} { r } { \big | \mathrm { ~ } E ^ { * } \circ g ( o \cdot s ) - j ( o , \mathfrak { s } ) ^ { \iota } \sum _ { \gamma \in g \cdot N ( F ^ { * } ) N ( F ) \cap \Gamma _ { \infty } } \alpha ^ { * } ( \mathfrak { s } ) ^ { - 1 } \cdot \beta ( \mathfrak { s } \cdot g ^ { - 1 } \cdot \gamma ) \big | < \mathfrak { s } } \end{array}
$$

for all $s \in { \mathfrak { S } } _ { F ^ { * } } ^ { \prime }$ satisfying $a ( s ) ^ { \beta _ { b ^ { * } } } < u _ { \mathfrak { c } }$

By 7.7 (i) the series $E ^ { * } \circ g$ has a constant majorant series in $\mathfrak { S } ^ { * }$ ，so that we may investigate its behavior termwise; 7.7 (ii) and 7.7 (iii) allow us to do this,with the theorem as an immediate consequence.

7.9. PRoPosITIoN. We keep the previous notation and assume $b ^ { * } \leq \boldsymbol { b }$ Then the series

$$
\begin{array} { r } { E ^ { * } \circ g ( o \cdot s ) = \alpha ^ { * } ( s ) ^ { - 1 } \cdot \sum _ { \gamma \in ( g N ( F ^ { * } ) N ( F ) \cap \Gamma ) / \Gamma _ { \infty } } \beta ( s \cdot g ^ { - 1 } \bullet \gamma ) } \end{array}
$$

is an automorphic form on $F ^ { * }$ ,for the group

$$
\Gamma ^ { \boldsymbol \sigma } ( F ^ { * } ) = \big ( Z ( F ^ { * } ) \cap g ^ { - 1 } \Gamma g \big ) \backslash \big ( N ( F ^ { * } ) \cap g ^ { - } \Gamma g \big ) \ ,
$$

lifted to $X$ by means of the canonical projection $\sigma _ { \mathfrak { b } ^ { * } } X  F ^ { * }$ ，of type $J _ { * } ( x , \mathbf { \theta } ) ^ { l }$ ：

Since $\mathbf { b } ^ { * } \leq \mathbf { b }$ we have a canonical factorization $\sigma = \sigma _ { \mathfrak { b } } = \tau \circ \sigma _ { * }$ where $\tau \colon F ^ { * } \longrightarrow F$ is a holomorphic map.In fact $\tau$ may be identified with the canonical projection of $F ^ { * }$ onto $F$ ，the latter being viewed as a standard rational boundary component of $F ^ { * }$

We show first that $E ^ { * } \circ g$ is holomorphic,constant along the fibres of $\pmb { \sigma } _ { \ast }$ By definition

$$
\begin{array} { r l } & { E ^ { * } \circ g ( o \cdot s ) } \\ & { \qquad = \alpha ^ { * } ( s ) ^ { - 1 } \sum _ { \gamma \in \Gamma / \Gamma _ { \infty } } \sum _ { \lambda \in \Gamma _ { \infty } / \Gamma _ { 0 } } \varphi \big ( \sigma ( o \cdot s \cdot g ^ { - 1 } \gamma \cdot \lambda ) \big ) \cdot J ( o , s \cdot g ^ { - 1 } \cdot \gamma \cdot \lambda ) ^ { l } \ , } \end{array}
$$

the range of $\gamma$ being as in (1). For fixed $\gamma$ ,the product of the series on the right hand side by $\alpha ( s \cdot g ^ { - 1 } \cdot \gamma ) ^ { - 1 }$ is a Poincaré series for $\Gamma _ { \infty } / \Gamma _ { 0 }$ on $\pmb { F }$ ,lifted to $X$ by $\sigma$ .It is therefore $^ { a }$ fortiori lifted from a holomorphic function on $F ^ { * }$ ： In order to finish the proof of our assertion,it suffices to show that

$$
\alpha ^ { * } ( s ) ^ { - 1 } \cdot \alpha ( s \cdot u \cdot v ) \ , \qquad \quad ( u \in N ( F ^ { * } ) , v \in N ( F ) )
$$

is holomorphic,as a function of $o \cdot s \in X$ ,and constant along fibres of $\sigma _ { * }$ .The equality 7.3 (8) yields

$$
\begin{array} { l } { { \alpha ^ { * } ( s ) ^ { - 1 } \cdot \alpha ( s \cdot u \cdot v ) = J _ { * } ( o , s ) ^ { - l } \cdot J ( o , s \cdot u \cdot v ) ^ { l } } } \\ { { \ \qquad = j ( o , y ) ^ { l } \cdot j ( o \cdot s , y ) ^ { - 1 } \cdot J ( o , s ) ^ { - l } \cdot J ( o , s \cdot u \cdot v ) ^ { l } } } \\ { { \ \qquad = d \cdot j ( o \cdot s , y ) ^ { - l } \cdot J ( o \cdot s , u \cdot v ) ^ { l } ~ . } } \end{array}
$$

The factors on the right hand side are of course holomorphic in $o \cdot s$ ; by 3.3 (ii), $j ( o \cdot s , \upsilon ) ^ { l }$ is constant along the fibres of $\sigma _ { * }$ . By 1.7, $Z ( F ^ { * } ) ^ { \mathfrak { o } }$ is transitive along the fibers of $\sigma _ { * }$ . In view of the cocycle identity,it suffices to prove

$$
\begin{array} { c c } { { J ( x , u ) = J ( x z , u ) } } & { { \qquad ( z \in Z ( F ^ { * } ) , u \in N ( F ^ { * } ) \big ) ~ , } } \\ { { J ( x u , v ) = J ( x z u , v ) ~ . } } & { { } } \end{array}
$$

We have $z u = u z ^ { \prime }$ （ $( z ^ { \prime } \in Z ( F ^ { * } ) )$ . Since $b ^ { * } \leq b , F \subset \tilde { F }$ ，whence $Z ( F ^ { * } ) \subset Z ( F )$ so that (2) and (3) follow from 3.3 (ii).

Let now $\gamma _ { \mathfrak { o } } \in N ( F ^ { * } ) \cap g ^ { - 1 } \cdot \Gamma \cdot g$ Thus $\gamma _ { 0 } = g ^ { - 1 } { \cdot } \gamma ^ { \prime } { \cdot } g \left( \gamma ^ { \prime } \in \Gamma \right)$ ,and it is clear that the series on the right hand side of (1) remains unaltered if $\pmb { s }$ is replaced by $s \cdot \gamma _ { 0 }$ .Moreover

$$
\alpha ^ { * } ( s \cdot \gamma _ { 0 } ) ^ { - 1 } = { \cal J } _ { * } ( o , s \cdot \gamma _ { 0 } ) ^ { - l } = { \cal J } _ { * } ( o , s ) ^ { - l } \cdot { \cal J } _ { * } ( o \cdot s , \gamma _ { 0 } ) ^ { - l } \ ;
$$

hence,

$$
{ \cal E } ^ { * } \circ g ( o \cdot s ) = { \cal J } _ { * } ( o \cdot s , \gamma _ { 0 } ) ^ { \iota } \cdot { \cal E } ^ { * } \circ g ( o \cdot s \cdot \gamma _ { 0 } ) \ ,
$$
...
8.2.The functional determinant $J _ { \mathbf { b } } ( x , g ) \ ( g \in N ( F _ { \mathbf { b } } ) , x \in X )$ is by 3.3 (ii) constant along the fibres of the projection $\sigma _ { \mathfrak { b } } \colon X \to F _ { \mathfrak { b } }$ .It defines therefore an automorphy factor on $F _ { \mathbf { b } }$ for $N ( F _ { \mathbf { b } } )$ ,hence an action of $N ( F _ { \mathbf { b } } )$ on the trivial line bundle $F _ { \mathrm { ~ b ~ } } \times \mathrm { ~ C ~ }$ given by

$$
( x , c ) \cdot n = \left( x \cdot n , J _ { \mathrm { b } } ( x , n ) \cdot c \right) \qquad \ \left( x \in F _ { \mathrm { b } } , c \in \mathbf { C } , n \in N ( F _ { \mathrm { b } } ) \right) .
$$

The $N ( F _ { \mathbf { b } } )$ -bundle thus defined will be denoted by $\xi _ { \mathbf { b } }$ If $F = { F _ { \mathrm { { b } } } } \cdot { g ^ { - 1 } }$ is as above,the translation by $g ^ { - 1 }$ carries $\xi _ { \mathbf { b } }$ over onto an $N ( F )$ -bundle denoted by $\hat { \xi } _ { F }$ . The isomorphism class of $\hat { \xi } _ { F }$ , viewed as an $N ( F )$ -bundle,depends only on $\pmb { F }$

Let $\Lambda$ be a discrete subgroup of $N ( F )$ whose image $\Lambda ^ { \prime }$ under $\smash { \mathcal { \varpi } _ { F } }$ is discrete,and $ { \boldsymbol { l } }$ an integer.An automorphic form $\omega$ for $\Lambda ^ { \prime }$ ,of type $\hat { \xi } _ { F } ^ { l }$ ,is a $\Lambda ^ { \prime }$ 1 invariant holomorphic cross section of $\xi _ { F } ^ { l }$ . The transform $\omega \circ g$ is then an automorphic form of type $\hat { \xi } _ { \bf b } ^ { l }$ for $\smash { \varpi _ { \boldsymbol { \mathsf { b } } } ( \Lambda ^ { \boldsymbol { \mathsf { \boldsymbol { \mathfrak { q } } } } } ) }$ .It is therefore represented in the canonical bounded realization of $F _ { \mathbf { b } }$ bya function $f$ which satisfies

$$
f ( x \cdot \lambda ) = J _ { \mathrm { \bf b } } ( x , \lambda ) ^ { - \ l } \cdot f ( x ) \ ,
$$

$$
( x \in F _ { \mathbf { b } } , \lambda \in \Delta ^ { g } )
$$

where,by abuse of notation,we write $J _ { \mathbf { b } } ( x , g )$ for $J _ { \mathbf { b } } ( x ^ { \prime } , g )$ if $x \in F _ { \mathfrak { b } } , x ^ { \prime } \in \sigma _ { \mathfrak { b } } ^ { - 1 } ( x ) ,$ $g \in N ( F _ { \mathbf { b } } )$ ：

Let $c \leq b$ and $\pmb { \nu _ { \mathrm { b } , \mathrm { c } } } \colon S _ { \mathbf { c } }  S _ { \mathbf { b } }$ be the canonical isomorphism.We have

$$
j ( x , y _ { \mathrm { b , c } } ) \cdot J _ { \mathrm { b } } ( { \boldsymbol { \nu } } _ { \mathrm { b , c } } ( x ) , g ) = J _ { \mathrm { c } } ( x , g ) \cdot j ( x \cdot g , \mathscr { D } _ { \mathrm { b , c } } )
$$
...
The form $\omega$ is integral on $N ( x )$ if and only if for every $g \in G _ { \mathbf { Q } }$ such that $F { \cdot } g = F _ { \mathrm { \bf { b } } }$ ,the transform $\omega \circ g$ is represented in $S _ { \mathbf { b } }$ by a function which extends by continuity to a holomorphic function on $F _ { \mathrm { c } } \cap N ( x )$ for all $c \leq b$ .In fact,as before, this condition is insensitive to a change of $g$ ; moreover, by 3.9,if $F ^ { \prime } \cap N ( x ) \neq \emptyset$ ，there exists $g \in G _ { \mathbf { q } }$ such that $F ^ { \prime } \cdot g = F _ { \mathrm { c } } , F \cdot g = F _ { \mathrm { b } }$ $( c \\\leq b )$ ：
...
The function $J _ { \mathrm { c } } ( { \it \Delta \phi } , h )$ is constant along the fibres of $\sigma _ { \mathrm { { c } } } \colon S _ { \mathrm { { c } } } \longrightarrow F _ { \mathrm { { c } } }$ (3.3 (ii))， and is multiplicatively bounded on $\mathfrak { S } ( u , V _ { a } )$ by 4.16.Consequently,we are reduced to showing that $E ^ { * } \circ g \cdot h ^ { - 1 }$ extends by continuity to a holomorphic function on the interior of ${ \bar { \mathfrak { S } } } ( u , V _ { a } ) \cap F _ { \mathbf { c } }$ . Since this series has a normal majorant in ${ \mathfrak { S } } ( u , V _ { a } )$ by 7.7, this follows from 7.8, 7.9.

In order to study the limit of $E ^ { * } \circ g$ around $x \cdot g$ on $F _ { \mathrm { c } }$ ，it is enough to consider its behavior on $\mathfrak { S } ( u , V )$ ,where $V$ is a neighborhood of $x \cdot g$ .If $c > b$ ， i.e., if dim $F ^ { * } < \dim F$ ,this limit is zero by 7.8 (i). Let now $c = b$ . Theorem 7.8 (ii) implies that the limit is zero unless $g \bullet N ( F _ { \mathbf { b } } ) \cap \Gamma \neq \emptyset$ ， i.e.，unless $F _ { \mathbf { b } } { \cdot } g ^ { - 1 } \subset F _ { \mathbf { b } } { \cdot } \Gamma$ Since

$$
\Phi _ { { \scriptscriptstyle F } { \bf { \bar { b } } } } ( E \circ g ) = ( \Phi _ { { \scriptscriptstyle F } { \bf { \bar { b } } } \cdot g - 1 } E ) \circ g \ ,
$$

this ends the proof of the second assertion.

Let now $g = e$ .Then 7.8 shows that the limit of $E$ on $F _ { \mathbf { b } }$ is the limit of the“constant” term $a ( s ) ^ { - 1 } \cdot b ( s )$ , which is by 7.9 the Poincaré series of type $\hat { \xi } _ { \bf b } ^ { l }$ ：

$$
\sum _ { \lambda \in \Gamma _ { \infty } / \Gamma _ { 0 } } \varphi \big ( \sigma _ { \bf b } ( x \cdot \lambda ) \big ) J _ { \bf b } ( x , \lambda ) ^ { l } \ ,
$$

(see 8.2). Furthermore,it is clear that every such Poincaré series can be obtained in this way by suitable choice of $\varphi$ in the definition of $E$ ·

8.7. The automorphy factor for $N ( F _ { \mathbf { b } } )$ defined on $F _ { \mathbf { b } }$ by $J _ { \mathbf { b } }$ is equal in absolute value to $| \ j _ { \mathbf { b } } ( \sigma _ { \mathbf { b } } ( x ) , g ) \ | ^ { \mathbf { q _ { b } } }$ (cf.3.12). Therefore,(5.10),it satisfies the condition imposed by $\mathbf { H }$ . Cartan [35 Exp.10 bis; $1 9 \ \mathrm { p . } \ 1 7 0 ]$ so that we may apply Theorems 2,3 of loc.cit.to the Poincaré series formed by means of $J _ { \mathbf { b } }$ on $F _ { \mathbf { b } }$ . Since every rational boundary component is the transform of some $F _ { \mathbf { b } }$ by an element of $G _ { \mathbf { q } }$ ,this implies:

(1） Let $\pmb { F }$ be a rational boundary component of $X , a _ { 1 } , \cdots , a _ { q } , q$ points of $\pmb { F }$ ,no two of which are equivalent under $\Gamma ( F )$ ,and $t$ a positive integer.Then there is a positive integer $l _ { 0 }$ with the property that,for any multiple $ { \boldsymbol { l } }$ of $l _ { 0 }$ there exist a Poincaré series $P$ of type $\xi _ { F } ^ { l }$ (see 8.2) which has pre-assigned admissible (i.e., locally invariant,cf.[19,pp.170-171]) Taylor developments of order $t$ (in suitable local coordinates), at $a _ { 1 } , \cdots , a _ { q }$ ：

This means in particular that, for suitable $ { l }$ ，we may find $P$ which is not zero at $a _ { 1 }$ and zero at $\mathbf { \delta } _ { a _ { i } }$ $( i \geq 2 )$ ：

8.8.PROPOSITION．Let $\pmb { F }$ $F ^ { \prime }$ be two rational boundary components such that dim $F \geq \dim P ^ { \prime }$ ， and that either $F = F ^ { \prime }$ or $F \not \subset F ^ { \prime } \cdot \Gamma$ .Let $x \in F$ $y \in F ^ { \prime }$ be not equivalent under $\mathbf { \Gamma } _ { \mathbf { { T } } }$ . There is an integer $l _ { \mathfrak { d } }$ ,such thatif $ { \boldsymbol { l } }$ is $^ { a }$ multiple of $l _ { 0 }$ ,there exists an integral automorphic form $E$ which verifes $\Phi _ { F } E ( x ) \neq 0$ ， $\Phi _ { F ^ { \prime } } E ( y ) = 0$
...
$$
\begin{array} { r l r l } & { \Phi _ { F } E ^ { \prime } ( x ) \neq 0 , \quad } & { \Phi _ { F } E ^ { \prime } ( x ^ { \prime } ) = 0 \quad } & & { ( x ^ { \prime } \in x \cdot \Gamma \cap F ; x ^ { \prime } \notin x \cdot \Gamma ^ { \prime } \cap F ^ { \prime } ) , } \\ & { \Phi _ { F ^ { \prime } } E ^ { \prime } ( y ^ { \prime } ) = 0 . \quad } & & { ( y ^ { \prime } \in y \cdot \Gamma \cap F ^ { \prime } ) . } \end{array}
$$

Assume now that $ { \boldsymbol { l } }$ is also a multiple of the order of $\Gamma ( F ) _ { x }$ ,and put

$$
\begin{array} { r } { E = \sum _ { \gamma \in \Gamma ^ { \prime } \backslash \Gamma } E ^ { \prime } \circ \gamma . } \end{array}
$$

Each summand on the right-hand side is an integral automorphic form of weight $ { \boldsymbol { l } }$ for $\mathbf { \Gamma } ^ { \mathbf { \Gamma } ^ { \prime } }$ ，hence $E$ is an integral automorphic form of weight $ { \boldsymbol { l } }$ for $\mathbf { r }$ We claim that

$$
\Phi _ { \scriptscriptstyle F } E ( x ) \neq 0 , \qquad \Phi _ { \scriptscriptstyle F ^ { \prime } } E ( y ) = 0 ,
$$

which will prove our contention, if we take for $l _ { 0 }$ some multiple of $l _ { 0 } ^ { \prime }$ and of the order of $\Gamma ( F ) _ { x }$ . We have,for any rational boundary component ${ \pmb F } ^ { * }$

$$
( \Phi _ { F ^ { * } \cdot \gamma ^ { - 1 } } E ^ { \prime } ) \circ \gamma = \Phi _ { F ^ { * } } ( E ^ { \prime } \circ \gamma ) \ ,
$$

(see 8.5). Let $F ^ { \prime } \not \subset F { \cdot } \mathbf { I } ^ { * }$ and $F ^ { * } = F ^ { \prime }$ .Then $F ^ { \ast } \cdot \gamma ^ { - 1 } \not \subset F \cdot \Gamma ^ { \prime }$ ，the left-hand side of (3) is zero by 8.6,whence the second part of (2) if $F \neq F ^ { \prime }$ . Let now $F ^ { * } = F = F ^ { \prime }$ .If $\gamma \notin ( N ( F ) \cap \Gamma ) \cdot \Gamma ^ { \prime }$ , then $F { \cdot } \gamma ^ { - 1 } \subset F { \cdot } \Gamma ^ { \prime }$ ,the left-hand side of (3) is zero by 8.6,whence

$$
\begin{array} { r } { \Phi _ { \varepsilon } E ( z ) = \sum _ { \Gamma ^ { \prime } \backslash \left( N \left( F \right) \cap \Gamma \right) \cdot \Gamma ^ { \prime } } \left( \left( \Phi _ { \varepsilon } E ^ { \prime } \right) \circ \gamma \right) ( z ) } \end{array}
$$
...
which implies $\Phi _ { r } E ( y ) = 0$ and, because of the conditions imposed in (1).

$$
\begin{array} { r } { \Phi _ { F } E ( { \boldsymbol { x } } ) = \sum _ { \langle N ( F ) \cap \Gamma ^ { \prime } \rangle \setminus \langle N ( F ) \cap \Gamma \rangle } \dot { \boldsymbol { j } } _ { F } ( { \boldsymbol { x } } , { \boldsymbol { \gamma } } ) ^ { - 1 } \cdot \Phi _ { F } E ^ { \prime } ( { \boldsymbol { x } } \cdot { \boldsymbol { \gamma } } ) \ . } \end{array}
$$

If $\boldsymbol { x } \cdot \boldsymbol { \gamma } \notin \boldsymbol { x } \cdot \boldsymbol { \Gamma } ^ { \prime }$ , then the corresponding summand is zero by construction of $E ^ { \prime }$ There remains to consider those terms for which $\boldsymbol { x } \cdot \boldsymbol { \gamma } \in \boldsymbol { x } \cdot \boldsymbol { \Gamma } ^ { \prime }$ . In that case $\gamma \in ( N ( F ) \cap \Gamma ^ { \prime } ) \cdot \Gamma ( F ) _ { x }$ . Since we sum modulo $N ( F ) \cap \Gamma ^ { \prime }$ ，we may assume that $\gamma \in \Gamma ( F ) _ { x }$ . Then $\dot { \mathcal { I } } _ { F } ( x , \gamma ) ^ { l } = 1$ ，since $ { \boldsymbol { l } }$ is a multiple of the order of $\Gamma ( F ) _ { x }$ ,and the corresponding summand is equal to $\Phi _ { F } E ^ { \prime } ( x )$ . As a result, $\Phi _ { F } E ( x )$ is a non-zero multiple of $\Phi _ { F } E ^ { \prime } ( x )$ ，which ends the proof.
...
(iv) Each point $v \in V$ has a neighborhood $U _ { v }$ whose points are separated by the @-functions defined on $U$

Then $( V , \mathcal { Q } )$ is an irreducible normal analytic space and for each $d \equiv \dim V _ { \mathrm { 0 } } , \dag$ $V _ { ( d ) }$ is an analytic subspace of (V,C) with dimension equal to $\operatorname* { m a x } _ { \dim V _ { i } \not \equiv a }$ (dim Vi).

The proof of 9.2,will be broken up into several lemmas,and will be concluded at the end of 9.7. We note first that,in view of (i), the subspace $V _ { i }$ is locally closed in $V _ { ( a ) }$ $( d = \dim V _ { i } )$ ，hence is locally closed in $V$ ·
...
Let $h$ be a continuous,complex-valued function on $Y$ which satisfies a relation

$$
\begin{array} { r } { h ^ { n } ( y ) + \sum _ { 0 < i \leq n } a _ { i } ( y ) \cdot h ^ { n - i } ( y ) = 0 } \end{array}
$$
...
of $P$ which is irreducible in $K _ { a } [ T ]$ ,and such that

$$
Q _ { y } \big ( h ( y ) \big ) = h ^ { m } ( y ) + b _ { 1 } ( y ) \cdot h ^ { m - 1 } ( y ) + \cdot \cdot \cdot + b _ { m } ( y ) = 0
$$

where $U$ is a sufficiently small neighborhood of $^ { a }$ .Here $Q _ { y } \in \mathbf { C } [ T ]$ denotes the polynomial obtained from $Q$ by replacing $b _ { i }$ by $b _ { i } ( y )$ ， $( y \in U )$ . By consideration of the resultant of $Q$ and $d Q / d T$ ，we see that the set of points $y \in U$ ,for which $Q _ { y }$ and $d Q _ { y } / d T$ have a common root,is a proper analytic subset $z$ of $U .$ If $y \notin Z$ ,then the implicit function theorem and (2) show that $\boldsymbol { h }$ is analytic around $y$ ，Hence, $\boldsymbol { h }$ is analytic at a set of points defined locally as the complement of a proper,local analytic subset of $U$ .It is then analytic in $U$ by Riemann's extension theorem $[ 1 , \ 4 4 . 4 2 , \ \mathrm { p . } \ 4 2 0 ]$ . Since the set of singular points of $Y$ is a proper analytic subset,a further application of the Riemann extension theorem shows that $h$ is analytic on $Y$

9.4. LEMMA. We keep the notation of 9.1 and assume (i),(ii) of 9.2. Then ${ \mathcal { Q } } _ { v }$ is integrally closed for every $v \in V$
...
$$
\begin{array} { r } { ( f / g ) ^ { n } + \sum _ { 0 < i \leq n } a _ { i } \cdot ( f / g ) ^ { n - i } = 0 \qquad ( a _ { i } \in \mathbb { G } _ { \mathfrak { s } } ; i = 0 , \cdots , n - 1 ) . } \end{array}
$$

If $U$ is a sufficiently small neighborhood of $v$ ,then $f , g$ may be viewed as $\mathcal { \vec { \mathrm { ~ G ~ } } }$ -functions on $U$ and $g$ is not identically zero on $U \cap V _ { \mathfrak { o } }$ . Since $U \cap V _ { \mathfrak { o } }$ is normal, there exists then an analytic function $h$ on $U \cap V _ { \mathfrak { o } }$ such that
...
As in [35,loc.cit.] it follows from (1) and (i) that $h$ extends by continuity to a continuous function on $U$ ,which will then verify

$$
\begin{array} { r } { h ^ { \boldsymbol { n } } ( \boldsymbol { x } ) + \sum _ { \boldsymbol { 0 } < i \leq n } a _ { i } ( \boldsymbol { x } ) \cdot h ^ { \boldsymbol { n } - i } ( \boldsymbol { x } ) = 0 , } \end{array}
$$

for all $x \in U$ 、By 9.3,the restriction of $h$ to $V _ { i } \cap U$ is then analytic; hence, $h$ is an $\mathcal { Q }$ -function on $U$ and $f / g \in { \mathcal { \vec { \mathrm { G } } } } _ { v }$

9.5. LEMMA. We keep the notation of 9.1 and the assumptions (i), (iv) of 9.2. Let $v \in V$ $U ^ { \prime }$ be an open relatively compact neighborhood of v whose points are separated by @-functions, and $U$ be a neighborhood of v whose closure is contained in $U ^ { \prime }$ . Then there exist fnitely many @-functions on U which separate the points of $U$

Let $f _ { 1 } , \cdots , f _ { s }$ be a finite set of $\mathcal { \vec { \mathrm { ~ \mathfrak { ~ a ~ } ~ } } }$ -functions on $U ^ { \prime }$ ．Define a holomorphic map f $\colon U ^ { \prime } \to \mathbf { C } ^ { s }$ by $f ( u ) = ( f _ { 1 } ( u ) , \cdots , f _ { s } ( u ) )$ ,and let
...
$$
\partial _ { U } ( f _ { 1 } , \cdot \cdot \cdot , f _ { s } ) = \mathrm { m } \mathbf { a } _ { j , k } \mathrm { d i m } { \cal M } _ { j k }
$$

Put $\hat { \partial } _ { U } ( f _ { 1 } , \dots , f _ { s } ) = - 1$ if all the $M _ { j k }$ are empty, i.e., if $f$ is injective on $U$ ，It is clearly enough to show that if, $\delta _ { \sigma } ( f _ { 1 } , \cdots , f _ { s } ) \geq 0$ , then there exists an open neighborhood $U ^ { \prime \prime }$ of $U$ ,and finitely many $\boldsymbol { \mathcal { \mathrm { q } } }$ -functions $f _ { 1 } ^ { \prime } , \cdots , f _ { t } ^ { \prime }$ on $U ^ { \prime \prime }$ such that $\delta _ { U } ( f _ { 1 } ^ { \prime } , \cdot \cdot \cdot , f _ { t } ^ { \prime } ) < \delta _ { U } ( f _ { 1 } , \cdot \cdot \cdot , f _ { s } )$

Let us enumerate the $M _ { j k }$ as $Y _ { 1 } , Y _ { 2 } , \dots$ ,and let $y _ { i } = ( u _ { i } , v _ { i } ) \in Y _ { i } ( i =$ $1 , 2 , \cdots )$ .Then $u _ { i } \neq v _ { i }$ ， so there exists an $\mathcal { \vec { \mathrm { ~ \mathfrak { ~ a ~ } ~ } } }$ -function $g _ { i }$ on $U ^ { \prime }$ such that $g _ { i } ( u _ { i } ) \neq g _ { i } ( v _ { i } )$ $( i = 1 , \cdots )$ .Define $g _ { i } ^ { * }$ on $U ^ { \prime } \times U ^ { \prime }$ by $g _ { i } ^ { * } ( x , y ) = g _ { i } ( x ) - g _ { i } ( y )$ We may,and shall, assume that $\mid g _ { i } \mid \le 1 / 2$ on $U ^ { \prime }$ ,hence that $| \ g _ { i } ^ { * } \ | \leq 1$ on $U ^ { \prime } \times U ^ { \prime }$ .Let $U ^ { \prime \prime }$ be an open neighborhood of $\overbar { U }$ whose closure is contained in $U ^ { \prime }$ . We claim that we may choose constants $c _ { i }$ such that the sequence $\begin{array} { r } { g _ { ( m ) } ^ { * } = \sum _ { 1 \leq i \leq m } c _ { i } g _ { i } ^ { * } } \end{array}$ converges uniformly on $\bar { U } ^ { \prime \prime } \times \bar { U } ^ { \prime \prime }$ to a function $g ^ { * }$ such that $g ^ { \ast } ( u _ { i } , v _ { i } ) \neq 0$ $( i = 1 , 2 , \cdots )$ . In fact， supposing $c _ { 1 } , \cdots , c _ { m - 1 }$ chosen in such a way that $g _ { ( i ) } ^ { \ast } ( u _ { i } , v _ { i } ) \neq 0$ for $i = 1 , \cdots , m - 1$ ，we select $c _ { m }$ verifying the following conditions

$$
\begin{array} { r l } & { \mid c _ { m } \mid \leq 4 ^ { - m } ~ ; \qquad g _ { ( m ) } ^ { * } ( u _ { m } , v _ { m } ) \neq 0 ~ , } \\ & { \mid c _ { m } \cdot g _ { m } ^ { * } ( u _ { i } , v _ { i } ) \mid \leq 4 ^ { - m } \cdot \mathrm { M i n } _ { 1 \leq j < m } \mid g _ { ( j ) } ^ { * } ( u _ { i } , v _ { i } ) \mid } \end{array}
$$
...
Since $Y$ is analytically irreducible (of dimension $d = \dim V _ { \mathrm { 0 } } )$ at each point, the canonical projection of $\widetilde { Y }$ onto $Y$ is a homeomorphism, and we may identify $\widetilde { Y }$ with $Y$ , endowed with the structural sheaf $\widetilde { \mathfrak { C } }$ whose stalk at $\mathcal { Y }$ is the integral closure $\widetilde { \mathcal { O } } _ { y }$ of the local ring ${ \mathfrak { O } } _ { y }$ of $Y$ at $y$ . We have to prove that $f$ induces an isomorphism of $\mathcal { \vec { \mathrm { G } } } _ { u }$ onto $\widetilde { \mathcal { O } } _ { f ( u ) }$ for every $u \in U ^ { \prime }$

Let first $g \in \widetilde { \mathcal { O } } _ { f ( u ) }$ . There is a neighborhood of $f ( u )$ in which $g$ defines a continuous function which satisfies an integral dependence relation

$$
\begin{array} { r } { g ^ { n } ( x ) + \sum _ { 0 < i \leq n } { b } _ { i } ( x ) \cdot g ^ { n - i } ( x ) = 0 , } \end{array}
$$

where the $b _ { i }$ are analytic on $Y$ around $f ( u )$ .The function $g \circ f$ is then continuous around $\boldsymbol { u }$ ,and satisfies there a relation similar to (1),with $b _ { i }$ replaced by $a _ { i } = b _ { i } \circ f$ The $a _ { i } ^ { \mathrm { ~ \tiny ~ \vdots ~ } }$ s are continuous around $\boldsymbol { u }$ . By 9.6, they are $\circleddash$ -functions; hence (9.3), the restriction of ${ \boldsymbol { g } } \circ { \boldsymbol { f } }$ to $V _ { i }$ around $\boldsymbol { u }$ is analytic.Therefore $g \circ f$ is an $\boldsymbol { \mathcal { \mathrm { { q } } } }$ -function.

It is well-known [8,p.179] that an analytic homeomorphism of one complex manifold onto another is an isomorphism.Let $a$ be an $\mathcal { Q }$ -function at $u \in U ^ { \prime }$ ,i.e., $a \in \mathcal { Q } _ { u }$ ,and let $N$ be a neighborhood of $f ( u )$ .If $N$ is chosen small enough, then $a \diamond f ^ { - 1 }$ is continuous in $N$ and analytic on $f ( V _ { 0 } ) \cap N$ (viewed as a subset of $\widetilde { Y }$ )，except possibly at the image points of the singularities of $V _ { 0 }$ .Hence [1, 44.42,p. 420], $a \circ f ^ { - 1 }$ is analytic on all of $f ( V _ { \mathrm { 0 } } ) \cap N$ By 9.6, $( f ( U ^ { \prime } ) - f ( U ^ { \prime } \cap V _ { 0 } ) ) \cap N$ is a proper analytic subset of $\smash { \widetilde { Y } } \cap N$ Hence, $a \circ f ^ { - 1 }$ is analytic on $\smash { \widetilde { Y } } \cap N$ ，so that,finally, $f ^ { * }$ is an isomorphism of $\widetilde { \mathcal { O } } _ { f ( u ) }$ onto $\mathcal { \vec { \mathrm { G } } } _ { u }$

By 9.5,each point $v \in V$ has a neighborhood $U ^ { \prime }$ as in 9.6. Therefore, the first assertion of the theorem follows from 9.7. The assertion about $V _ { ( a ) }$ follows at once from the induction procedure indicated in 9.6.

9.8.CoROLLARY. Let U be an open subset of $V$ , and f a continuous function on U which is analytic on $V _ { \mathfrak { o } } \cap U$ Then $f$ is an @-function.

This follows from the theorem and the Riemann extension theorem.
...
Let $x \in X ^ { * }$ and $v = \pi ( x )$ .Let $U$ be a good neighborhood of $x$ in $X ^ { * }$ (8.1). Then $U ^ { \prime } = \pi ( U )$ may be identified with $U / \Gamma _ { x }$ ，hence $V _ { i } \cap U ^ { \prime }$ with $( F _ { i } \cap U ) / ( \Gamma _ { x } \cap N ( F _ { i } ) )$ . The definitions of the analytic structure on $V _ { i }$ and of $\mathcal { \vec { \mathrm { G } } }$ imply that $f \colon U ^ { \prime } \to \mathbf { C }$ is an $\mathcal { Q }$ -function if and only if $f \circ \pi$ is a continuous function on $U$ ，which is invariant under $\Gamma _ { x }$ ,and whose restriction to $F \cap U$ is analytic for every rational boundary component $\pmb { F }$ ，In particular，the quotient $\omega / \omega ^ { \prime }$ of two integral automorphic forms $\omega , \omega ^ { \prime }$ for $\Gamma _ { x }$ on $U$ of the same weight,where $\omega ^ { \prime }$ does not take the value zero in $U$ ，may be identified with an $\mathcal { \ c G }$ -function of $U ^ { \prime }$ ：

10.3. Let $i$ be the index such that $v \in V _ { i }$ . The canonical projection $\sigma _ { i } \colon X \longrightarrow F _ { i }$ (1.7,remark) induces an analytic map $\mathbf { \sigma } _ { \sigma _ { i } ^ { \prime } } ^ { \prime }$ of $( X \cap U ) / \Gamma _ { x } = V \cap U ^ { \prime }$ onto a neighborhood of $v$ in $V _ { i } \cap U ^ { \prime } = ( U \cap F _ { i } ) / \Gamma _ { x }$ Let $j$ be such that $v \in \bar { V } _ { j }$ ， and let $w \in V _ { j } \cap U ^ { \prime }$ . There exists $\gamma \in \Gamma$ such that $F _ { j } { \cdot } \gamma \cap U \neq \emptyset$ and $\bar { F } _ { j } \cdot \cdot \gamma \ni x$ ：

The canonical projection $\sigma _ { \it { F } _ { i } , \it { F } _ { j } \cdot \gamma }$ induces a holomorphic map of

$$
\pi ( F _ { j } \bullet \gamma \cap U ) = ( F _ { j } \bullet \gamma \cap U ) / \big ( N ( F _ { j } \bullet \gamma ) \cap \Gamma _ { x } \big )
$$

onto a neighborhood of $v$ in $V _ { i }$ . We have the factorization (1.7, remark)

$$
\sigma _ { { { \scriptscriptstyle F } } _ { i } } = \sigma _ { { { \scriptscriptstyle F } } _ { i } , { { \scriptscriptstyle F } } _ { j } \cdot \gamma } \circ \sigma _ { { { \scriptscriptstyle F } } _ { j } \cdot \gamma } ~ .
$$

Let now $f$ be a holomorphic function around $v$ on $V _ { i }$ . The above remarks imply that $f \circ \sigma _ { F _ { i } } ^ { \prime }$ extends by continuity to an $\mathcal { \hat { \mathrm { \Omega } } }$ -function near $v$ in $V$ ，whose restriction to $V _ { i }$ around $v$ is equal to $f _ { i }$ ,and whose restriction to $V _ { j }$ near $_ w$ ， lifted to $F _ { j } { \cdot } \gamma$ ,is equal to
...
The quotient $E ^ { \prime } / E ^ { m }$ is then an $\boldsymbol { \mathcal { \vec { \mathrm { a } } } }$ -function on $U ^ { \prime }$ which separates $p ^ { \prime }$ from $q ^ { \prime }$ Thus 9.2 (iv) also holds true in $V ^ { * }$

10.5. CoROLLARY. Assume that $G$ has no normal $\mathbf { Q }$ -subgroup of dimension 3. Let $U$ be open in $V ^ { * }$ . Then every meromorphic function on $U \cap V$ is the restriction of a meromorphic function on U. In particular, the restriction to $V$ yields an isomorphism of the field of meromorphic functions on $V ^ { * }$ onto the feld of meromorphic functions on $V$

The assumption on $G$ implies,by 3.15,that dim $( V ^ { * } - V ) \leq \dim V ^ { * } - 2$

Therefore 10.5 follows from 10.4 and a well-known extension theorem on normal analytic spaces.

We recall the map $f \mapsto \pi \circ f$ identifies the meromorphic functions on $V$ with the $\Gamma$ -invariant meromorphic functions on $X$ ,i.e.,with the automorphic functions for $\mathbf { \Gamma } ^ { \Gamma }$

10.6. LEMMA. We keep the notation of 10.1,10.2. There exist a weight l and fnitely many integral automorphic forms $E _ { 0 } , \cdots , E _ { s }$ of weight $ { \boldsymbol { l } }$ such that the forms $\Phi _ { { \cal F } _ { i } } \cdot E _ { j }$ are nowhere simultaneously zero $0 \leq i \leq m$ ).

Given $x \in F _ { i }$ , there exists a weight $l _ { x }$ ,and an integral automorphic form $E _ { x }$ of weight $ { \boldsymbol { l } }$ such that $\Phi _ { F _ { i } } E _ { x } ( x ) \neq 0$ ,(8.8,8.9). There is then a good neighborhood $N ( x )$ of $x$ such that the extension of $\boldsymbol { E }$ to $N ( x )$ is nowhere zero.By compactness, $V$ is covered by the images of finitely many such neighborhoods $N ( x _ { j } )$ . The lemma follows then by taking for $\boldsymbol { l }$ the l.c.m.of the $l _ { x _ { j } }$ and for $\textstyle E _ { i }$ 's suitable powers of the $E _ { x _ { j } }$

10.7. Let $E _ { j }$ $( 0 \leq j \leq N )$ be as in 10.6. If we trivialize the bundle $\boldsymbol { \xi } _ { F _ { i } } ^ { l } ,$ the forms $\Phi _ { { \boldsymbol { F } } _ { i } } E _ { j }$ are identified with holomorphic functions which are nowhere simultaneously zero; their values at ${ \boldsymbol { x } } \in F _ { j }$ are the coordinates of a point in $\mathbf { C } ^ { N + 1 } - 0$ . If we change the trivialization, these coordinates are all multiplied by the same non-zero constant,hence define the same point in the associated projective space $\mathbf { P } ( N , \mathbf { C } )$ .Thus，to $x \in F$ there is associated a well-defined point in $\mathbf { P } ( N , \mathbf { C } )$ ,whose homogeneous coordinates will be denoted by $\Phi _ { F _ { i } } E _ { j } ( x )$ ： Since the $E _ { j }$ are automorphic forms of the same weight,two points $x$ and $x \cdot \gamma ( \gamma \in \Gamma )$ will have the same image in $\mathbf { P } ( N , \mathbf { C } )$ , whence a map $f \colon V ^ { * } \longrightarrow \mathbf { P } ( N , \mathbf { C } )$ defined by

$$
f ( \pi ( x ) ) = \bigl ( \Phi _ { { \cal F } _ { \mathrm { i } } } E _ { 0 } ( x ) , \cdots , \Phi _ { { \cal F } _ { \mathrm { i } } } E _ { N } ( x ) \bigr ) \qquad ( x \in { \cal F } _ { \mathrm { i } } , i = 0 , \cdots , m ) \ .
$$

Since the quotient of two integral automorphic forms is an $\mathcal { Q }$ -function outside the set of zeros of the denominator, $f$ is a holomorphic mapping.

10.8. LEMMA. We keep the notation of 10.1, 10.2. There exist a weight l and finitely many integral automorphic forms $E _ { \mathfrak { d } }$ …, $E _ { N }$ of weight $ { \boldsymbol { l } }$ for Γ,satisfying 10.5, such that the map $f$ $V ^ { * } \longrightarrow \mathbf { P } ( N , \mathbf { C } )$ associated to the $\boldsymbol { E } _ { i } ^ { \ , } \mathbf { s }$ is a homeomorphism of $V ^ { * }$ onto $f ( V ^ { * } )$

The proof is essentially the same as in the symplectic case [2],and will be described briefly.It is enough to show that for suitable $E _ { i } ^ { \prime } { \bf s }$ the map $f$ is injective.

Let $D$ and $\Delta$ be the diagonals in $V ^ { * } \times V ^ { * }$ and $\mathbf { P } ( N , \mathbf { C } ) \times \mathbf { P } ( N , \mathbf { C } )$ respectively，and $S = ( f \times f ) ^ { - 1 } ( \Delta )$ .Then $\boldsymbol { S }$ is an analytic subset of $V ^ { * } \times V ^ { * }$ containing $D$ ，which is equal to $D$ if and only if $f$ is injective.Since,in a compact analytic space,a decreasing sequence of analytic subsets is stationary,it is enough to show that if $S \ne D$ ,then there exists a similar map $f ^ { \prime } \colon V ^ { * } \longrightarrow \mathbf { P } ( N ^ { \prime } , \mathbf { C } )$ associated to integral automorphic forms of some weight $\mathrm { \Delta } l ^ { \prime }$ for which $S ^ { \prime } = ( f ^ { \prime } \times f ^ { \prime } ) ^ { - 1 } ( \Delta ) \subsetneq S$

Let $x \in F _ { i }$ ， $y \in F _ { j }$ $( \dim F _ { i } \geq \dim F _ { j } )$ ， $x ^ { \prime } = \pi ( x )$ ， $y ^ { \prime } = \pi ( y )$ ，be such that $( x ^ { \prime } , y ^ { \prime } ) \in S - D$ . Then $x \notin y \cdot \Gamma$ ; by 8.8,8.9 there exists a multiple ${ \mathit { l } } ^ { \prime }$ of $ { l }$ and an integral automorphic form $\pmb { { \cal E } }$ of weight $ { \boldsymbol { l } }$ such that $\Phi _ { F _ { i } } E ( x ) \neq 0$ ， $\Phi _ { F _ { j } } E ( y ) = 0$ We then take as $E _ { j } ^ { \prime }$ 's all the monomials of degree ${ \mathit { l } ^ { \prime } } / { \mathit { l } }$ in the $E _ { j } ^ { ~ \prime } { \bf s }$ ,and $\boldsymbol { \mathbf { \mathit { E } } }$ .We have $S ^ { \prime } \subset S$ ,and $( x , y ) \notin S ^ { \prime }$ ，hence $S ^ { \prime } \ne S$

10.9. Let $\mathcal { Q } ( \Gamma )$ be the graded ring of automorphic forms of positive weight for $\mathbf { \Gamma } ^ { \Gamma }$ on $X$ ，It may be identified with the set of invariants of $\mathbf { \Gamma } ^ { \Gamma }$ in a ring $\begin{array} { r } { B = \sum _ { i \geq 0 } B _ { i } } \end{array}$ of holomorphic functions,on which $H ( X )$ operates by

$$
( f \circ g ^ { - 1 } ) ( x ) = J ( x , g ) ^ { i } \cdot f ( x \cdot g )
$$
...
10.12.CoROLLARY. Assume that $G$ has no normal $\mathbf { Q }$ -subgroup of dimension 3. Then the field of automorphic functions for T is canonically isomorphic with the field of rational functions on $f ( V ^ { * } )$ . In particular,it is an algebraic function field of transcendence degree equal to $\operatorname { d i m } _ { \mathrm { { C } } } X$ Every automorphic function is the quotient of two integral automorphic forms of the same weight.

This follows from 10.5,and from the fact that a meromorphic function on a projective variety is rational by Chow's theorem.

10.13. Let $\rho$ $K ^ { \circ } \longrightarrow \mathbf { G L } ( E )$ bea finite dimensional unitary representation of $K ^ { \circ }$ . It defines on $X$ a complex vector bundle $\xi _ { \rho }$ ，the bundle associated by $\rho$ to $G _ { \mathbf { R } } ^ { 0 }$ ，viewed as principal $K ^ { \circ }$ -bundle by left translations.The total space is therefore the quotient $G _ { \mathrm { R } } ^ { \phantom { 0 } } \times \phantom { 0 } _ { \kappa ^ { 0 } } E$ of $G _ { \mathbf { R } } ^ { _ { 0 } } \times E$ by the equivalence relation

$$
( g , v ) \approx ( k \cdot g , \rho ( k ) \cdot v )
$$

$$
( k \in K ^ { \circ } , g \in G _ { \mathbf { R } } ^ { \circ } , v \in E )
$$

It can also be written as $P ^ { - } { \cdot } K _ { \mathrm { c } } ^ { \circ } { \cdot } G _ { \mathrm { R } } ^ { \circ } \times { } _ { P ^ { - } { \cdot } { \kappa } _ { \mathrm { C } } ^ { 0 } } E$ ，where $\rho$ is extended in the obvious fashion to a representation of $P ^ { - } { \cdot } K _ { \mathrm { C } } ^ { \mathrm { 0 } }$ which is trivial on $P ^ { - }$ ; hence, it is a holomorphic vector bundle.An automorphic form of type $\tilde { \xi } _ { \rho }$ isa $\mathbf { \Gamma } ^ { \Gamma }$ ， invariant， holomorphic cross-section of $\xi _ { \rho }$ . These forms correspond in a canonical fashion to the holomorphic $V \mathrm { . }$ -valued functions on $X$ which satisfy the relation

$$
f ( x \cdot \gamma ) = \mu _ { \rho } ( x , \gamma ) ^ { - 1 } \cdot f ( x )
$$
...
where $\mu _ { \rho }$ is the automorphy factor introduced in 5.6.We let ${ \mathcal { Q } } _ { \rho }$ be the sheaf of germs of automorphic functions of type $\tilde { \xi } _ { \rho }$ ,for $\mathbf { \Gamma } ^ { \Gamma }$ on $X / \Gamma$ . It is reflexive, torsionless,and is known to be an analytic coherent sheaf [34, Exp.XX].
...
$$
( n \geq n _ { 0 } , p \geq n _ { 0 } )
$$

Since the sheaves involved extend to algebraic coherent sheaves on a projective variety, the proof of (1) given by Serre [34,XX,nos.9,10] when $X / \Gamma$ is compact applies without change to our case.
...
Assume now $X$ to be irreducible.Then its isometries are either holomorphic or anti-holomorphic, and $H ( X )$ has index two in Is $( X )$ . In fact, let ${ \mathfrak { g } } = { \mathfrak { k } } + { \mathfrak { p } }$ be the Cartan decomposition of $\mathfrak { g }$ associated to the Lie algebra f of $\kappa$ Then Is $( X ) = K \cdot P$ $\mathbf { \nabla } ^ { \prime } P = \mathbf { e x p } \ \mathfrak { p } ,$ ）and $H ( X ) = ( K \cap H ( X ) ) \cdot P$ The identity component $\boldsymbol { S }$ of the center of the identity component of $\kappa$ is onedimensional,and an automorphism Int $k$ $( k \in K )$ is either the identity or the inversion $s \mapsto s ^ { - 1 }$ on $\boldsymbol { S }$ .On the other hand,the multiplication by $\nu ^ { - 1 }$ in the tangent space $X _ { 0 }$ of $X$ at $\kappa$ is induced by $\mathbf { A d } s _ { 0 }$ ，where $\scriptstyle { \boldsymbol { s } } _ { 0 }$ is an element of order 4 in $S$ .Therefore Int $k ( s _ { 0 } )$ is equal either to $\boldsymbol { s } _ { 0 }$ or to $s _ { 0 } ^ { - 1 }$ . The transformation $k$ is holomorphic in the first case,anti-holomorphic in the second one.In particular
...
11.2.PROPOSITION． Let $\bar { D }$ be the natural compactification of $X$ (1.4). The action of $H ( X )$ on $X$ extends by continuity to a continuous action on $\bar { D }$ and the restriction of $h \in H ( X )$ to any boundary component is holomorphic.
