# Source Trace: Thas/Desargues Configuration Claim for 10-Nodal Rational Sextic

## 1. Search Targets

The search targeted the following for the claim: *"The ten points of a Desargues
configuration of lines and points formed by two perspective triangles in the projective
plane can serve as the ten nodes of a unique rational plane curve of degree 6"*:
...
### Source 1: MPI Lecture Abstract (2016)
...
- **Year**: 2016
- **Content**: The abstract snippet states: "J. Thas asserts that the ten points of a
...
- **Scope**: Complete publications list (280+ items) from 1967–2023
- **Finding**: No paper specifically on Desargues configurations and rational plane
  sextics
- **Closest relevant entry**: Item 18 — "The number of Desargues-configurations of the
